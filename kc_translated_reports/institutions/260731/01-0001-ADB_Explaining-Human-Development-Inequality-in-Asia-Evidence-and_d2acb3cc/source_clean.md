...
Note: MMR is measured as maternal deaths per 100,000 live births. ABR is measured as births per 1,000 women aged 15–19 years. Government effectiveness ranges from -2.5 (weakest) to +2.5 (strongest).
Source: Authors' estimation.

Overall, East Asia and the Pacific outperform South Asia across most indicators of human development inequality, gender inclusion, and governance. The findings suggest that reducing educational and income disparities, promoting gender equality, and strengthening institutional effectiveness remain central to achieving more inclusive human development outcomes across Asia.

## 3. Policy Priorities and Future Directions

The findings identify education and income inequality as the principal drivers of human development losses across Asian economies. South Asia records substantially higher levels of educational and income inequality than East Asia and the Pacific, suggesting that unequal access to quality education and economic opportunities remains a major constraint to inclusive development. Investments in education enhance human capabilities and productivity while reducing long-term socioeconomic disparities (Becker 1993; Lanzi 2007). Policymakers should therefore prioritize equitable access to quality education, particularly at the secondary level, while strengthening skills development and lifelong learning opportunities. Reducing educational disparities can also help narrow income gaps and promote more inclusive development outcomes (Sylwester 2002; Machin and Vignoles 2004).

The positive association between gender inequality and human development losses highlights the importance of gender-inclusive policies. Countries with lower levels of gender inequality generally experience lower development losses from inequality, while economies characterized by weaker gender outcomes tend to face greater development challenges. Previous studies show that gender inequality constrains economic performance and limits broader development outcomes (Klasen 2018; Carlsen 2020). Expanding female educational attainment, improving reproductive health outcomes, increasing women's labor force participation, and strengthening women's representation in decision-making institutions can therefore contribute to more inclusive development (Kabeer 2010; Duflo 2012). Such measures are particularly relevant for South Asia, where female educational attainment and labor force participation remain below regional and global averages.
