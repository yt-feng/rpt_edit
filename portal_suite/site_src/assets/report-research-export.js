(() => {
  ...
  async function openPdfPrint(payload, runtime = {}) {
    ...
    printWindow.document.write('<!doctype html><html lang="zh-CN"><meta charset="utf-8"><title>正在准备研究报告</title><body style="font-family:system-ui;padding:32px">正在准备可打印的研究报告与图表…</body></html>');
