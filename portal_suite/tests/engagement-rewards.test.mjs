...
test("research grounding checks local metric units and definite numeric comparisons", async (t) => {
  ...
  const cases = [
    ...
    { name: "power consumption may use energy units", evidence: "Power consumption is 400 TWh.", sentence: "Power consumption is 400 TWh.", label: "power consumption", value: "400 TWh", keep: true },
    { name: "power consumption may use power units", evidence: "Power consumption is 400 kW.", sentence: "Power consumption is 400 kW.", label: "power consumption", value: "400 kW", keep: true },
    { name: "power demand may use energy units", evidence: "Power demand is 400 TWh.", sentence: "Power demand is 400 TWh.", label: "power demand", value: "400 TWh", keep: true },
    { name: "power demand may use power units", evidence: "Power demand is 400 kW.", sentence: "Power demand is 400 kW.", label: "power demand", value: "400 kW", keep: true },
    { name: "energy demand may use power units", evidence: "Energy demand is 400 kW.", sentence: "Energy demand is 400 kW.", label: "energy demand", value: "400 kW", keep: true },
    { name: "energy demand may use energy units", evidence: "Energy demand is 400 TWh.", sentence: "Energy demand is 400 TWh.", label: "energy demand", value: "400 TWh", keep: true },
    { name: "ambiguous Chinese consumption keeps the supplied dimension", evidence: "Energy use is 400 kW.", sentence: "设备能耗为400 kW。", label: "设备能耗", value: "400 kW", keep: true },
    { name: "electricity consumption keeps a supplied power rate", evidence: "Electricity consumption is 400 kW.", sentence: "Electricity consumption is 400 kW.", label: "electricity consumption", value: "400 kW", keep: true },
    { name: "Chinese power consumption keeps a supplied energy total", evidence: "Annual consumption is 400 kWh.", sentence: "设备功耗为400 kWh。", label: "设备功耗", value: "400 kWh", keep: true },
    { name: "ambiguous power consumption still cannot be currency", evidence: "Equipment cost is US$400.", sentence: "Power consumption is US$400.", label: "power consumption", value: "US$400", keep: false },
    { name: "ambiguous energy demand still cannot be currency", evidence: "Equipment cost is US$400.", sentence: "Energy demand is US$400.", label: "energy demand", value: "US$400", keep: false },
    { name: "explicit power cannot be energy", evidence: "Annual consumption is 400 TWh.", sentence: "设备功率为400 TWh。", label: "设备功率", value: "400 TWh", keep: false },
    { name: "energy quantities cannot be equipment cost", evidence: "Annual consumption is 400 TWh.", sentence: "Equipment cost is 400 TWh.", label: "equipment cost", value: "400 TWh", keep: false },
