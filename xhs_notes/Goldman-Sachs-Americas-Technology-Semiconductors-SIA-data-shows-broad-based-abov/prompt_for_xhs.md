...
Across our global coverage, we examine stocks using an M&A framework, considering both q

[中间内容因长度限制已省略]

, officers, directors, and employees will from time to time have long or short positions in, act as principal in, and buy or sell, the securities or derivatives, if any, referred to in this research, unless otherwise prohibited by regulation or Goldman Sachs policy.
