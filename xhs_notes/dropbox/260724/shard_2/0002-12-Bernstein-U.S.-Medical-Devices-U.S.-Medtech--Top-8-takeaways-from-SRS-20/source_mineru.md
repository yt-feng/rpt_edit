...
Hugo launch status. Medtronic is focused on a measured U.S. rollout, starting in urology and expanding via recently submitted 510(k)s into general surgery and gynecology, which together represent roughly 80% of soft-tissue robotic procedures. Key near-term catalysts include these indication expansions and the introduction of differentiated instruments like LigaSure and ProGrip mesh, alongside a broader ecosystem strategy. Anderson stressed that Hugo is not just a product but a program requiring close hospital partnership, with early U.S. learnings informing a broader launch cadence rather than rapid placement targets.

Longer-term vision. Anderson argued that international experience (35+ countries, tens of thousands of procedures, \~400 publications) has reinforced demand for Medtronic's legacy instruments and validated Hugo's form factor, while also highlighting the importance of training, workflow integration, and ecosystem capabilities. On debated topics, management acknowledged surgeon preference variability (open vs. immersive console) but reported strong feedback on modularity and workflow flexibility, and downplayed footprint concerns. Anderson noted growing relevance in ambulatory surgery centers and signaled continued investment in robotics platforms tailored to different care settings, with the broader vision of integrating robotics, instruments, and AI into a connected surgical ecosystem.

## Intuitive Surgical

Intuitive's presence during the first day of SRS was limited to a pre-recorded fireside chat with CEO Dave Rosa and CFO Jamie Samath (pre-recorded before 2Q26 earnings and before the announcement of JNJ's U.S. clearance for Ottava).

Continuous innovation. Intuitive Surgical management highlighted a shift toward a continuous innovation model, with regular software and hardware updates driven by customer feedback and evaluated through Intuitive's quintuple aim framework: improving outcomes, enhancing patient and care team experience, lowering total cost of care, and expanding access. Recent da Vinci 5 upgrades include over 100 enhancements, notably a digital ruler for intraoperative measurement, surgeon-controlled instrument ejection to improve workflow efficiency, and multi-arm targeting for setup optimization. Cybersecurity was also emphasized as an increasingly important differentiator. On pricing and utilization, Intuitive is extending instrument life to drive manufacturing efficiency and, in certain core instruments, reduce cost per procedure—particularly targeting lower-acuity, cost-sensitive settings such as ambulatory surgery centers (ASCs), where the company sees meaningful growth opportunity.

Innovation priorities. Looking longer term, Rosa framed Intuitive's strategy around building an integrated ecosystem rather than a collection of standalone products, with connectivity, data, and AI as key pillars. While AI remains early, current value is being delivered through digital tools (e.g., My Intuitive + platform), with future potential in intraoperative guidance, automation, and augmented dexterity. Expansion will come via deeper penetration of existing procedures, new indications, and new platforms where Intuitive's capabilities can meaningfully improve clinical and economic outcomes.

Hot topics. In ASCs, adoption is being driven by health systems shifting lower-acuity procedures away from the hospital, with systems like da Vinci XiR positioned to meet cost and workflow needs. On competition (Medtronic Hugo, J&J Ottava, and emerging low-cost international players), management emphasized competing on value and outcomes first, supported by a broad portfolio and flexible economic models. Finally, Rosa positioned telesurgery primarily as a training and proctoring tool rather than a direct care delivery model, aligning with Intuitive's focus on scaling surgical expertise globally. We will hear more about Intuitive's vision for an AI-enabled future of healthcare today at the conference (see this morning's press release from ISRG).
...
We set a price target of \$97 using a P/E multiple of 15.0x against our forward Q5-Q8 EPS estimate of \$6.45. The P/E target reflects observed absolute and relative historical multiples and our outlook for forward growth.

## Stryker Corp

We set a price target of \$410 using a P/E multiple of 24x against our forward Q5-Q8 EPS estimate of \$17.08. The P/E target reflects observed absolute and relative historical multiples and our outlook for forward growth.
...
Downside risks include: A major product recall; the risk that key products fail to grow as expected; the risk that the company will overpay for acquisitions to make up for sluggish revenue growth throughout the portfolio; and / or market-wide deceleration across MDT's end markets.

## Stryker Corp

Downside risks include: Pressure on hospital capital expenditure budgets; margin headwinds related to inflationary impact and supply chain challenges; a major product recall; the risk that key products fail to grow as expected; the risk that the company will overpay for acquisitions; and / or the risk of a market-wide deceleration across the company's end markets.
...
Prior to April 1, 2024, Bernstein & Co., LLC. issued the ratings and price target information in the graph(s) below for the following companies: Intuitive Surgical Inc, Johnson & Johnson, Medtronic PLC and Stryker Corp.

Intuitive Surgical Inc (ISRG) Rating History for Bernstein as of 07/22/2026  
![](images/118bbbebe9b1569349dad850365b4a67e2b79a6e38ec596989b64d6854086c48.jpg)

Johnson & Johnson (JNJ) Rating History for Bernstein as of 07/22/2026  
![](images/194bd3aafd3d82371e7645f41a196bbf91b4b69ea096f3e8491c0ba637c4fe26.jpg)  
Outperform (O); Market-Perform (M); Underperform (U); Coverage Suspended (CS); Not Covered (NC)

Medtronic PLC (MDT) Rating History for Bernstein as of 07/22/2026  
![](images/50b2014dc47b275ea6d177ca152224a1cb5fd9616d520042b605306a1f3116fa.jpg)

Stryker Corp (SYK) Rating History for Bernstein as of 07/22/2026  
![](images/9d452386cad58886824656b75eeae6953eeae98d3dc8d9f2a56228741b44346a.jpg)  
All price target and closing price data in the chart(s) above are denominated in the currency noted in the Ticker Table of this report.

## CONFLICTS OF INTEREST

Bernstein Autonomous LLP or BSG France SA, beneficially, has either a net long or short position of 0.5% or more of the total issued share capital of a class of common equity securities of the following MiFID eligible securities: Intuitive Surgical Inc, Medtronic PLC and Stryker Corp.

AB and/or its affiliates beneficially own 1% or more of a class of common equity securities of the following companies: Intuitive Surgical Inc and Stryker Corp.

SG and/or its affiliates beneficially own 0.5% or more of [the total issued share capital/any class of common equity securities] with a net [long/short] position of: Intuitive Surgical Inc.

Bernstein and/or affiliates have received compensation for non-investment banking securities-related products or services in the previous twelve months from the following clients: Stryker Corp.

Certain affiliates of Bernstein act as market maker or liquidity provider in the equities securities of: Intuitive Surgical Inc, Johnson & Johnson, Medtronic PLC and Stryker Corp.

Certain affiliates of Bernstein act as market maker or liquidity provider in the debt securities of: Johnson & Johnson, Medtronic PLC and Stryker Corp.
