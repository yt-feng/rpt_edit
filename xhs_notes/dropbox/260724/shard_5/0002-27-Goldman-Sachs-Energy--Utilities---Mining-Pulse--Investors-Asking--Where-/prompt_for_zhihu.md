...
EQT. Following the company's reporting of 2Q26 earnings on July 21, EQT has been a name in focus this week with investors following outperformance on 2Q26 production. The company reported total production of 6.97 Bcfe/d for the quarter relative to FactSet consensus at 6.65 Bcfe/d. Investors have noted the company's commentary around compression projects driving a shallower base decline rate, as many investors begin to focus on the potential for incremental efficiencies to the maintenance capital program in 2027+ as a result of EQT's organic growth projects. Those more constructive on EQT note the company's announcements for incremental power and LNG agreements alongside 2Q26 earnings. On the 10-year power supply deal with CPV Shay, investors have been focused on the premium pricing structure linked to PJM pricing as well as the potential for a 2031 start-up as was messaged by EQT. On the 5-year LNG offtake agreement with an undisclosed large integrated Asian energy company, investors have noted EQT's expectation for a \$45 mn uplift to 2028 FCF at recent strip pricing. Given the ongoing pressure in the US natural gas macro environment, investors continue to focus on EQT's long-term outlook for regional Appalachian power demand growth to ease the currently robust near-term expectations for US natural gas supply growth.

## Majors & Refining

Refining. This week within the refining complex, we have received incremental inbounds around relative valuation following strong YTD equity moves. Conversations remain focused on the refining macro, with discussions particularly around ongoing supply disruptions, the extent to which RIN prices remain elevated, and the potential magnitude for small refinery exemptions. Among the large caps, discussions have been primarily around relative valuation and the cadence for share repurchases amid strong cash flow generation. Among SMID cap refiners, we have received some inbounds around CVI given the magnitude of underperformance, with some bullish investors viewing the dislocation as presenting an attractive entry opportunity. Additionally, bullish investors we speak to remain constructive on DK given SOTP efforts, balance sheet strength, and potential to receive 100% SREs across the asset base. Lastly, for PARR, sentiment has improved more recently though investors are mindful of the Hawaii turnaround and look for further clarity on the third quarter outlook given crude price volatility.

Canadian Oils. Based on our conversations marketing in Toronto this week, investors continue to express interest in the setup for Canadian Oils amid renewed geopolitical tensions and commodity price volatility. We note CVE remains a highly debated stock ahead of 2Q26 earnings, with long-only and Canadian investors keenly focused on volume and free cash flow growth as West White Rose comes online. Additional upside exists at Christina Lake North, where integration is tracking ahead of schedule. Given strong year-to-date outperformance, however, we find some investors with shorter horizons may be inclined to position for a mean-reversion trade. Into the print, the market looks for solid Upstream execution but expects Downstream margin capture to normalize toward 70%. Investors also look for continued progress on debt reduction amid elevated commodity prices, with a potential path to C\$6 bn of net debt by year-end. Meanwhile, sentiment remains constructive on SU and IMO.TO's strong integrated exposure with refining a larger share of the total earnings mix, though valuation for the latter still screens as expensive to some. Lastly, we highlight investor appetite for CNQ to catch up with peers following year-to-date underperformance, despite lingering questions over capital spend on medium and long-term projects.

## Energy Services

HAL. Conversations focused on HAL this week after the company reported an in-line quarter vs GS estimates, and guided to a softer 3Q than Street was anticipating. Investors queried what
