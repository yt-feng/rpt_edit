...
【研报解析内容】
"""
22 Jul 2026 20:06:38 ET | 11 pages

# MicroPort MedBot (2252.HK)

1H26 Positive Profit Alert Announced: Another Strong Half-year

## CITI'S TAKE

MicroPort MedBot announced 1H26 profit alert with net profit of RMB28–40mn (vs. a net loss of RMB115mn in 1H25). Revenue growth of 200–230% YoY beat both VA consensus (+173% YoY) and CitiE (+190% YoY), reflecting continued commercial momentum in the Toumai surgical robot across overseas and domestic markets. Notably, overseas revenue increased by 450%+ YoY. GPM improved by more than 15 ppts YoY — a notable operational achievement driven by scale benefits, process optimization, and a favorable mix shift toward higher-margin consumables. On earnings, the midpoint of RMB34mn beats VA (RMB24mn) but falls short of CitiE of RMB44mn — a gap we attribute to the investment-led nature of the current growth phase. We view the topline beat and first-time semi-annual profitability as the key takeaways for investors. With the full 1H26 results to be announced by end of August, we see potential management guidance uplift as the next key catalyst.

<table><tr><td colspan="2">Buy / High Risk</td></tr><tr><td colspan="2">Catalyst Watch: Upside, expires 20-OCT-26</td></tr><tr><td>Price (22 Jul 26 16:10)</td><td>HK$21.82</td></tr><tr><td>Target price</td><td>HK$41.00</td></tr><tr><td>Expected share price return</td><td>87.9%</td></tr><tr><td>Expected dividend yield</td><td>0.0%</td></tr><tr><td>Expected total return</td><td>87.9%</td></tr><tr><td>Market Cap</td><td>HK$22,504MUS$2,870M</td></tr></table>

Eva Zhao, CFA $^{AC}$ +852-2501-2701
eva.zhao@citi.com
...
## Catalyst Watch on MicroPort MedBot (2252.HK)

Direction: Upside

Duration: Within 90 Days (expires 20 Oct 2026)

Date Added: 21 Jul 2026

Catalyst: Earnings

We are initiating a 90-day Upside Catalyst Watch on MicroPort MedBot. We reckon the recent share price retreat as profit taking after the order number disclosure by the end of 1H26. However, we expect the key catalyst will be the forward-looking guidance provided at the post-earnings call following 1H26 results. We expect management to confirm continued strong overseas order momentum and, critically, raise its global installation guidance above the previous target of 200 units for FY26. Such a guidance raise would serve as a powerful confirmation of the company's accelerating global commercialization trajectory, likely acting as a significant re-rating event and driving positive estimate revisions across the Street.

## MicroPort MedBot

## Valuation

We set our target price for MicroPort MedBot shares at HK\$41, which is derived from a DCF model with WACC of 9.4%, beta of 0.8 and a terminal growth rate of 3.0%. We opt for DCF, similar to our approach for the company's peers, in view that the company to generate positive cash inflow from 2026.

## Risks

We rate the MedBot stock High Risk based on our quant risk rating system, which tracks share price volatility. Key downside risks that could impede the stock from reaching our target price include sales interruption on heavier-than-expected anti-corruption campaign impact, lack of profitability, R&D failures, increasing competition, regulatory risks, reputational risk if severe AE happens, and price cuts.
