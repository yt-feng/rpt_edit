...
Model projection: 6.7822 versus 6.7906 previous (84 pips lower; 116 pips higher from the previous official spot close).

Model projection with counter-cyclical factor: 6.7880 (26 pips lower from previous fix).
