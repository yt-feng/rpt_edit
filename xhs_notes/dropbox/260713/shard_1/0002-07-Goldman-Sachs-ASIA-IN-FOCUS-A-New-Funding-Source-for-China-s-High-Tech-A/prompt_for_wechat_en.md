...
Some complementary funding may come from the government budget rather than purely incremental private-sector capital, so its multiplier effect should not be double counted.

■ NPBFI implementation – particularly during policy bank bond issuance and local government resource re-allocation – may divert financing from other investment projects already in the pipeline.

Relatively weak incentives for local officials to launch major investment projects in recent years – amid high-pressure anti-corruption campaigns and local-level political reshuffles – could remain a bottleneck for policy implementation. With subdued private-sector credit demand, as evidenced by the continued decline in TSF stock growth in recent quarters (Exhibit 8), some projects financed by NPBFI could be projects that would have been financed anyway with or without NPBFI, implying little additional boost to total investment.

Exhibit 7: High-tech investment continues to outpace headline FAI  
![](images/9cc39a7234fb39529028e57b99c8b4ad1f1397a4cdca0140935547babc604e5e.jpg)  
Source: NBS, Wind, GS Global Investment Research

Exhibit 8: TSF stock growth has continued to slow in recent quarters despite measured fiscal expansion  
![](images/f7eddd41408df331df41398d99a3314b95b971b01952cc0d2aedccb74a992672.jpg)  
Source: PBOC, Wind, Data compiled by GS Global Investment Research

Our earlier study finds that a 1pp widening in the augmented fiscal deficit (AFD) would lift China's real GDP level by a cumulative 0.5pp four quarters after the shock. Given the NPBFI's short track record and rising concerns about FAI data quality, estimating its fiscal impulse precisely is challenging. We therefore use scenario analysis, assuming fiscal multipliers of 0.5x, 1x, and 2x in our conservative, baseline, and optimistic scenarios, respectively.

Specifically, we estimate that the RMB500bn NPBFI deployed in September-October 2025 lifted real GDP level by a cumulative 0.2pp, 0.4pp, and 0.7pp in the conservative, baseline, and optimistic scenarios, respectively (after rounding), over the following four quarters, with most of the impact concentrated in 2026. Assuming the planned

RMB800bn NPBFI for this year will be implemented in Q3, we estimate a baseline GDP impact of 0.5pp (with conservative and optimistic impacts of 0.3pp and 1.1pp, respectively), likely concentrated in late 2026 and early 2027 (Exhibit 9).

Fiscal policy dragged on growth in Q2 as government spending slowed meaningfully after a strong Q1. We expect central and local governments to increase bond issuance, accelerate proceeds spending, and speed up NPBFI implementation in the coming months.

Exhibit 9: Estimated GDP impact of the RMB800bn NPBFI in coming quarters  
![](images/074af031c3212fe51ea569df112589b83ffcce33f4632d2f02b431cf89a89575.jpg)  
Source: GS Global Investment Research  
Exhibit 10: Policy bank funding via P
