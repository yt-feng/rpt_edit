...
Model projection: 6.7824 versus 6.7934 previous (110 pips lower; 51 pips higher from the previous official spot close).

Model projection with counter-cyclical factor: 6.7862 (72 pips lower from previous fix).
