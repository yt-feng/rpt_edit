...
For central banks, the response is less clear. As an isolated event, El Niño can be a relative price shock for agricultural commodities. Energy provision can also be affected when this depends on hydro sources. The headline inflation impact can usually be ignored as a temporary influence. From a central banking perspective, the key question is not whether these prices r
