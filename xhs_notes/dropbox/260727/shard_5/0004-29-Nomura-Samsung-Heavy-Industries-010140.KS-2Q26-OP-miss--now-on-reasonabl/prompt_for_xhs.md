...
Our TP of 25,000 is based on a 12-month-forward (12MF) BVPS of KRW7,456 (previously: 12MF BVPS of KRW6,738), multiplied by a target P/B of 3.35x (previously: 4.01x). Our target P/B implies a $4.3\%$ premium to SHI's implied P/B of 3.21x. We factor in the premium coming from the US naval opportunity, as SHI is now p
