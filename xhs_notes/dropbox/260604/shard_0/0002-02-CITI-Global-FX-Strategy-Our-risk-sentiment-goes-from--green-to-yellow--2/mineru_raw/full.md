...
The market has been anticipating an Iran deal, with much of the good news potentially priced-in. This creates risk of a “sell the rumor” dynamic once/if a resolution is confirmed. A negative sign for markets would be if the rally is short-lived and quickly reverses after such an announcement.

Figure 11. S&P 500 (2021-2022) with COVID vaccine milestones – the market adage of “buy the rumor, sell the news” in effect   
![](images/ff946b9012105aabfbf9ac5633c9260f12398a662f7584ce1fb61bffd7edf9e9.jpg)

<details>
<summary>line</summary>

| Date       | SPX Index (S&P 500 INDEX) - Last Price |
| ---------- | ------------------------------------- |
| Aug 21, 2021 | 4176.81982                          |
</details>

© 2026 Citi Inc. No redistribution without Citi's written permission.   
Source: Citi, Bloomberg

\- Data/Fed/etc.: The usual suspects of bad data, hawkish Fed, etc. Hawkish central banks are largely priced, but any inflation surprises that push yields higher could be negative for risk assets. This could also be reflected in a pick-up in term premium, especially if fiscal looseness is used to offset energy impacts globally.

This is not necessarily a comprehensive checklist, simply some items we are closely watching. Narratives can often be applied retroactively to price action, though, so we watch for both the market reaction to events as well as the events themselves

# Implications for FX

We revisit FX performance when equities are negative, but condition on whether yields are higher or lower (we use the S&P 500 Index and the US 10yr yield as proxies). We observe that the FX reaction in risk-off is quite different based on how yields react (Figure 12 and 13).

Figure 12. G10 FX performance – equities down, yields down (2021-present, based on US 10y and S&P 500)   
![](images/6738ffb6a782da43f9ea7fc7c9caefe892318b8f310fe56c38e22da88629efe9.jpg)

<details>
<summary>scatter</summary>

| Currency | % of up days | Average daily return (%) |
|----------|--------------|--------------------------|
| JPY      | 67%          | 0.25%                    |
| CHF      | 58%          | 0.12%                    |
| EUR      | 49%          | -0.02%                   |
...
Figure 13. G10 FX performance – equities down, yields up (2021–present, based on US 10y and S&P 500)   
![](images/eee0b2fcd8f03de2c0804745d8e1539a3b96a4a1d2c45510c276307645f3fdb6.jpg)
...
The post-dot-com era saw equities lower more consistently with yields lower. That has shifted in the post-COVID era, as we see increased frequency of equities lower with yields higher (Figure 14). Given the current backdrop, both scenarios (equities down with yields either up or down) seem probable.

As we’ve been noting, we are not necessarily outright bearish risk. Rather, we see increased potential for a correction – though timing and catalyst are uncertain. Pre-COVID, it was easier to think about FX hedges as the equities down/yields down regime was more common. Therefore, lower cross-JPY (and especially AUDJPY) was the clear risk-off trade in G10 FX.

However, the increased frequency of equities down with yields up – along with negative JPY fiscal fundamentals – haa diminished the role of JPY as “safe haven” currency. We have always seen JPY as a rates trade rather than an equities trade, but the higher frequency of yields down/equities down pre-COVID created a view that JPY was a “safe haven” currency. Correlation without causation, in our view, as it are yields that drive JPY. And we can see in a world of equities down/yields up, JPY is actually one of the worst-performing currencies.

Given relatively low implied vol (which is now below realized vol) in JPY (Figure 15), strangles may provide an attractive hedge given the uncertain direction on yields.

Figure 14. Frequency of equities down/yields up is increasing post-COVID   
![](images/a552c242528c6cd1c5a2a5ac69cd22d92f9c56150014fc883b3c72052a124e62.jpg)

<details>
<summary>area</summary>

| Year | Yields up + Equities down | Yields down + Equities down |
|------|---------------------------|-----------------------------|
| 90   | ~62%                      | ~38%                        |
| 92   | ~63%                      | ~37%                        |
| 94   | ~62%                      | ~38%                        |
...
Figure 15. USDJPY implied vol is historically low and also below realized vol   
![](images/d4d95ac56b9b4331bacf0f619a7b41b036dd76d0c60b15b425db17e443cdb703.jpg)

<details>
<summary>line</summary>

| Date   | USDJPY 3m implied vol | USDJPY 3m realized vol |
|--------|------------------------|-------------------------|
| Jun/21 | ~5.5                   | ~5.0                    |
| Jun/22 | ~12.0                  | ~11.5                   |
| Jun/23 | ~10.5                  | ~10.0                   |
...
The other common theme when equities head lower is consistent underperformance by high beta/risk currencies. In light of the current backdrop (Figure 16), we would be hesitant to hedge risk-off in those currencies with positive terms of trade related to the conflict as they could still outperform if conflict re-escalation is the risk-off catalyst (and here we specifically mean AUD and NOK). We therefore prefer puts in NZD and SEK (versus AUD and NOK) as hedges as there are more scenarios for these currencies to potentially underperform, and they tend to perform similarly poorly to other high beta currencies in risk-off.

However, we flag a major caveat. With the World Cup starting June 11, it is worth remembering FX vol tends to drop around this event (Figure 17). This could create some short-term issues for risk-off hedges, which are typically long vega. That may require some patience in layering into hedges, or looking for creative expressions (e.g., calendar spreads, condors).

Figure 16. Terms of trade has been a major FX since the conflict began   
![](images/88580ba3e0356e96ae805d2a492d1cabe6368de54926be84879037b851faf0f4.jpg)

<details>
<summary>scatter</summary>

| Currency | Latest Citi commodities ToT index | Chg in CCYUSD (%) |
|----------|------------------------------------|-------------------|
| NOK      | 100                                | 2.5               |
| AUD      | 50                                 | 1.0               |
| GBP      | 10                                 | -0.5              |
...
Figure 17. FX vol tends to drop into the World Cup   
![](images/9f45f798d90d613107d492c8140b4b37319fda058613f6b1d152698b5e686db5.jpg)

<details>
<summary>line</summary>

| Weekdays around first World Cup game | Mean | Median | 75th & 25th Pctl | Benchmark (mean) |
| ------------------------------------ | ---- | ------ | ---------------- | ---------------- |
| T-22                                 | 0.2  | 0.1    | -0.3             | 0.0              |
| T-20                                 | 0.4  | 0.3    | 0.6              | -0.1             |
| T-18                                 | 0.6  | 0.5    | 0.8              | -0.2             |
| T-16                                 | 0.7  | 0.6    | 0.9              | -0.3             |
| T-14                                 | 0.6  | 0.5    | 0.8              | -0.4             |
| T-12                                 | 0.5  | 0.4    | 0.7              | -0.5             |
| T-10                                 | 0.4  | 0.3    | 0.6              | -0.6             |
| T-8                                   | 0.3  | 0.2    | 0.5              | -0.7             |
| T-6                                   | 0.2  | 0.1    | 0.4              | -0.8             |
| T-4                                   | 0.1  | 0.0    | 0.3              | -0.9             |
| T-2                                   | 0.0  | -0.1   | 0.2              | -1.0             |
...
<table><tr><td>Within the past 12 months, Citi Global Markets Inc. or its affiliates has acted as manager or co-manager of an offering of securities of Sweden.</td></tr><tr><td>Citi Global Markets Inc. or its affiliates has received compensation for investment banking services provided within the past 12 months from Australia, Commonwealth of (Government),Japan,New Zealand,Norway,Sweden,United States.</td></tr><tr><td>Citi Global Markets Inc. or its affiliates expects to receive or intends to seek, within the next three months, compensation for investment banking services from Norway.</td></tr><tr><td>Citi Global Markets Inc. or its affiliates received compensation for products and services other than investment banking services from Australia, Commonwealth of (Government),Japan,New Zealand,Norway,Sweden,United States in the past 12 months.</td></tr><tr><td>Citi Global Markets Inc. or its affiliates currently has, or had within the past 12 months, the following as investment banking client(s): Australia, Commonwealth of (Government),Japan,New Zealand,Norway,Sweden,United States.</td></tr><tr><td>Citi Global Markets Inc. or its affiliates currently has, or had within the past 12 months, the following as clients, and the services provided were non-investment-banking, securities-related: Australia, Commonwealth of (Government),Japan,New Zealand,Norway,Sweden,United States.</td></tr><tr><td>Citi Global Markets Inc. or its affiliates currently has, or had within the past 12 months, the following as clients, and the services provided were non-investment-banking, non-securities-related: Australia, Commonwealth of (Government),Japan,New Zealand,Norway,Sweden,United States.</td></tr><tr><td>Citi Global Markets Inc. and/or its affiliates has a significant financial interest in relation to Australia, Commonwealth of (Government),Japan,New Zealand,Norway,Sweden,United States. (For an explanation of the determination of significant financial interest, please refer to the policy for managing conflicts of interest which can be found at www.citiVelocity.com.)</td></tr><tr><td>Analysts&#x27; compensation is determined by Citi management and Citi&#x27;s senior management and is based upon activities and services intended to benefit the investor clients of Citi Global Markets Inc. and its affiliates (the &quot;Firm&quot;). Compensation is not linked to specific transactions or recommendations. Like all Firm employees, analysts receive compensation that is impacted by overall Firm profitability which includes investment banking, sales and trading, and principal trading revenues. One factor in equity research analyst compensation is arranging corporate access events between institutional clients and the management teams of covered companies. Typically, company management is more likely to participate when the analyst has a positive view of the company.</td></tr><tr><td>For financial instruments recommended in the Product in which the Firm is not a market maker, the Firm is a liquidity provider in such financial instruments (and any underlying instruments) and may act as principal in connection with transactions in such instruments. The Firm is a regular issuer of traded financial instruments linked to securities that may have been recommended in the Product. The Firm regularly trades in the securities of the issuer(s) discussed in the Product. The Firm may engage in securities transactions in a manner inconsistent with the Product and, with respect to securities covered by the Product, will buy or sell from customers on a principal basis.</td></tr><tr><td>Unless stated otherwise neither the Research Analyst nor any member of their team has viewed the material operations of the Companies for which an investment view has been provided within the past 12 months.</td></tr><tr><td>For important disclosures (including copies of historical disclosures) regarding the companies that are the subject of this Citi product (&quot;the Product&quot;), please contact Citi, 388 Greenwich Street, 6th Floor, New York, NY, 10013, Attention: Legal/Compliance [E6WYB6412478]. In addition, the same important disclosures, with the exception of the Valuation and Risk assessments and historical disclosures, are contained on the Firm&#x27;s disclosure website at https://www.citivelocity.com/cvr/eppublic/citi_research_disclosures. Valuation and Risk assessments can be found in the</td></tr></table>

text of the most recent research note/report regarding the subject company. Pursuant to the Market Abuse Regulation a history of all Citi recommendations published during the preceding 12-month period can be accessed via Citi Velocity (https://www.citivelocity.com/cv2) or your standard distribution portal. Historical disclosures (for up to the past three years) will be provided upon request.
