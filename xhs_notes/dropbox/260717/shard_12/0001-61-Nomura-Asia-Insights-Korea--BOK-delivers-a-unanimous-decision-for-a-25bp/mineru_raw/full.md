...
Governor Shin declined to make pre-commitment to the future path of the policy rate, saying that the policy rate path was not predetermined and that the Board would closely examine incoming data, including the advance Q2 GDP estimate (due on 23 July) and July CPI inflation data (due to 4 August).
