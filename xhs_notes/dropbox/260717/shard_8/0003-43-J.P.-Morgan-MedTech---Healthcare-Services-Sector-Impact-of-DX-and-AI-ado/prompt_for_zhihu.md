...
<table><tr><td>Examination Method</td><td>Examination Site</td><td>Main AI Products</td></tr><tr><td>Upper GI Endoscopy</td><td>Oral CavityPharynx, LarynxEsophagusStomachDuodenum</td><td>AI Medical Service (gastroAI model-G2)Fujifilm (CAD EYE)Olympus (esophagus only, CADU)</td></tr><tr><td>Capsule Endoscopy</td><td>Small Intestine</td><td>None</td></tr><tr><td>Lower GI Endoscopy</td><td>ColonAnus</td><td>Fujifilm (CAD EYE)Olympus (EndoBRAIN, CADDIE)AI Medical Service (gastroAI model-EIRL)NEC (WISE VISION)</td></tr></table>
