...
We hosted the China Memory Expert Webinar on July 24. The discussion was mainly on China DRAM capacity expansion, product development, and overall memory price trends. The expert's comments echoes our positive view on China SPE, which we expect to ride on the local foundries' and memory factories' capacity expansion in coming years, with growing adoption of local SPEs. Buy: Naura, AMEC, ACMR, Kematek; Read more: China Semis self-sufficiency (2023), China Semi's accelerating momentum (2024), China Semi's capex and migration (2025).
...
contracts between memory suppliers and customers, which is positive to memory price stabilization.
...
ACM Research (Buy, \$88.42), AMEC (Buy, Rmb388.50), Kematek (Buy, Rmb94.60) and NAURA (Buy, Rmb757.00)
