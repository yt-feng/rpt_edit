...
PBoC FX policy since 2Q25 has reflected a well-calibrated stance. On one hand, the near one-way glide in the daily fixing signals the PBoC's comfort with a stronger CNY and a directionally lower USD/CNH. On the other, the persistently wide spot–fix gap and continued smoothing via agent banks underscore the authorities' intent to retain control over the pace of appreciation. In practice, CNY gains have been tightly managed, with six-month total returns on long-CNY positions capped at around 2%—well below previous appreciation cycles (Figure 17).

This managed approach has worked in the PBoC's favor along several dimensions. The pace has been firm enough to incentivize corporates to reduce elevated USD holdings and FX exposure, yet gradual enough to avoid disorderly or panic-driven selling that often leads to higher FX volatility. By containing total returns, the authorities also deter excessive speculative inflows that could later unwind abruptly. Consistent with this, speculative positioning appears materially lighter than in prior cycles, as reflected in a relatively contained CNH–CNY basis throughout this appreciation cycle (Figure 18). At the same time, a stronger yuan has supported domestic asset valuations and created return synergies, helping to attract foreign inflows and advance PBoC's broader objective of RMB internationalization.

That said, historical precedent suggests the PBoC's tolerance for currency strength is not unlimited—an important source of investor anxiety given the well-subscribed bullish CNY theme, following a roughly $6\%$ year-on-year decline in USD/CNH and increasingly crowded positioning. Looking back, there have been episodes of policy-engineered weakness once appreciation was judged to have overshot, most notably in early 2022, which marked a turning point from the appreciation cycle that began in 2020.

However, we do not think the current environment is close to that threshold. On a trade-weighted basis, overvaluation was far more pronounced in past episodes, with the CNY NEER reaching around 13% above trend at its peak (Figure 19). By contrast, although the CFETS TWI has risen by more than 8% year-on-year, it is only about 4.5% above trend—well short of prior extremes—suggesting limited urgency for the PBoC to cap CNY strength or engineer outright depreciation. Moreover, the PBoC has historically maintained a supportive FX stance around major diplomatic engagements (Figure 20). A pipeline of presidential meetings in the coming months, including a potential state visit by President Xi to the US, provides an additional anchor for near-term policy support. Against this backdrop, the risk of a sudden, policy-driven reversal in USD/CNY appears low. If anything, risks may be tilted toward stronger-than-expected spot appreciation. The accelerated decline in CNY fixings in recent months, alongside widening US–China yield differentials, raises a tentative possibility that the PBoC may be leaning toward a more total-return-oriented FX framework—allowing or engineering greater spot strength to offset structurally negative carry.

We head into 2H26 expecting the CNY appreciation trend to remain intact, albeit at a softer pace against the USD amid a broader bullish turn in the dollar (FX Mid-Year Outlook: Ten questions and answers on currencies in 2H26). Our year-end forecast stands at 6.70. We remain positioned for further CNY strength via options (long 3m USD/CNH 6.75 puts), while staying open to rotating into higher CNH crosses, where we see greater headroom for CNY TWI appreciation should DXY momentum strengthen further in the months ahead.

Figure 17: A managed appreciation has limited the total return from CNY longs  
![](images/c7f4e9110392393ff599eb5db1f9e68e45fd08a399d924a2f483e926cefb0738.jpg)  
Source: Bloomberg Finance L.P., JPM  
Figure 19: CNY NEER looks still far from previous cycle extremes

Figure 18: Speculative positioning appears materially lighter than in prior cycles, as reflected in a relatively contained CNH–CNY basis  
![](images/23a51a7f754cab2c17cc409214bdb967e4bfd7cd1f23900586774df048072717.jpg)  
Source: Bloomberg Finance L.P., JPM

![](images/1b653414d80f3c57b557a182ba0d337d9a30ad3725132e2d119e4774718b426b.jpg)  
Source: Bloomberg Finance L.P., JPM

Figure 20: The PBoC tends to maintain a supportive FX stance around presidential summits  
cumulative change in CNY fix, T indicates the date of presidential summits  
![](images/d56dc5ac10235589660b69c7c36212640f411adc346637f6b7223fcd050c76ae.jpg)  
Source: Bloomberg Finance L.P., JPM

## CNY Rates (4Q26 10y CGB yield: 1.80%): Neutral local duration, expecting yields to range bound

A liquidity-charged duration rally in 1H26. CNY rates have remained relatively insulated from the global rate sell-off in 1H26, with Chinese bonds emerging as a relative safe haven amid rising yields elsewhere. Combined with currency appreciation, Chinese bonds delivered around 5% total return in the first half of the year (Figure 21). While this trails the double-digit gains seen in the absolute higher-yielder such as COP, HUF, and BRL rates, it is still notable for a low-yielding market as it has outperformed both major DM rates and regional Asian peers. CGB yields declined by 4–17bp across the curve, led by a richening in the front end (Figure 22). The resulting bull-steepening suggests that the rally was primarily driven by looser-than-expected liquidity conditions, which typically favor short-end bonds. Our liquidity conditions index indicates that overall conditions have eased to their most accommodative level since 2022 (Figure 23). While the period of easy liquidity conditions initially stemmed from above-average injections by the PBoC in January and February, these conditions have remained broadly intact through 2Q, even as the PBoC shifted toward liquidity drains in recent months (Figure 24).

Figure 21: Chinese bonds have emerged as a relative safe haven amid recent global rate sell-offs  
![](images/67f776633c5c50cd8af8c146bbfeaf93ebf4bf849e55c45c9563eff119ec4775.jpg)  
Source: JPM

Figure 22: Bond yields have fallen across the curve  
![](images/e57e416a597062cd71d8937ca80bac46f3b9bb6e86b2f43e141df8d13636836c.jpg)  
Source: SAFE, JPM

Figure 23: Liquidity conditions eased to the most accommodative level since 2022, ...  
![](images/dc543b52f56828a51b7baf3f3487df61b793beb78c4630ebb01966143111a49d.jpg)  
Source: JPM

Figure 24: , ... before PBoC's liquidity drains leading to marginal tightness  
![](images/4f14be513b5ff7c4c5893b95d5f8b0fe0aecbd190b418c79e8fd64ec3a53996f.jpg)  
Source: PBoC, JPM

The yield hunt by domestic investors, amid subdued credit demand, continues to underpin strong duration demand. Against a backdrop of ample liquidity, the search for yield by investors has intensified, as reflected in the visible outperformance of bonds over swaps—suggesting that asset allocation demand from onshore investors has been a key driver behind the smoother-than-expected decline in bond yields. This came against a backdrop of tepid loan growth (Figure 25), as both investment and consumption have lost momentum in recent months (Figure 26). In contrast, deposit growth has remained robust, dispelling earlier concerns that a large stock of maturing time deposits could be reallocated into risky assets, triggering deposit outflows from banks, potentially putting pressure on bond demand. Instead, deposit growth has held steady at above 9% in 1H26, significantly outpacing loan growth of around 5%. At the same time, the liquidity glut has also been reinforced by growing AuM in wealth management products following an early-year dip, alongside sustained inflows into bond and money market funds (Figure 27). This combination has provided a solid flow backdrop for duration demand, further intensifying the yield search among domestic investors. As a result, not only have government bond yields moved lower, but demand has also broadened to onshore credit bonds offering higher yields. Credit spreads on onshore corporate bonds have consequently compressed to their tightest levels on record (Figure 28).

Figure 25: Deposit growth has far outpaced loan growth, ...  
![](images/c5ed348b72da2adc28918368d5179835682548007f7c1b75160e21abf7e96dc5.jpg)  
Source: Haver, JPM

Figure 26: , ... against a backdrop of softening domestic investment activities  
![](images/1f1c9ea40b798efc4c172f87020d3fd0a53ca8f31ffd1337f4b2ed43c473c03d.jpg)  
Source: Wind, JPM

Figure 27: Expanding AuMs in domestic bond funds and wealth management products underscores robust flow support for Chinese bonds  
![](images/efdfb1016f0e7f2cf466d89605ca07c5deba24e7e32ab783e1ed682f5d917af9.jpg)  
Source: Wind, JPM

Figure 28: The intensified yield hunt from domestic Chinese investors has driven onshore credit spread to historical tights  
![](images/c02fb748a100ccec42d83b251908576a08a9293ba6693741442d6be1a4da4a45.jpg)  
Source: Wind, JPM

The PBoC's pushback against declining yields has remained measured. Beyond signaling discomfort with the intensifying liquidity glut—evidenced by proactive liquidity drains to manage deviations of money market rates from policy rates—the central bank has refrained from directly guiding banks to curb bond purchases. This restraint partly reflects the still-moderate level of market trading activity. While turnover in CGBs has picked up, it remains well below previous extremes (Figure 29), suggesting limited signs of overheating that would otherwise warrant stronger regulatory intervention. As we have noted previously, recent liquidity withdrawals should not be interpreted as a shift toward outright tightening. Rather, they appear aimed at mitigating the risk of a liquidity trap, where weak credit demand and excess liquidity could fuel speculative trading and weaken monetary policy transmission. At the latest Lujiazui Forum, the PBoC refined its operational framework by enhancing its overnight liquidity facilities, narrowing the rate corridor to ±25bp around the 7-day reverse repo rate (from +50/-20bp previously), and signaling a gradual move toward incorporating the overnight rate as a policy target (EM Quicktake: New PBoC facilities announced at Lujiazui). These adjustments should help to improve control over short-term funding costs and reduce rate volatility. With the overnight repo rate now broadly re-anchored around 1.4% in line with policy rates, we believe the risk of further policy-induced tightening has diminished in the near term (Figure 30).

Figure 29: While turnover of CGB trading has picked up, it remains well below previous extremes  
![](images/03bae05c0a5acba024d2b3a378f0025f40260e5518eed842925d4c298eaf115c.jpg)  
Source: Wind, JPM

Figure 30: The overnight repo rate is now re-anchored to PBoC's policy rate, reducing near-term risks of further policy-engineered tightening  
![](images/43131cb86a69a0af677c27958db97211de2fd3d86d222a57816b2a0903f06bb0.jpg)  
Source: Bloomberg Finance L.P., JPM

Bond supply is set to pick up after net issuance has lagged last year's pace. While the risk of policy-engineered tightening has diminished, CNY rates still need to contend with a seasonal increase in bond issuance and the associated liquidity shortfalls in the coming months. Historically, liquidity conditions tend to ease into mid-year before tightening from late 3Q onwards (Figure 31). This pattern has often been driven by back-loaded bond issuance, with $60\%$ of the net government bond supply used to be concentration in 2H. That said, since last year, bond supply—particularly CGB issuance—has become less back-loaded. So far this year, issuance has trailed last year's pace (Figure 32), implying somewhat heavier supply pressure ahead. However, we expect the PBoC to provide the necessary liquidity to offset this supply pickup, helping to anchor money market rates within its newly defined rate corridor, which should largely limit the supply overhang for CNY rates.

Figure 31: Liquidity conditions tend to ease into mid year before tightening from late 3Q onwards  
![](images/767e3ebb1e4f0191d8bb6917948721fa82c3e570c6ce07a046fd079c735c9ba4.jpg)  
Source: JPM

Figure 32: Government bond issuance this year has trailed last year's pace  
![](images/a0598dc20e4284f783d13431abbe7fa60eb2fb76077df1db91f6afc4d3a5fdae.jpg)  
Source: Wind, JPM

We remain MW in CNY rates, expecting yields to stay broadly range-bound (YE target for 10y CGB yields at 1.8%). As we head into 2H26, valuations look slightly rich, with 10Y CGB yields trading around 10bp below our estimated fair value of 1.85% (Figure 33). While these technicals point to near-term upside risks to yields, the misalignment is not large enough to suggest a meaningful risk of trend reversal. The

strong duration demand discussed above is unlikely to fade unless domestic demand shows a sustained recovery. While there is some optimism that an end to the Middle East conflict and a pickup in lagged fiscal spending could support a rebound in investment activity in the 2H, structural headwinds—including household balance sheet constraints and a prolonged property downturn—are likely to limit the scope for a domestically driven reflation, thereby keeping a cap on yields. Expectations for additional PBoC easing remain modest, with the forward curve pricing in roughly 5bp of cuts in the coming months, which we view as reasonable (Figure 34). Against this backdrop, we maintain a neutral stance on CNY rates.

Figure 33: 10y CGB yields are trading slightly rich vs our model, though the misalignment is not large enough to suggest meaningful risks of trend reversal  
![](images/5e36f81f198c7dfec3a3a34ffd206ab518ffdb1f1bd41f68275f2dd72d1994e2.jpg)  
Source: JPM

Figure 34: CNY rates have low expectations of further PBoC rate cut  
![](images/eb08f220167c2402bd1af620a489da90ba19d982f5af0833bd14f763732dd653.jpg)  
Source: Bloomberg Finance L.P., JPM

## China Local Markets Publications in 2026

\- EM Quicktake: New PBoC facilities announced at Lujiazui - Jun 17, 2026 - see here

\- HK/China: Capital Flow Policy: Mixed impacts, clearer framework - Jun 17, 2026 - see here

\- China Local Markets Weekly: Cross-border tightening and FX impact; growing importance of o/n rates in PBoC's policy framework - Jun 12, 2026 - see here

\- China Local Markets Weekly: CNY FX awaits fresh signals; stay bullish while calibrating forecasts - Jun 06, 2026 - see here

\- China Local Markets Weekly: Stay bullish CNY post Trump-Xi summit; PBoC 1Q monetary policy report highlights - May 16, 2026 - see here

\- China Local Markets Weekly: Add downside USD/CNH in options amid moderating PBoC resistance and upcoming Trump-Xi summit - May 8, 2026 - see here

\- China Local Markets Weekly: FX in a holding pattern, while rates on a liquidity charge - Apr 30, 2026 - see here

\- China Local Markets Weekly: Lower USD/CNY target to 6.70 - Apr 17, 2026 - see here

\- China Local Markets Weekly: The Hormuz reprieve; loose liquidity conditions a duration tailwind - Apr 12, 2026 - see here

\- China Local Markets Weekly: Quicktake on weaker CNY fixings; capped fuel price surge eases near-term inflationary pressure on CNY rates - Mar 28, 2026 - see here

\- China Local Markets Weekly: Signals from the tape: February flows at a glance - Mar 20, 2026 - see here

\- China Local Markets Weekly: Re-engage with CNH longs on China's relative resilience; imported-inflation fears for CNY rates overdone - Mar 13, 2026 - see here

\- China Local Markets Weekly: NPC is a non-event; implications from the Middle East Conflict - Mar 6, 2026 - see here

\- CNY FX: A pause to the party: tactically take profit on CNH longs - Feb 27, 2026 - see here

\- China Local Markets Weekly - CFETS TWI's new weights underlie CNY's reduced sensitivity to JPY; demand recovery in bonds seen amid soft credit growth - Jan 30, 2026 - see here

\- China Local Markets Weekly - Record trade surplus and record USD selling from Chinese corporates - Jan 17, 2026 - see here

\- China Local Markets Weekly - A happy new year for CNY FX; lowering USD/CNY target to 6.85 - Jan 9, 2026 - see here

\- China Local Markets 2026 Outlook: Enter 2026 bullish CNY FX and neutral CNY rates - Nov 28, 2025 - see here
