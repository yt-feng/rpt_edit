...
PBoC FX policy since 2Q25 has reflected a well-calibrated stance. On one hand, the near one-way glide in the daily fixing signals the PBoC's comfort with a stronger CNY and a directionally lower USD/CNH. On the other, the persistently wide spot–fix gap and continued smoothing via agent
