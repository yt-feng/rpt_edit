...
Figure 15: LNG tanker arrivals in China (DWT in million)   
![](images/6f706fd2d3e1555cdd0ee75084703d815168b96fc275655a8ba1ca3282ddc785.jpg)

<details>
<summary>area</summary>

| Month | 5-year ragne | 2025 | 2026 | 5-year average |
|-------|--------------|------|------|----------------|
| Jan   | 2.8          | 2.5  | 2.4  | 2.3            |
| Feb   | 1.8          | 0.9  | 1.3  | 1.7            |
| Mar   | 1.5          | 1.3  | 1.4  | 1.8            |
...
Figure 16: LNG tanker arrivals in Korea (DWT in million)   
![](images/5c870e76e640a079e0516a436a51f0cdca4cce723633857f3528cbbf01a266c9.jpg)
...
Figure 17: LNG tanker arrivals in Taiwan (DWT in million)   
![](images/ffe834cf5e6444b20de5ce1ef29e1e86193b5b6e9975cadd2157fc863ee721c7.jpg)
...
Figure 18: LNG tanker arrivals in India (DWT in million)   
![](images/11084b0fd85497769de3617916c5c96cd5c441c47de9dd2c3a2196d7fee01af2.jpg)
...
# Global Maritime Cargo Monitor - LNG & LPG (>Access Dataset)

This report leverages the following UBS Evidence Lab asset: Global Maritime Cargo Monitor - LNG &LPG. UBS Evidence Lab uses hourly AIS (Automated Information System) data to monitor the locations of more than 35,200 commercial maritime vessels (tankers, bulkers, containers) sailing around the globe. Each ship has a unique identification number (IMO number) which is connected to vessel characteristics data including cargo type, size, and capacity in order to calculate the quantity and aggregated cargo tonnage moving through global maritime points of interest (regions, and ports). UBS Evidence Lab has conducted thorough benchmarking and has designed proprietary cleaning techniques to ensure the data is accurate by reducing the noise associated with AIS data.

# European Natural Gas Monitor (>Access Dataset)

This report leverages the following UBS Evidence Lab asset: European Natural Gas Monitor. UBS Evidence Lab monitors gas storage and flows across 25 European nations using daily data on gas storage and gas movements. Data is sourced from an independent trade organization. Due to duplicated gas storage and flows figures in raw data, UBS Evidence Lab eliminated them to limit the overestimation of gas movements to EU countries. Volumes are aggregated and converted to common units for ease of use and comparison.

# Valuation Method and Risk Statement

The risks associated with our investment thesis include volatility in oil and natural gas prices, margins for global refining, marketing, and chemicals, as well as normal exploration risks associated with the oil and gas business.
...
UBS AG London Branch: Ellinor Cederstroem Palliotto, Joshua Stone, Leo Currie, Nayoung Kim. UBS Europe SE: Henri Patricot, CFA. UBS LLC: Josh Silverstein.
