...
Model projection: 6.7724 versus 6.7911 previous (187 pips lower; 50 pips higher from the previous official spot close).

## Research Analysts

Model projection with counter-cyclical factor: 6.7802 (109 pips lower from previous fix).
