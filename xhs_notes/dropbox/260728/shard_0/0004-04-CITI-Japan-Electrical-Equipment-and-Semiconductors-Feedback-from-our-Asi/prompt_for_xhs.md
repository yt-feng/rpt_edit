...
Feedback from our Asia investor tour
...
Kioxia/AI-related — As Kioxia shares fell c50% from a June 22 high of ¥112,700, we found a notable number of investors were still bullish on the fundamentals outlook in the first part of the week, mostly ascribing the fall to memory share deleveraging centered on Korea. Later in the week however, concern was expressed about the memory supply/demand outlook from 2027 H2. Also, the July-September NAND price consensus was a QoQ increase of c20% and many investors thought positive surprises were probably unlikely with April-June results. Investors were wary on the near-term share prices of companies that have been seen as AI-related names (this includes Kioxia, Renesas Electronics, and Panasonic Holdings in our coverage) and some spoke of reducing AI-related exposure. Our NAND sector view is that supply shortages will continue in 2026-2027 given significant growth in demand in the data center KV cache space.
...
Takero Fujiwara $^{AC}$ +81-3-6776-4642
...
<table><tr><td>Citi Global Markets Japan Inc.</td><td>Takero Fujiwara</td></tr></table>
...
The proportion of all Citi recommendations that were the equivalent to "Buy", "Hold", "Sell" at the end of each quarter over the prior 12 months (with the % of these that had received investment firm services from Citi in the prior 12 months shown in brackets) is as follows; Q1 2026 Buy $33\% (63\%)$ , Hold $44\% (52\%)$ , Sell $23\% (46\%)$ , RV $0.5\% (89\%)$ : Q4 2025 Buy $33\% (63\%)$ , Hold $44\% (50\%)$ , Sell $23\% (46\%)$ , RV $0.4\% (91\%)$ ; Q3 2025 Buy $33\% (61\%)$ , Hold $44\% (52\%)$ , Sell $23\% (50\%)$ , RV $0.4\% (80\%)$ ; Q2 2025 Buy $33\% (63\%)$ , Hold $44\% (51\%)$ , Sell $23\% (49\%)$ , RV $0.4\% (86\%)$ . For the purposes of disclosing recommendations other than for equity (whose definitions can be found in the corresponding disclosure sections), "Buy" means a positive directional trade idea; "Sell" means a negative directional trade idea; and "Relative Value" means any tra
