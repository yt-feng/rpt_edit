...
\- There's no quick fix, but we think there are four likely scenarios where MedTech can recapture investor interest here: (1) a large risk-on event (peace in Iran, Ukraine) could drive significant re-grossing at hedge funds and capital deployment into Medtech, and specifically quality growth; (2) the demis
