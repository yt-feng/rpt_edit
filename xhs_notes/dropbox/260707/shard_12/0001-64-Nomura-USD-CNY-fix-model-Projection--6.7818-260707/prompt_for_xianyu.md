...
Model projection: 6.7818 versus 6.8066 previous (248 pips lower; 107 pips lower from the previous official spot close).

Model projection with counter-cyclical factor: 6.7846 (220 pips lower from previous fix).
