...
\- April 2026 US containerized imports pulled back modestly post March rebound, as trade policy uncertainty weighed on near-term momentum. Monthly container import volume declined $3.2\%$ M/M and $5.5\%$ Y/Y, totaling 2,277,965 TEUs (Descartes). Despite the sequential pullback—breaking from the typical seasonal pattern 
