...
Model projection: 6.7760 versus 6.7917 previous (157 pips lower; 92 pips higher from the previous official spot close).

Model projection with counter-cyclical factor: 6.7844 (73 pips lower from previous fix).
