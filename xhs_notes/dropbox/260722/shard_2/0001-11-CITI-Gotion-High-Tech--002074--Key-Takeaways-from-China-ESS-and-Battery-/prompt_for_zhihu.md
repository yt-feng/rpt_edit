...
# Key Takeaways from China ESS and Battery Chain Tour

## CITI'S TAKE

We hosted the 2026 China ESS and Battery Chain Tour and met with Mr. Liu Shenghua, IR Director, and Mr. Liu Qinfeng, Vice President of the IR department, Gotion High Tech on 15th Jul. The battery shipment is \~65GWh in 1H26, with fully capacity utilization ratio for ESS battery and \~70% utilization ratio for EV battery. The full year battery shipment guidance remains at 150GWh, including \~45GWh ESS battery. Key takeaways are as follows.

Battery shipment – The battery shipment is \~65GWh in 1H26, with fully capacity utilization ratio for ESS battery and \~70% utilization ratio for EV battery. The full year battery shipment guidance remains at 150GWh, including \~45GWh ESS battery. Gotion expects the battery output in 2H26E will be stronger HoH because of export VAT rebate cut off by year end.

Battery capacity – Effective battery capacity was \~150GWh at YE2025, including \~30GWh ESS battery capacity. Gotion has planned 40GWh ESS battery capacity addition, which will be in operation within 2026E and volume contribution mainly in 2027E. Mgmt. expects effective capacity to reach 260GWh in YE2026E, including 40GWh ESS battery capacity addition and 70GWh EV battery capacity addition during the year.

Overseas capacity – The Morocco battery project with 20GWh capacity is expected to be in operation in 2026E. The Slovakia battery project with 20GWh capacity and US battery project with 15GWh capacity will be later than Morocco, depending on demand.

Capex – The unit capex is \~Rmb100mn per GWh for domestic battery capacity and capex in overseas will be higher.

Cost pass-through – 1H26 gross profit margin was under pressure driven by hiking raw materials price. By end 1H26, Gotion has successfully pass through the hiking cost to most clients and mgmt. expects improvement in profit margin in 2H26E.

<table><tr><td>Price (20 Jul 26 15:00)</td><td>Rmb27.000</td></tr><tr><td>Target price</td><td>Rmb42.700</td></tr><tr><td>Expected share price return</td><td>58.1%</td></tr><tr><td>Expected dividend yield</td><td>0.4%</td></tr><tr><td>Expected total return</td><td>58.5%</td></tr><tr><td>Market Cap</td><td>Rmb48,998MUS$7,238M</td></tr></table>
...
We value Gotion Hi-Tech at Rmb42.70/share based on an EV/EBITDA valuation approach as it eliminates uncertainties related to capital structures. Using 15.1x 2026E EV/EBITDA, 0.5SD below the historical average since 2012 due to a slowdown in EBITDA growth relative to very high levels of growth reported historically, we derive a fair value of Rmb42.70. Our TP implies 39.0x 2026E P/E and 23.4x 2027E P/E

## Risks

Downside risks that could cause the Gotion Hi-Tech shares to continue to trade below our target price include: 1) slower-than-expected capacity expansion ramp-up; 2) lower-than-expected product margins; and 3) worse-than-expected NEV demand.
...
Citi Global Markets Inc. or its affiliates received compensation for products and services other than investment banking services from Gotion High Tech in the past 12 months.

Citi Global Markets Inc. or its affiliates currently has, or had within the past 12 months, the following as clients, and the services provided were non-investment-banking, non-securities-related: Gotion High Tech.
...
This communication is directed at persons who are "Eligible Clients" as such term is defined in the Israeli Regulation of Investment Advice, Investment Marketing and Investment Portfolio Management law, 1995 (the "Advisory Law"). Within Israel, this communication is not intended for retail clients and Citi will not make such products or transactions available to retail clients or to non-Eligible Clients. The presenter is not licensed as investment advisor or investment marketer by the Israeli Securities Authority ("ISA") and this communication does not constitute investment or marketing advice. The information contained herein may relate to matters that are not regulated by the ISA. Any securities which are the subject of this communication may not be offered or sold to any Israeli person except pursuant to a security offering exempti
