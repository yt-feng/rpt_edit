...
## U.S. Medtech: Observations after HCA pre-release; perspectives on the sector
...
U.S. Medtech stocks experienced a notable move yesterday, as HCA (covered by Lance Wilkes) pre-released 2Q26 revenue and highlighted a 2.3% decline in same-facility inpatient surgery volumes and a 3.4% decline in same-facility outpatient surgery volumes (see PR and Lance's take). HCA shares finished the day down 7%, and several of our stocks were down almost as much (ISRG/SYK). JNJ reported mixed MedTech results this morning, which may not provide additional context for medtech stocks after yesterday's activity. We spoke to medtech management teams and offer thoughts on sector dynamics below.

Investors are attentive, so the HCA announcement had an impact. U.S. Medtech stock performance has been challenging. Our coverage has underperformed the S&P 500 by 5000bps over the past year (Exhibit 1), and the medtech sector multiple has compressed by over 30% since November (Exhibit 2). Given how medtech performance has been, investors naturally wonder if something is fundamentally different about the sector. Areas of focus include: utilization growth trends, margin dynamics, and (to a lesser extent) GLP-1 considerations.

Hospital commentary has raised questions about whether utilization growth could moderate in 2H26, driven in part by declining enrollment in ACA plans and cuts to Medicaid. Recent alt data trends and survey work have not alleviated investor questions about the health of underlying medtech procedure volumes. With investors attentive, yesterday's announcement from HCA had a notable impact, especially given the nature of the update—a couple of data points in a PR showing declines in inpatient and outpatient procedures with no public commentary from the company to provide additional context.

We have been on the road recently, and we have heard investor questions clearly. We have discussed the group, noting that the recent activity has been more about individual company narratives that have become more nuanced than it is about a changing macro environment (see our recent Deadtech forever? note). In a world where AI-related stories continue to command significant attention, investors have very little patience for complex medtech narratives.

Medtech management teams see healthy end markets. In our discussions with medtech companies, we do not hear concern about underlying market health. In fact, most companies point to continued steady/strong procedure volume growth. We caught up with ZBH yesterday, and they reiterated that (1) ACA is a LSD % of U.S. procedures, (2) Medicaid is LSD % of U.S. procedures, so (3) ACA and Medicaid together account for something at the low end of MSD % of U.S. procedures (say ~4%). Obviously, ACA and Medicaid programs are not going to zero, so ZBH felt the reaction to the HCA pre-release was notable. The company wouldn't comment on Q2 procedures specifically, of course, but they characterized the market as "fine."
...
We also spoke with a private ortho company yesterday who hasn't noticed any change in market volume trends, and we connected with MDT who sees underlying markets as healthy and believes hospitals will push to do more elective procedures as hospital financials come under increased scrutiny.

No additional context from JNJ? This morning, JNJ reported 2Q26 MedTech sales of $4.55bn in the U.S., which missed consensus by ~1.7% (~$80mn) on U.S. organic growth of 4.1%. Most of the U.S. variance came from lower-than-expected Abiomed U.S. sales (~$60mn miss), which may be a JNJ-specific issue. U.S. Knees missed by 3% ($6mn), and U.S. Spine missed by 1% ($3mn), while U.S. Surgery was 1.5% ahead of expectations (+$19mn). Outside the U.S., JNJ MedTech sales grew 3.2% organic to $4.37bn, slightly ahead of consensus.

From the headline numbers and commentary in JNJ's Q2 earnings presentation, we do not see any clear signals of a change in U.S. procedure volumes, but these numbers may not provide additional context for medtech stocks. JNJ's results in cardiovascular may raise some questions, and investors may note JNJ's small misses in U.S. Knees and U.S. Spine. Medtech investors will be listening closely to JNJ's commentary about medtech market health.

What could shift the narrative for medtech? As of this morning, we have a hard time reconciling HCA's declining Q2 procedure trend with the reassuring commentary we hear from medtech management teams regarding the health of underlying markets. At this point, we continue to believe medtech stock activity is more about individual company narratives that have become more nuanced. Let's see what we hear from JNJ and from medtech management teams as they report Q2 results over the coming days and weeks.

Notably, momentum has become an increasingly important factor in medtech valuations. Medtech stocks that were well-regarded in late 2024 at all-time-high valuations are now viewed differently at 10-year-low valuations. We're not yet willing to conclude that market health is changing, but even if that turns out to be the case, there may be opportunities for investors at these valuations (see Exhibit 3). After all, these are quality companies operating in attractive oligopoly markets, medtech innovation continues at a rapid pace, and there are secular tailwinds that will continue to drive growth.

We see potential for gradual improvement for the group as idiosyncratic risks are addressed one by one. It doesn't appear that medtech will get much additional context from JNJ's Q2 results. We don't expect to get much from Abbott, either, but if ABT can show recovery in Nutrition and stabilization in Structural Heart, investors might start to consider broadening access for CGM and the growth opportunity in EP. Perhaps Intuitive Surgical's portfolio of launches (dV5, Ion, SP, XiR, AI) can continue to drive strong quarterly financial performance, and maybe investors will find it harder to overlook ISRG as estimates continue to move higher. Perhaps Stryker can deliver a healthy Q2 result and reinforce confidence that the business will continue its trajectory despite the cyberattack-related hiccup. Progress for Boston Scientific would go a long way in building confidence in the group. Questions continue about decelerating growth for Watchman and EP. As we get clarity on when and where growth rates may stabilize for these key franchises, and as reset LRP expectations begin to come into focus, we see the potential for notable improvement over the next 12-24 months.

Bottom line: For investors who are comfortable with narratives that have some complexity, we see interesting risk/reward for many quality medtech names across our coverage. We believe ISRG represents an interesting opportunity below $400, and we like SYK going into Q2. We believe BSX shares have the potential to see meaningful appreciation over the next couple of years, though we admit it could take several quarters to get better visibility and rebuild investor confidence.
...
EXHIBIT 3: For most of our coverage, multiples have been reduced by 20%-60% over the last 18 months
...
SG and/or its affiliates beneficially own 0.5% or more of [the total issued share capital/any class of common equity securities] with a net [long/short] position of: DexCom Inc and Insulet Corporation.

SG and/or its affiliates beneficially own 1% or more of a class of common equity securities of the following company: Insulet Corporation.
...
Bernstein and/or affiliates have received compensation for non-investment banking securities-related products or services in the previous twelve months from the following clients: Abbott Laboratories, Boston Scientific Corp, Medline Inc. and Stryker Corp.
...
Bernstein and/or affiliates expect to receive or intend to seek compensation for investment banking services in the next three months from Abbott Laboratories and Medline Inc..
...
Certain affiliates of Bernstein act as market maker or liquidity provider in the debt securities of: Abbott Laboratories, Boston Scientific Corp, Johnson & Johnson, Stryker Corp, Zimmer Biomet Holdings Inc and Medtronic PLC.
...
Certain affiliates of Bernstein act as market maker or liquidity provider in the equities securities of: Abbott Laboratories, DexCom Inc, Edwards Lifesciences Corp, Insulet Corporation, Intuitive Surgical Inc, Johnson & Johnson, Stryker Corp, Zimmer Biomet Holdings Inc and Medtronic PLC.
...
Where this report has been prepared by research analyst(s) employed by a non-US affiliate, such analyst(s), is/are (unless otherwise expressly noted below) not registered as associated persons of Bernstein Institutional Services LLC or any other SEC-registered broker-dealer and are not licensed or qualified as research analysts with FINRA. Accordingly, such analyst(s) may not be subject to FINRA's restrictions regarding (among other things) communications by research analysts with a subject company, interactions between research analysts and investment banking personnel, participation by research analysts in solicitation and marketing activities relating to investment banking transactions, public appearances by research analysts, and trading securities
...
This document is for distribution only to persons who (i) have professional experience in matters relating to investments falling within Article 19(5) of
