...
Model projection: 6.7708 versus 6.7948 previous (240 pips lower; 38 pips higher from the previous official spot close).

Model projection with counter-cyclical factor: 6.7808 (140 pips lower from previous fix).
