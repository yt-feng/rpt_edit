...
# Upgrading into uncertainty

Equities remain choppy as peace talks stop and start, and questions linger about AI spend, funding and monetization, higher-for-longer rates, and consumer strength. We focus on the improving earnings outlook, taking our S&P 500 FY26 EPS to \$337 from \$321 and our 2026 PT to 7800 from 7650.

Reprinted from Upgrading Into Uncertainty: Raise S&P 500 PT to 7800, FY26 EPS to \$337, 23 June 2026.

\- The macro regime remains complex, but the balance of risks still leans constructive. Labor data are strong enough to reduce recession risk, but also to push rate cuts further out. Input costs are rising again, though not yet a growth shock large enough to derail the cycle. The equity bull case remains intact, but earnings and AI capex visibility must do more of the work as Fed support fades and positioning is less able to absorb disappointment.
...
\- Our 2026 S&P 500 price target goes to 7800 from 7650. We trim our valuation assumptions modestly from the previous update (23x FY26 EPS, down from \~24x) to account for uncertainties around the scale, funding and monetization timeline of capex, AI-led dispersion, and higher nominal yields and inflation. This leaves earnings to do the work in raising our price target. We also introduce our 2027 price target at 8800.

\- We go to Neutral on Financials and Healthcare. Our bull thesis on the Financials sector has not played out, as banks-driven positive earnings revisions were offset by private credit concerns, regulatory risks within payments, and AI disruption. We believe downward EPS revisions for Healthcare have mostly run their course, leaving risk/reward more balanced. The balance of our sector views remains unchanged: Positive on TMT, Industrials and Utilities, Negative on the Consumer space.

\- Risks we are watching into the back half of the year include signs of stress in the AI investment cycle, including the 'what-ifs' we debated last September: model advancement, availability of power, and funding (especially as the financing mix grows more complex). Rates are re-centering as a key risk factor with a new Fed chair taking the reins amid
...
resurgent inflation. Finally, we are keeping a close eye on the US consumer, as higher inflation and lower purchasing power have the potential to generate lagged pressures in 2H26.

FIGURE 1. BARC FY26 and FY27 estimates for the S&P 500

<table><tr><td></td><td colspan="5">BARC S&amp;P 500 FY 2026 Estimates</td><td colspan="4">BARC S&amp;P 500 FY 2027 Estimates</td></tr><tr><td>Scenario</td><td>EPS</td><td>Growth (yoy)</td><td>PE Multiple</td><td>YE Value</td><td>Upside / Downside</td><td>EPS</td><td>Growth (yoy)</td><td>PE Multiple</td><td>YE Value</td></tr><tr><td>Bull Case</td><td>$343</td><td>22.9%</td><td>24.8x</td><td>8500</td><td>13.7%</td><td>$397</td><td>17.8%</td><td>24.2x</td><td>9600</td></tr><tr><td>Base Case</td><td>$337</td><td>20.8%</td><td>23.1x</td><td>7800</td><td>4.4%</td><td>$389</td><td>15.4%</td><td>22.6x</td><td>8800</td></tr><tr><td>Bear Case</td><td>$329</td><td>17.9%</td><td>19.1x</td><td>6300</td><td>-15.7%</td><td>$380</td><td>12.8%</td><td>18.7x</td><td>7100</td></tr><tr><td>Current S&amp;P 500 Price</td><td></td><td></td><td></td><td></td><td>7,473</td><td></td><td></td><td></td><td></td></tr></table>
...
We believed there was value in looking through the noise and focusing on both the underlying strength of the US economy and the improving fundamentals within US equities. Indeed, once ceasefire headlines shrank both the left tail and the immediate geopolitical risk premium, investors quickly returned to the parts of the market where earnings visibility looked strongest. Big Tech, Growth and Momentum surged as investors re-engaged with AI- and Tech-exposed names. A strong 1Q26 earnings season, with Tech EPS growth sitting at the best levels since 2010 and revisions to full-year EPS hitting record pace, pointed to more fundamental headroom.
...
The rebound in equities following the US-Iran détente reinforces the market's resilience, but we believe yields are re-centering as a key risk factor for equities. The relationship between yields and equities has turned notably negative, suggesting that higher yields are now being read less as a growth signal and more as a constraint on valuations and liquidity. In this regime, incremental increases in either inflation or term premia carry asymmetric downside risk for equities, particularly given the market's dependence on longer-duration growth assets.

FIGURE 2. The yield-equity correlation is testing the lower bound of its historical range at current levels of the nominal 10y  
![](images/bffc72f86c589261561eb258fb760519e576a0e80344803f294816bb4444fc7a.jpg)  
Data as of 22 June 2026. 6m rolling correlations observed at monthly average 10y yields. Source: Bloomberg, BARC

This makes the path of rates especially consequential. Even in an environment of broadly stable growth, upside surprises in inflation could challenge the durability of the recent rally if it leads to a durable repricing of the policy path. Markets are already assigning some probability to additional Fed tightening by year-end, at odds with our more benign baseline expectations for policy. While the historical record surrounding Fed "reversal of easing" suggests that the mere prospect of the Fed's resuming hikes has not typically derailed equities ahead of the event, the weeks and months following the event could be a different story.
...
![](images/85dbd9fb044642266fca02d396dd7b73c7ebf3283bc4be2be034f02e93752c2c.jpg)  
...
![](images/ebe45f78c17567e26d6da17eb3bbb5ed81820c109afe28ea7a3d4348d05cf688.jpg)  
...
![](images/ca764108625356fdbff3c81f74117aad9d6f47e5d14261a676b318908823baf6.jpg)

Source: Bloomberg, BARC

Overall, while it is clear that the macro regime remains complex, we believe the balance of risks still leans constructive. Labor data are strong enough to reduce recession risk, but also to push rate cuts further out. Input costs are rising again, though not yet a growth shock large enough to derail the cycle. The equity bull case remains intact, but earnings and AI capex visibility must do more of the work as Fed support fades and positioning is less able to absorb disappointment.

## Raise FY26 EPS estimate to \$337 from \$321

We raise our FY26 S&P 500 EPS estimate to \$337 from \$321, modestly below the Street's \$341 and implying 20.8% y/y growth from \$279 in FY25. Since our previous update, three developments argue for a higher EPS estimate: 1) 1Q26 earnings season was materially stronger than expected, confirming that Big Tech and the rest of TMT continue to convert AI-related demand into earnings upside, and upward revisions to the full-year consensus are running well ahead of average; 2) reflationary pressure through 2026 should support nominal revenue growth, particularly in sectors with operating leverage or commodity exposure; and 3) the industrial side of the economy looks relatively supportive into 2027, with our economists' forecasts pointing to a better industrial production backdrop next year. We expect these upside drivers to be modestly offset by weaker consumption: spending data have cooled and real purchasing power gains look more modest at current inflation.

Around our base case of \$337, we estimate a relatively tight bull/bear range of \$343/\$329, underscoring that the core debate is less about directional earnings risk and more about the magnitude and persistence of key cyclical drivers. The dispersion is primarily a function of uncertainty about the durability of the Tech beat-and-raise, alongside the trajectory of goods consumption and whether recent resilience can be sustained into a softer macro backdrop. Industrial activity represents a second-order swing factor, particularly given its sensitivity to both global demand and inventory dynamics, while the path of inflation also remains critical.
...
![](images/7d5bd96293ed27267c3eb5280e5d04b1351cdd6e3dabf8fcaf7833d7dfddb15e.jpg)

FIGURE 9. We estimate \$337 in FY26 EPS (+21% y/y) vs. the Street at \$341  
![](images/5573bc6fb400f9355694b0d87cb53a22ac160c32ffc15c9fa3a5c5bf6a475297.jpg)

FIGURE 10. FY26 Base, Bull and Bear case EPS scenarios  
![](images/452bc98f05e99d08a74bb525a59dbd2a60a1ac0e5033f5403a35ff08a26ae7ca.jpg)  
Data as of 16 Jun 2026
Source: LSEG Data & Analytics, Bloomberg, BARC  
Data as of 10 Jun 2026
Source: LSEG Data & Analytics, Bloomberg, BARC

We introduce a preliminary FY27 EPS estimate of \$389, reflecting a modest deceleration in growth. Our framework assumes a partial recovery in consumption on y/y basis, coupled with continued strength in industrial production as the lagged effects of prior tightening fade. This is partially offset by a normalization in nominal pricing power, particularly as disinflationary forces broaden. The resulting bull and bear cases of \$397/\$380 capture a similar set of crosscurrents, with upside tied to a more durable demand recovery and sustained Tech momentum, while downside reflects the risk of a more protracted normalization in margins and growth.

Source: LSEG Data & Analytics, Bloomberg, BARC

FIGURE 11. We estimate \$389 in FY27 EPS (+15% y/y) vs. Street at \$398  
![](images/d6600b707dcd180dc1a3a905a7487dbae68dd9d89d7c89809e001a6da55798fa.jpg)  
Data as of 10 Jun 2026.  
Source: LSEG Data & Analytics, Bloomberg, BARC

FIGURE 12. FY27 Base, Bull and Bear case EPS scenarios  
![](images/94d1fb5327ebded97c884b0e23d6ddba7bbe9c79885d833f0830609971a20be8.jpg)  
Data as of 10 Jun 2026.

We recognize that a central pillar of our EPS framework rests on the view that Tech can continue to deliver positive earnings upside even as consensus estimates and revisions already sit at elevated levels vs. history. Skepticism about the magnitude and durability of this outperformance is understandable, particularly given concerns about where we are in the AI investment cycle and whether current growth assumptions embed an implicit peak. Still, our industry analyst colleagues see good reason to believe that much of the supply-demand imbalance in AI compute will persist well into CY27 (Making the Case for Another Leg Higher in the Memory Trade, 26 May 2026), and we think this visibility provides a degree of near-term de-risking to NTM estimates. While we do not dismiss the possibility of normalization further out, current conditions argue that earnings estimates for Tech over the near term are not overly heroic.

FIGURE 13. YTD revisions to full-year EPS are running well ahead of 10-year norms...  
![](images/5ce5421acacc0f349a4a945df40bd9ebb15c6dccc62c0f73485523e09cb643bc.jpg)  
Data as of 16 June 2026. 10y average from 2014-2025, excluding 2020 and 2021. Source: Bloomberg, BARC

FIGURE 14. ...with all quarters seeing a pickup in EPS estimates since the end of calendar 1Q26  
![](images/5309b7e006c34dd34e28e8a5c7773a487142ec5b4143f0ab500f78fe0c8e9485.jpg)  
Data as of 16 Jun 2026.  
...
FIGURE 16. Semis and IT Hardware account for more than half of the + \$31 added to FY26 Street estimates YTD  
![](images/73f5f9abd8ccbce0f6e4e10cef63b251bd00072123348ba60e9058688e494a79.jpg)

Data as of 16 Jun 2026
Source: Bloomberg, BARC

## Raise 2026 price target to 7800 from 7650

Our SOTP valuation framework assigns Big Tech a lower baseline multiple than in March (26x vs. 27.5x). We continue to believe the group offers durable earnings growth, but we trim our valuation assumptions to account for uncertainties about the scale, funding and monetization timeline of the AI infrastructure buildout. We also trim our baseline multiple assumption for the rest of the Tech sector to 23.5x from 25.0x. While data center capex and AI adoption are broadening, valuation dispersion is increasing as investors look to separate AI winners from losers within the broader Tech space.

For the rest of the S&P 500, we derive a fair value P/E of 21.5x based on 10, Treasury yields, trimmed PCE inflation, and manufacturing PMI. These macro inputs are less supportive than at the start of the year, but not weak enough to warrant a material de-rating. Nominal yields have remained relatively contained since March, and our rates colleagues continue to frame the Fed's reaction function as patient, rather than signaling a return to aggressive tightening. At the same time, manufacturing activity and nominal growth indicators remain firm enough to support earnings, while still-elevated inflation underpins nominal revenue growth.

Applying the blended multiple takes our YE26 S&P 500 target up to 7800 from 7650, 23x our \$337 FY26 EPS estimate. Our upwardly revised EPS estimate does the heavy lifting, as our valuation assumptions are reduced modestly from our previous update. Our base case reflects a still-constructive backdrop where AI-driven capex supports earnings resilience, while the broader macro backdrop stays durable in the face of higher-for-longer inflation and rates. Upside to 8500 in our bull case would require a stronger translation of AI investment into productivity and margins, alongside a more benign macro path. Conversely, our 6300 bear case embeds a slowdown in AI capex and tighter financial conditions, driving both EPS and multiple compression risks highlighted in prior work.

FIGURE 17. 2026 S&P 500 price target goes to 7800 from 7650  
![](images/b38ae1a7829cd40fe22d23b328c6b2426760657110f940cbe7b9a5ed4b2f079c.jpg)  
Data as of 11 Jun 2026.  
Source: LSEG Data & Analytics, Bloomberg, BARC

FIGURE 18. 2026 Base, Bull and Bear case PT scenarios  
![](images/6fcc9453f0e134e2009efd8148cf5f80c06c1fe0fda2a654cf760d9b41300244.jpg)  
Data as of 16 Jun 2026.  
Source: LSEG Data & Analytics, Bloomberg, BARC

Extending the horizon into 2027, we introduce targets of 8800 in our base case, 9600 in the bull case and 7100 in the bear case, reflecting a more tempered but still constructive long-duration pathway for equities. These estimates are derived by modestly trimming our 2026 multiple assumptions by roughly a half turn across scenarios, acknowledging the effect of a longer discounting period, as well as greater uncertainty about the durability of AI-led earnings expansion, the terminal level of Fed policy rates, and the broader macro equilibrium.

FIGURE 19. We introduce our 2027 preliminary PT at 8800  
![](images/547023c0392246afd4278926a760bde9f9e67ee25d954eca5955926a8e43c727.jpg)  
Data as of 11 Jun 2026

FIGURE 20. 2027 Base, Bull and Bear case PT scenarios  
![](images/c9e41098508eb891e68333039c08f7ab92d84d5f8b521c718c248161037e4058.jpg)  
Source: LSEG Data & Analytics, Bloomberg, BARC  
Data as of 11 Jun 2026  
Source: LSEG Data & Analytics, Bloomberg, BARC

## Sector and factor recommendations

As a preamble to our sector views, we'd point out that the evolution of the AI narrative continues to reshape the market structure. Correlations within sectors have collapsed to historically low levels, reflecting a market increasingly dominated by idiosyncratic earnings outcomes and positioning, as well as AI disruption narratives. At the same time, concentration in a narrow group of leaders has widened the gap between single-stock and index behavior, with single-stock volatility rising alongside heightened event risk. Together, these dynamics have, we believe, reduced the effectiveness of sectors as an expression of views, reinforcing the shift toward stock selection and narrow thematic exposure (sub-industries, AI winners & losers, select factors) in a dispersion-rich environment.

FIGURE 21. Correlations collapsing between AI winners/losers  
![](images/bac498cef7e6306db0c9fc367d5b78de39642fa4c62be570ba2e4ac7b2d114f2.jpg)  
Data as of 18 June 2026.
Source: Bloomberg, BARC

FIGURE 22. The single stock vs. index vol spread is elevated compared with history  
![](images/64f0c8454f8dd60dd95fb481b3ca97a95c3c65a0820b3b1cd09d3701f202edfd.jpg)  
Data as of 17 June 2026.
Source: Bloomberg, BARC Derivatives Research

Against this backdrop, we implement two changes to our sector positioning. First, we downgrade Financials to Neutral. While earnings estimate revisions for banks remain constructive (supported by stronger net interest income, resilient loan growth, and improved trading and capital markets activity), the broader sector faces more mixed fundamentals. Regulatory risks from credit card fees and lingering concerns over private credit exposure and AI disruption continue to weigh on non-bank components. As a result, we see modest downside risk to consensus EPS growth expectations at the sector level. Valuations are undemanding, but largely reflect these risks, leaving the overall risk/reward more balanced. Within Financials, we continue to prefer banks, where earnings visibility remains stronger.

Second, we upgrade Healthcare to Neutral. Earlier concerns about downside risk to FY26 EPS, driven by difficult comparisons, have partially played out; consensus estimates have been revised materially lower. With expectations now reset, we see only modest additional downside risk. At the same time, the sector trades modestly above its 5y median forward P/E, despite meaningful underperformance YTD. This combination suggests a more balanced setup, where neither valuation nor earnings present a strong directional signal.

The balance of our sector views remain unchanged: Positive on TMT, Industrials and Utilities, Negative on the Consumer space. We provide rationale in the table below.

FIGURE 23. sector views

<table><tr><td>Sector</td><td>View</td><td>&#x27;26 EPS Δ% (BARC)</td><td>&#x27;26 EPS Δ% (Street)</td><td>vs. Street</td><td>Current Valuation</td><td>Rationale</td></tr><tr><td>Big Tech</td><td>POS</td><td>36.10</td><td>23.19</td><td>12.91</td><td>23.9x</td><td></td></tr><tr><td>Rest of Tech</td><td>POS</td><td>81.28</td><td>69.44</td><td>11.84</td><td>23.6x</td><td>We remain Positive on the TMT complex. Big Tech core verticals (digital ads, public cloud) are performing well as the group positions for further AI monetization. Expanding capex boosts EPS for component names across chips, memory &amp; equipment. Overall Tech P/Es remain below 2Y/3Y medians.</td></tr><tr><td>Communication Services</td><td>POS</td><td>8.82</td><td>12.09</td><td>(3.26)</td><td>35.6x</td><td></td></tr><tr><td>Industrials</td><td>POS</td><td>12.96</td><td>7.30</td><td>5.66</td><td>25.7x</td><td>We see upside to FY26 EPS as PMIs/IP improve. Positioned to benefit from both fiscal spending and AI capex, while relatively insulated from reflation. Valuations elevated but remain off YTD highs.</td></tr><tr><td>Utilities</td><td>POS</td><td>8.81</td><td>12.18</td><td>(3.37)</td><td>17.5x</td><td>We see modest downside to Street FY26 EPS but still expect Utilities to be one of the better AI-adjacent earnings growth stories at a reasonable valuation.</td></tr><tr><td>Financials</td><td>NEU ↓</td><td>4.44</td><td>7.65</td><td>(3.21)</td><td>15.5x</td><td>Downgrade to Neutral; setup for banks remains favorable but rest of the sector challenged by regulatory risks, private credit and AI disruption.</td></tr><tr><td>Real Estate</td><td>NEU</td><td>3.36</td><td>2.79</td><td>0.57</td><td>28.5x</td><td>We see little risk to consensus FY26 earnings growth, but P/FFO multiples look elevated with respect to current nominal Treasury yields.</td></tr><tr><td>Energy</td><td>NEU</td><td>29.19</td><td>48.69</td><td>(19.50)</td><td>6.3x</td><td>We believe revisions to FY26 earnings estimates have run too far, too fast even with respect to higher oil prices. But valuations have come in from March peaks and BARC sees upside to consensus crude forecasts.</td></tr><tr><td>Materials</td><td>NEU</td><td>28.85</td><td>39.84</td><td>(10.99)</td><td>18.0x</td><td>Supply-demand imbalance and resource nationalism leave industrial metals looking better positioned than commodity chemicals.</td></tr><tr><td>Health Care</td><td>NEU ↑</td><td>(0.70)</td><td>1.13</td><td>(1.83)</td><td>17.8x</td><td>Upgrade to Neutral; downward revisions to FY26 EPS are likely to have mostly run their course, but we expect earnings growth to remain weak vs. tough 2025 comps.</td></tr><tr><td>Consumer Staples</td><td>NEG</td><td>5.58</td><td>4.63</td><td>0.94</td><td>22.1x</td><td rowspan="2">We remain Negative on the Consumer complex. While spending data remains resilient, moderating income gains and higher inflation (including gas prices) are likely to create lagged pressure in 2H, leading to a modest consumption slowdown.</td></tr><tr><td>Consumer Discretionary</td><td>NEG</td><td>3.95</td><td>4.76</td><td>(0.81)</td><td>23.0x</td></tr></table>

Data as of 16 June 2026. Our sector earnings framework combines bottom-up and top-down approaches, adjusting consensus estimates based on historical bias and macro variables relevant to each sector. EBITDA and EV/EBITDA applied instead of EPS and P/E for Energy; FFO and P/FFO applied for Real Estate. Consumer Discretionary valuation is a simple average of constituent P/E, to adjust for the influence of TSLA. Arrows next to sector views denote changes.
Source: Bloomberg, BARC

On factors, we recently downgraded Momentum to Neutral, reflecting historically crowded positioning that creates downside asymmetry despite Momentum's strong NTM earnings growth and reasonable valuations. We remain Positive on Growth and Neutral on Value, underpinned by powerful Tech-led 1Q26 earnings momentum, supportive valuations and AI capex tailwinds within Growth. Our Positive Large-over-Small view is maintained, as small caps remain vulnerable due to weak earnings revisions, near-record negative beta to the 10-year yield, and valuation excesses in segments such as small-cap software, in contrast to mega-cap hyperscalers. We remain Negative on Quality as markets look through geopolitical risks in a risk-on regime, Neutral on High-over-Low Volatility given stretched valuations and AI-linked exposure offset by committed capex and favorable June-July seasonality, and Neutral on Yield as the long/short Yield basket is pressured by AI-driven inflation impulses and flow diversion, though cheap valuations and light positioning limit further downside.
