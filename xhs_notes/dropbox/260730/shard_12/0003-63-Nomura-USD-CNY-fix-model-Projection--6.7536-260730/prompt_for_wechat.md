...
Model projection: 6.7536 versus 6.7899 previous (363 pips lower; 119 pips lower from the previous official spot close).

Model projection with counter-cyclical factor: 6.7727 (172 pips lower from previous fix).
