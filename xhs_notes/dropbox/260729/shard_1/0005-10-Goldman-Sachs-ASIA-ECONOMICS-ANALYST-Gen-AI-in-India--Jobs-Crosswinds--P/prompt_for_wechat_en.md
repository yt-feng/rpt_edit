...
A classification issue is worth noting. Under the ILO employment data, parts of India's IT and IT-enabled services workforce sit within media and entertainment (high complementarity sector), while others are grouped within financial services (high substitution risk). India's IT and IT-enabled services sector employs 4.0 – 6.0mn $^{6}$ people, while the sector-level split ba
