...
# Time billionaires want more risk. Is AI to blame?

Read the full paper on the DB Institute (DBRI) website HERE

Are you a time billionaire? Some say "yes" if they expect to have more than 1bn seconds (or about 31.5 years) ahead of them. And as the number of younger investors increases, and their time horizons span 30, 40, or 50 years, they want two things: 1) More risk than they have today, 2) AI to manage their money and trade for them.
...
The views expressed in this report accurately reflect the personal views of the undersigned lead analyst(s). In addition, the undersigned lead analyst(s) has not and will not receive any compensation for providing a specific recommendation or view in this report. Galina Pozdnyakova, Luke Templeman, CPA.
...
Japan: Approved and/or distributed by Deutsche Securities Inc.(DSI). Registration number - Registered as a financial instruments dealer by the Head of the Kanto Local Finance Bureau (Kins
