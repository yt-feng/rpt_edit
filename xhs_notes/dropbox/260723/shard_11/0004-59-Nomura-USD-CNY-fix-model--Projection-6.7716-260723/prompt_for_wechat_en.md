...
Model projection: 6.7716 versus 6.7933 previous (217 pips lower; 24 pips lower from the previous official spot close).

Model projection with counter-cyclical factor: 6.7770 (163 pips lower from previous fix).
