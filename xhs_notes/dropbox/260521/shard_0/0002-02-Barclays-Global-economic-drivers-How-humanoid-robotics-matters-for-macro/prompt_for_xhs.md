...
1) they would expose more tasks and possibly also speed up adoption, thus leading to higher productivity gains for the economy in the Hulten's theorem first approximation approach; as Figure 5, Figure 6 and Figure 7 show, the sectoral exposure to Gen AI and humanoid robotics is quite complementary: it is exactly in the sectors relatively untouched by Gen AI, where the exposure to robotics i
