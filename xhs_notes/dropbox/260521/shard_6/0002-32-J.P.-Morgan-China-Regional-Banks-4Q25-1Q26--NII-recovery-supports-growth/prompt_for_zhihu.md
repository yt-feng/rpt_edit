...
\- Capital constraint may limit loan expansion and weaken leverage to a macro recovery. BoBJ's CET1 ratio was only 8.59% in 1Q26, with only an 84bps buffer above the regulatory minimum requirement, the lowest among peers (Figure 2). Per the company, the bank plans to follow a “capital-constrained asset growth” approach (“以资本定资产”), suggesting loan growth is likely to remain subdued at low single di
