...
【研报解析内容】
"""
# Japan semiconductor packaging industry update
...
# Record-high shipments of package substrates in March

We infer that shipments from Ibiden's Ono plant got into full swing in March

# Packaging-related monthly statistics: Record-high shipments and price per $m^2$ in March

According to the Current Survey of Production for March, released on 19 May, shipments of package substrates (rigid module PCBs) rose 63% y-y to a record high of ¥27.3bn. The price per m² was ¥1.216mn, also an all-time high. Jan–Mar package substrate shipments were up 46.6% y-y at ¥73.6bn. While it is important to bear in mind that sales at package substrate manufacturers do not necessarily match the data in the Current Survey of Production due to differences in the nature of the data (production and sales) and the fact that package substrate manufacturers also produce their products overseas, they show broadly the same trends.

# We infer that Ibiden's Ono plant started contributing in earnest from March

Ibiden's Ono plant in Japan is still in the process of ramping up mass production, and we think that keeping track of monthly statistics should provide some extent of understanding about the contribution to output from the new plant. Given that the Current Survey of Production showed shipments of ¥22.5bn in January and ¥23.8bn in February, we can see that there was a sharp increase in shipments in March. Shipments from the Ono plant look to have started to rise in earnest in March. On a Apr 2025–Mar 2026 basis, shipment value was up 30.7% y-y at ¥245.0bn and the average price per m² was ¥1.050mn. Our 27/3 forecasts for package substrate shipments assume that increased shipments of Rubin, next-generation switches, and high-priced multicore CPU packaging substrates (including EMIB) will result in: (1) a 30% rise in the price per m² to around ¥1.36mn; and (2) a 20% rise in m² shipped.

# AI industry: Andrej Karpathy joins Anthropic

In the AI industry, which is supporting demand for semiconductor package substrates, our focus is on the pace of evolution and uptake of agent models and whether AI Labo and cloud data centers can generate returns commensurate with investment by setting appropriate prices. On 20 May, there was a new development related to advances in agent models. One of the founding members of OpenAI, Andrej Karpathy, who led E2E autonomous driving model development at Tesla, joined Anthropic's pre-training team.

After leading the development of many cutting-edge AI models, Mr Karpathy shifted to a role in education. Now that he has returned to the cutting edge of LLM development, our expectations for the evolution of agent models have risen sharply. In his comments announcing his new position, Mr Karpathy said that the next two to three years will be a period of special development for cutting-edge LLMs.

We think the themes that Mr Karpathy will be in charge of include: (1) pre-training models specialized for agent models, including models with reasoning paths that can be verified from the outside and models capable of sustained learning; and (2) large language model operating system (LLM OS): long-term task execution, self-correcting loops, and pre-trained models that are suitable for tiered agents and constitutional-based multi-agent systems. We will be keeping a close eye on future comments by Mr Karpathy.
...
![](images/c29164904f812e92c0b3138f839fd783c8b2c575a85612f7151e4736d64e5209.jpg)
...
Fig. 2: Price per $m^2$ for rigid module boards   
![](images/3abfae0aac6c7ffc019435314a444f93f80f629f8abedb42918e91dee93f7aa3.jpg)
...
Note: Module boards have components mounted on the board surface. Source: NOM, based on Ministry of Economy, Trade & Industry's Current Survey of Production
