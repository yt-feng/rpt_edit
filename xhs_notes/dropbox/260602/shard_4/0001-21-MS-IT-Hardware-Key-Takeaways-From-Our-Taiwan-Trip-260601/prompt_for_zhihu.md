...
Our \$19 price target is based on a 7x P/E multiple on FY27 EPS of \$2.65. Our 7x P/E multiple implies that HP trades at a 1x turn discount to its trailing 5-year average, which we believe takes into account PC market refresh, offset by secular declines in 

[中间内容因长度限制已省略]

 wholly owned by FirstRand Limited. The information in MS is being disseminated by MS Saudi Arabia, regulated by the Capital Market Authority in the Kingdom of Saudi Arabia, and is directed at Sophisticated investors only.
