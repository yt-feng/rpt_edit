...
Our broader take, however, is that the direction of travel is likely to be shaped by the following factors. First, as mentioned, the nature of war has changed and communication and control capabilities will be fundamental in the digital age. Second, that successful defense industrial bases elsewhere, each in their own way, have largely based their success on the integration of their defense and commercial industrial bases. Thi
