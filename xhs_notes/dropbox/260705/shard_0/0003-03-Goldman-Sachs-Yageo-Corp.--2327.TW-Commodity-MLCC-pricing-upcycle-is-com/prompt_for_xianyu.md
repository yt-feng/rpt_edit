...
We expect non-AI MLCC volume to see a stable CAGR of 9% in 2025-28E, continuing to be supported by both automotive and smartphone, with CAGR of 8%/7% in 2025-28E, respectively. We view the automotive MLCC segment as a key sector as it accounts for 20%+ of total non-AI MLCC through 2025-28E, with the level of MLCC consumption to be notably higher than other non-AI segments (e.g. 20k+ on average vs. \~2K for smartphones and \~2.5K on average for desktop PCs). Smartphone
