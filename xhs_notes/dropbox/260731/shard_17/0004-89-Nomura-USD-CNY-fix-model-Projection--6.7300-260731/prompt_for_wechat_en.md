...
Model projection: 6.7300 versus 6.7892 previous (592 pips lower; 264 pips lower from the previous official spot close).

Model projection with counter-cyclical factor: 6.7426 (466 pips lower from previous fix).
