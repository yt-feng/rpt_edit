...
Short-term liquidity conditions eased marginally in July. The average DR007 edged down to 1.415% on a month-to-date basis from 1.438% in June but remain above the PBoC's 7-day OMO reverse repo rate of 1.40%, while the monthly average of 10-year CGB yields edged up t
