...
# Commanding the scene with disruptive SkyNomad pricing and differentiated Kunlun architecture; Buy

1810.HK

12m Price Target: HK\$40.00

Price: HK\$31.04

Upside: 28.9%

Xiaomi held its second EV Technology Conference on Jul 30 and introduced the Kunlun technology architecture including its manufacturing platform, range extender system and omni-domain safety system, which are key technology infrastructure for the upcoming SkyNomad EREV SUV models. Meanwhile, Xiaomi revealed the pre-sale prices for SkyNomad N70 Max (standard wheelbase 5-seater)/N90 Max (long wheelbase 7-seater) models at Rmb259.9k/Rmb299.9k, respectively (equivalent to US\$38k/44k).

## GS takes

\- Technology: The Kunlun Manufacturing Platform enables a large, intelligent and fully configurable interior featured by a flat floor and a long-track system, a refreshing feature in the auto sector; we see this native platform as a key technology differentiator for SkyNomad vs. competitors that may need time to replicate it and have to commercially balance a new platform against their existing ones. On the other hand, the long range support (e.g., 1705km CLTC range for N90 Max, or up to 505km pure electric CLTC range) enabled by the Kunlun Range Extender System is key value proposition to attract ICE consumers, in our view. Lastly, while SkyNomad adheres to Xiaomi's highest safety standards (e.g., an embedded roll cage constructed from as high as 2,200 MPa ultra-high-strength steel), Xiaomi has also achieved deep end-to-end involvement in battery manufacturing (i.e., leading product definition as well as battery pack design and development, participating in cell design and development, and governing full-process quality control) which we believe implies its control of core technologies instead of being a mere battery purchaser.

\- Pricing: While we expect more comprehensive model metrics to be unveiled over the next month before official launch in Sep
...
Market cap: HK\$800.0bn / \$102.0bn
Enterprise value: HK\$601.3bn / \$76.7bn
3m ADTV: HK\$5.0bn / \$640.7mn
China
...
Price Performance  
![](images/d8a3ad83072cb9b62a82eed24392c4dfa8ec4123512bbdf4d2b3190b8d318705.jpg)  
...
(e.g., standard and Pro versions), we see potential that the pre-sale prices could be disruptive to the China auto market considering SkyNomad's industry-leading interior space (i.e., intelligent, configurable and large), range support and unique ecosystem integration. More importantly, similar to our commentary on SU7 2 years ago, we believe the pre-sale prices demonstrates Xiaomi's potential of becoming a price leader in China's EREV SUV market despite a relatively late comer, and could enhance Xiaomi EV shipment visibility in 2026E/27E.

GSe 240k volume in 2027E or 500k in the bull-case: As detailed in our prior notes Setting the Scene and Sharpening the Scene, we expect Xiaomi will likely price SkyNomad N70 at a competitive level as the volume anchor, to capture the entry-level premium space (e.g. starting from Rmb200k) enabled by supply chain capabilities and more favorable battery costs, yet offer a wide pricing spectrum for higher-end complementary variants and features (i.e., higher CarloT revenue per model than SU7/YU7). We continue to model 110k/240k delivery volume in 2026E/27E for SkyNomad, with 2027E volume equivalent to 15% of the 1.6mn+ SUV units (ex. BEVs) with starting prices at Rmb200-400k sold in 2025 (Exhibit 5). In our bull case, if Xiaomi is able to capture part of the trade-up/ICE demand from the mass market, we could see potential for c.500k volume in 2027 based on 10% of the 5mn SUV units (ex. BEVs) with starting price from Rmb100-400k.

## What's next?

1) Xiaomi is scheduled to report 2Q26 results on Aug 18; as discussed in our prior note Setting the Scene, 2Q26 results may be the weakest of the year and we expect Xiaomi's revenue growth ex. EV, AI and other new initiatives to resume positive yoy growth from 3Q26E and net profit to improve qoq in 3Q/4Q26E.

2) Regarding SkyNomad, while Xiaomi has started receiving intentional orders, we see low likelihood that the number of intentional orders will be disclosed; instead, we believe investors should focus on confirmed order volume upon official release (i.e., we expect the initial batch of sales will likely extend till Oct 7, end of the National Day Golden Week). By comparison, the SU7 new facelift released in Mar 2026 received 15k+ confirmed orders within the first 34min or 80k+ confirmed orders during the initial batch of sales (48 days till the Labor Day Golden Week). That said, we do not see YU7 from last year (i.e., 240k+ confirmed orders within 18 hours) as a good comp for SkyNomad, as Xiaomi's execution in the SU7 new facelift demonstrates its enhanced abilities to smooth peak orders at initial launch and sustain healthy order volume post initial launch.

3) On AI, we see more cost-efficient MiMo-V3 series under way. As per company at the International Conference on Machine Learning (ICML) 2026, the upcoming V3 model will feature HySparse (Hybrid Sparse Attention), a new architecture that was introduced by Xiaomi LLM-Core team in Feb 2026 and enables sparse attention layers to reuse the full attention KV cache, thereby reducing both computation and memory. Compared to the 7:1 sparsity ratio for V2/V2.5, MiMo-V.3 may adopt a more aggressive 11:1 sparsity ratio, implying potential to further push efficiency frontier and reduce inference costs. Also see our prior note on Xiaomi Robotics.

Across trims: N70 5.7–5.8 | N90 6.1–6.28 L/100 km
Regular 92-octane gasoline supported across the lineup

Exhibit 1: Kunlun Range Extender System enables industry-leading range support

## Kunlun Range Extender System enables industry leading range support

Large battery and efficient, purpose-built extender address the core concerns of ICE switchers

RANGE

1705 km CLTC range (N90 Max)

CUSTOM-BUILT RANGE EXTENDER

M15DRE 1.5T·112 kW

505 km CLTC pure-electric range

DEPLETED-BATTERY FUEL USE · LOWER IS BETTER 0.6–1.6 L/100 km lower than rivals

Longest pure-electric range among peer models

57 / 200+ parts optimized

![](images/5e879111fda5135c56a04520dbe33720c3ff788464bf4037b9b379df3805909b.jpg)
...
7 core components redeveloped

LOWER HIDDEN COSTS

3 yrs / 30,000 km

Range-extender service interval after the initial service

92 / 95 / 98 RON

No mandatory premium fuel; better remote-area adaptability

8 yrs / 160,000 km

Ultra-long warranty coverage

Source: Company data

Exhibit 2: Kunlun Manufacturing Platform unlocks a flatter, more flexible cabin

## Kunlun Manufacturing Platform unlocks a flatter, more flexible cabin

A flatter package, regular footprint and six high-strength rails create a highly configurable $2 + 2 + 3$ smart cabin that can be voice controlled

INTEGRATED FLAT CHASSIS

298 mm total chassis package height

4.4 m² REGULAR, RECTANGULAR FOOTPRINT More usable space starts with a cleaner floor plan

SPACE THAT ADAPTS

180 L max storage capacity

≈200 mm less

vertical package intrusion versus same-size SUVs

![](images/7e55a19332862bc13c99b3b8bf9e4d795734407251d1396e908c13bd86fb6fde.jpg)  
2 + 2 + 3 AN UNCOMMON SUV CABIN CONFIGURATION

RE-ENGINEERED AS ONE SYSTEM

1.5 m max second-row legroom

Electric drive · electronic controls  
battery pack · extra-large fuel tank

EXPANSION MODES

TABLE $\leftrightarrow$ DOUBLE BED

Six rails extend the cabin beyond fixed seating a
