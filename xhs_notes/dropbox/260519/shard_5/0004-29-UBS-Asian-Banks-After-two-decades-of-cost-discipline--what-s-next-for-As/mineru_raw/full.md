...
Figure 6: Other opex/ assets ratio declined by 25bps over the past 20y for Asian banks   
![](images/98a04f575232a79c4356aa07d7d6b9a6dc716c64da5bc514044c7a6106a1f813.jpg)
...
# 4. AI adoption: strong momentum, limited near-term P&L impact

AI adoption is accelerating rapidly across Asian banks, but its near-term financial impact remains limited in our view. Banks are increasingly deploying generative and agentic AI across customer engagement, internal productivity and risk management.

However, from a P&L perspective, these initiatives have so far delivered more in the form of capacity release and cost avoidance rather than explicit cost reduction. Productivity gains are often reinvested into further technology modernisation, data infrastructure, cybersecurity and compliance, while improvements in fraud detection and risk analytics primarily enhance earnings resilience rather than driving immediate margin expansion.

Management commentaries across Asian banks consistently highlight operational improvements and strategic importance, but limited short-term impact on reported cost ratios.

# 5. Medium-term: AI is the largest remaining cost lever

Looking ahead, we believe AI nonetheless represents the most meaningful remaining cost lever for Asian banks over the medium term. Banking operations typically account for 60–70% of the overall cost base, making end-to-end operational AI a potentially powerful driver of efficiency once scaled.

As banks move beyond the initial high-capex phase of building data and AI infrastructure, digital labour can scale at very low marginal cost, allowing revenues to grow without a commensurate increase in headcount or physical infrastructure. Early examples demonstrate the scale of potential operational displacement once AI adoption reaches maturity.

Overall, AI is shifting from a narrative enhancer to a delivery obligation for Asian banks. While near-term financial benefits appear limited, we believe the medium-term opportunity to reshape cost structures is substantial. Execution, rather than intent or messaging, will ultimately determine which banks emerge as the beneficiaries of the next phase of efficiency improvement.

# Asian banks are facing structural headwinds on revenue

In our Q-Series published last year (Silver wave: How an ageing population is reshaping Asian finance), we discussed how Asia is undergoing a demographic transformation, with the population anticipated to peak in the next 15 years and by 2050, the population aged 65+ is expected to double. We believe these changes will lead to a rising dependency ratio and have a substantial effect on Asian economies and banking systems.

# Net interest income is on a structural downtrend from an ageing demographic

Our analysis identified three significant megatrends stemming from an ageing population. The first is a reduction in consumer savings, followed by a shift in asset allocation from deposits to investments, and lastly, a deceleration in the growth of consumer loans. We believe these megatrends will have a direct effect on Asian banks' profitability and their strategies.

Firstly, as both deposits and lending activities decelerate, with lending experiencing a more pronounced slowdown, net interest margins (NIM) of these banks are expected to enter a long-term decline, weighing on net interest income (NII).

Figure 7: Net interest income/assets ratio   
![](images/ef1abc73b01947b5c46892cddeb3861686424753f221fdc027ea4f41c68d7007.jpg)
...
As this unfolds, we believe banks will be forced to seek alternative income streams, driving them to shift their focus towards non-interest income (non-Ⅱ); a trend that has been increasingly playing out over the past few years. In addition, we can expect an increase in banking consolidation. With growing challenges, diminishing profitability, escalating regulatory demands, substantial technology investments, and ongoing pressure on profit margins, we believe the trend towards consolidation in the banking sector is likely to intensify.

# The shift towards fee income to drive revenue growth is also far from straightforward

Our follow-up report last year expanded the discussion around non-II, and specifically on fee income (The Pivot to Non-interest Income – how challenging is it?).

However, we concluded the shift towards fee income is far from straightforward. Many Asian banking markets have faced a combination of regulatory, structural and cyclical challenges over the past couple of decades which negatively impacted their ability to grow their fee income. And, more often than not, we find that focusing on non-II alone is not sufficient to offset the headwinds on net interest income (NII) and

Asia banks' net interest income/ assets ratio has declined 45bps on average over the past 20y

DM banks saw a 60bps NII/ assets ratio decline on average over the past 20y, compared to 20bps for the EM banks

Figure 8: Fee income/assets ratio   
![](images/d29bf95ba5b2388e03b77f03b83ae400280e926a2c687322ae271fe00e40f596.jpg)
...
# Can lower operating expenses help to offset the headwinds on revenue?

With the structural challenges on NII and headwinds on non-II, can banks turn to improving operating efficiency through the use of technology and AI to lower operating expenses to mitigate the headwinds on revenue?

This is the question we are attempting to answer in this report, where we are expanding the discussion around operating expenses, identifying which markets are doing better/less well, and discuss the challenges/headwinds.

Looking at this firstly on the Asian banks level and the trends over the past 20y, total operating expenses/ assets ratio was around $1.41\%$ in 2025 on average (0.97% for DM banks and $1.80\%$ for EM banks), declining by 40bps on average over the past 20y for Asian banks.

In comparison, revenue/assets ratio declined by 60bps on average over this period (-45bps NII/ assets ratio and -15bps fee income/ assets ratio). This suggests that lower operating expenses have only helped to offset roughly $\frac{2}{3}$ of the decline in revenues over the past 20y, but have not fully offset the impact flowing through to the bottom line.

With declining net interest income, banks are focusing more on non-interest income/fee income to drive revenue growth. However, that is far from straightforward, as we concluded in our report

Fee income/assets has declined by 15bps on average over the past 20y for Asian banks. DM banks saw a 25bps decline on average over this period, while EM banks declined 5bps

Figure 9: Total operating expenses/assets ratio   
![](images/e164792252dcd5045a16eb3351ba5b271b16191bd63c4de95f39bb3925a4b199.jpg)
...
However, there is an interesting divergence between the DM and EM banks.

Developed market banks' (JP, AU, KR, SG, HK, TW banks) total operating expenses/ assets ratio declined by 40bps on average over the past 20y. In comparison, revenue/ assets ratio declined by 85bps on average over this period (-60bps NII/ assets ratio and -25bps fee income/ assets ratio). This suggests that lower operating expenses have only helped to offset roughly 50% of the decline in revenues for DM banks over the past 20y.

However, emerging market banks' (IN, CN, ID, PH, TH, MY, VN banks) total operating expenses/assets ratio declined by 45bps on average over the past 20y. In comparison, revenue/assets ratio declined by 25bps on average over this period (-20bps NII/assets ratio and -5bps fee income/assets ratio). This suggests that lower operating expenses have more than offset the decline in revenues over the past 20y, leading to stronger bottom lines for the EM banks.

This divergence suggests emerging market banks have had more scope to extract efficiency gains, while developed market banks may be closer to the frontier of cost optimisation.

# What led to the lower opex/assets ratio over the past 20y?

Operating expenses are usually broken down into 2 broad categories for banks – 1) staff costs (e.g. salaries, bonuses, employee benefits) and 2) other operating expenses (e.g. administrative expenses, branch and office rent, IT expenses, marketing costs).

Our analysis of the Asian banks suggests staff costs account for slightly less than 50% of total opex (49% of total opex in 2025), though the contribution to total opex could range between 30-65% among markets which we discuss in greater detail in a later section.

Total opex/assets ratio declined by 40bps on average over the past 20y for Asian banks, helping to offset the majority of the decline in revenue/ assets ratio, but not sufficient to fully offset the impact to bottom line

Lower operating expenses have more than offset the decline in revenues for EM banks, but unfortunately not so for the DM banks.

Figure 10: Staff opex/total opex ratio   
![](images/52e4003f5d4a8e83a21deaebd8367b44e68898f2d4ceef046eb2e0dab14cba6d.jpg)
...
The decline in total opex/assets over the past 20y has been driven by both staff costs and other opex, though we find interesting differences between DM and EM banks.

Firstly on staff costs, staff costs/ assets ratio averaged 0.65% in 2025 for Asian banks, declining by 15bps over the past 20y, likely driven to a larger extent by costs cuts given the revenue headwinds, but also, to a smaller extent, likely better operating efficiencies via ongoing technology investments.

Comparing the DM and EM banks, we find their staff opex/ assets ratios declined by 10bps and 25bps respectively over the past 20y. Putting this in context of the overall decline in total opex/ assets ratio for the 2 categories of banks over the same period (-40bps/-45bps for DM and EM banks respectively), we see the decline in staff costs/ assets ratio contributed to 25%/55% of the overall decline in total opex respectively.

In other words, staff costs contributed to more than half of the decline in total opex for the EM banks over the past 20y, but only about $\frac{1}{4}$ for the DM banks.

Figure 11: Staff opex/ assets ratio   
![](images/f0016ed27bd685e884971f829adb68004148466c850bbdc48ec1321c528fb762.jpg)
...
The other opex/ assets ratio has also gradually declined over the past 20y. For Asian banks, other opex/ assets ratio averaged $0.75\%$ in 2025, declining by 25bps over the past 20y, likely also a reflection of banks trying to offset lower revenues and benefits from technology investments (e.g. branch rationalisation).

Comparing the DM and EM banks, we find their other opex/ assets ratios declined by 30bps and 20bps respectively over the past 20y. Putting this in context of the overall decline in total opex/ assets ratio over the same period (-40bps for both DM and EM

Staff costs accounts for slightly less than 50% of total opex for Asian banks on average

For Asian banks, staff opex/ assets ratio declined by 15bps over the past 20y likely driven to a larger extent by costs cuts given the revenue headwinds, but also, to a smaller extent, likely better operating efficiencies via ongoing technology investments

banks), we see the decline in staff costs/ assets ratio contributed to 75%/45% of the overall decline in total opex respectively. In other words, other opex contributed to 3/4 of the decline in total opex for the DM banks over the past 20y, but slightly less than half for the EM banks.

Overall, the composition of cost reduction differs meaningfully across markets, but in both cases, the scope for further gains from traditional levers appears increasingly constrained.

Figure 12: Other opex/assets ratio   
![](images/b582f58869db73d1625203420d373d8a4c616a348e3b8cf8462ad618f5bed282.jpg)
...
# Are there significant differences on the cost-to-income ratio?

On a cost-to-income (CIR) basis, we find little differences between DM and EM banks, both of which were around the 45-50% range in 2025.

However, EM banks managed to lower their CIR over the past 20y, while CIR increased for the DM banks. On an Asian banks level, CIR was around 46% in 2025, declining 1ppt over the past 20y, driven by a 7ppt decline for the EM banks offsetting a 5ppt increase for the DM banks.

This is interesting, as the common perception has been that EM banks should operate with higher CIR, given their need for extensive branch networks to reach underserved segments, as well as generally lower operating efficiencies due to more limited technological investment. However, our findings challenge this view, with EM banks demonstrating CIRs broadly comparable to those in developed markets.

What explains this apparent divergence from conventional thinking?

For Asian banks, other opex/ assets ratio declined by 25bps over over the past 20y, with DM banks seeing a relatively larger decline (-30bps) than EM banks (-20bps)

Figure 13: Total opex/revenue ratio   
![](images/79a803d74d726a6d051c9de0fb991d92fed72c2ac0c6539d4eba18e210d8d03b.jpg)
...
# Why are China, Vietnam, and Hong Kong (domestic) banks able to run at sub-40% cost-income ratio?

We have been asked by several investors in the past why China, Vietnam, and Hong Kong (domestic) banks are able to run at sub-40% cost-income ratio (CIR) when their EM and DM counterparts are running at 44%/49% respectively.

China banks: Chinese banks reported around 38% CIR in 2025. Average CIR from 2014-24 was around 35%. Higher CIR in 2025 was driven by faster growth in costs relative to revenue growth. Nevertheless, CIR was still comparatively lower compared to the EM banks average (38% in China vs 44% in EM). Looking at costs from an ROA perspective, China banks also performed better (ie. lower ratios) on both staff costs/assets and other opex/assets. This could likely be due to China banks' relatively stronger tech and digital capabilities, driving better operating efficiencies and lower costs (measured on both CIR and ROA basis).

Vietnam banks: Vietnamese banks recorded around 30% CIR in 2025, steadily declined from mid-40% in 2015. We believe this is a reflection of stronger revenue growth (high credit growth and fee growth, offsetting NIM pressure) relative to costs growth. Not only are Vietnamese banks performing better on CIR (compared to EM), they also outperformed (ie. lower ratios) on both staff costs/assets and other opex/assets, albeit less so than Chinese banks. Total opex/assets ratios were 1.3% in Vietnam, compared to 0.7% in China and 1.8% for EM banks. This suggests the Vietnam banks' relatively lower CIR of 30% was attributed more to stronger revenues (compared to EM), but likely relatively less due to tech and digital capabilities as with the Chinese banks.

Hong Kong banks: The key driver of the lower CIR is attributed to BOCHK, which reported a 24% CIR 2025. The other HK (domestic) bank, BEA, reported a CIR of 47% in 2025 which is close to the DM average. BOCHK has also impressively achieved positive JAWS with over the past few years with CIR averaging 29% over 2014-24. We attribute the strong operating efficiency to the bank's scale in Hong Kong (16-17% market share), and costs optimisation efforts by centralizing back-office operations in lower-cost regional hubs such as Nanning and deploying AI and robotic process automation to maximise back-office efficiency.

Diving deeper into the opex breakdown, DM banks' staff costs/revenue ratio was roughly 24% on average in 2025, while this was slightly lower for EM banks at around 19%.

This is an interesting observation as the general view has been that DM banks should have lower staff costs/revenue ratio as they have invested more in technology which should yield better operating efficiencies and lower staff count (through increased automation and lesser need for branches). However, this finding appears to be at odds with the common perception whereby DM banks are actually running at higher staff costs/revenue ratio than the EM banks.

Cost-to-income ratios for the both DM and EM banks have declined over the past 20y, and ranged around 45-46% in 2025

We think this could be due to a few possible reasons: 1) higher wages in DM markets relative to EM markets which offsets the lower staff count in general, 2) costs savings on lower administrative staff count is replaced by higher number of tech employees which generally earn higher wages, and 3) technological investments takes time to yield significant costs savings given the legacy banking systems which have to be replaced.

Figure 14: Staff costs/revenue ratio   
![](images/b50323bb0142606b8860ef2f05061bc12b33f9affa8e98417ab946f3200655e0.jpg)
...
# Banking consolidation has helped in lowering cost pressures

With increasing revenue pressures facing the banking sector, and the need for continued and higher costs investments (higher tech and regulatory costs), we have seen banking consolidation in several markets over the past 20y.

China has the largest number of licensed banking institutions among the Asian banking markets with close to 4,300 banks as of 2024 (-6% since 2018).

Indonesia has the second highest number of banks with close to 1,500 banks as of 2024, despite the total count down around 25% over the past 20y. We also note how the total bank count in the Philippines has halved over the past 25y to slightly more than 450 banks in 2025.

Other markets with a high number of banking institutions are India (208 scheduled banks), Hong Kong (149 banks), Singapore (133 banks), and Japan (107 banks). Note: Definition of banking institutions may vary across markets – definitions can be found in the grey text box below.

Nevertheless, the key insight in this section is that in most markets the number of licensed banking institutions was generally stable to declining over the past 5 years. Markets that saw a relatively larger decline in banks were the Philippines (-13% since 2020), China, Hong Kong, Australia, and Thailand (all -7% over the past 5y).

Staff counts accounted for 22% of revenue for DM banks on average in 2025, slightly higher than 20% for the EM banks

Figure 15: Number of licensed banks – CN   
![](images/b5e022c879858cf445b5aa20aeae71b95322138cdc7afc43438b6c2c56524947.jpg)
...
Figure 16: Number of licensed banks – PH / ID   
![](images/e19b8a11c1b318061e2e8da34d858ac418574c6cbb7b85bd83d219111e812a88.jpg)
...
Source: BSP, Indonesia Financial Services Authority

Figure 17: Number of licensed banks – HK / JP / SG / IN / AU   
![](images/d52a59158ae5af369c5fe935a7dc61ba762e84217d51b0fac175920090a6042a.jpg)
...
| Year | HK   | JP   | SG   | IN   | AU   |
|------|------|------|------|------|------|
| 2000 | 150  | 140  | 140  | 280  | 50   |
| 2001 | 145  | 135  | 135  | 275  | 50   |
| 2002 | 140  | 130  | 130  | 270  | 50   |
| 2003 | 135  | 125  | 125  | 265  | 50   |
| 2004 | 130  | 120  | 120  | 260  | 50   |
| 2005 | 125  | 115  | 115  | 255  | 50   |
| 2006 | 120  | 110  | 110  | 250  | 50   |
| 2007 | 130  | 115  | 115  | 240  | 50   |
| 2008 | 135  | 120  | 120  | 235  | 50   |
| 2009 | 140  | 125  | 125  | 230  | 50   |
| 2010 | 145  | 130  | 130  | 225  | 50   |
| 2011 | 150  | 135  | 135  | 220  | 60   |
| 2012 | 155  | 140  | 140  | 215  | 65   |
| 2013 | 160  | 145  | 145  | 210  | 70   |
| 2014 | 165  | 150  | 150  | 205  | 75   |
| 2015 | 160  | 145  | 145  | 200  | 80   |
| 2016 | 155  | 140  | 140  | 195  | 85   |
| 2017 | 150  | 135  | 135  | 190  | 90   |
| 2018 | 145  | 130  | 130  | 185  | 95   |
| 2019 | 140  | 125  | 125  | 180  | 100   |
| 2020 | 135  | 120  | 120  | 175  | ~95   |
| 2021 | 130  | ~115 | ~115 | ~170 | ~95   |
| 2022 | ~125 | ~110 | ~110 | ~165 | ~95   |
| 2023 | ~120 | ~105 | ~105 | ~160 | ~95   |
| 2024 | ~115 | ~100 | ~100 | ~155 | ~95   |
| 2025 | ~110 | ~95   | ~95   | ~150 | ~90   |
</details>

Source: Central banks, Australian Prudential Regulation Authority

Figure 18: Number of licensed banks – KR / TW / MY / TH / VN   
![](images/dc0a78103566336e1f494a3ccb943951299ab99465a4d194541ed11002dcc146.jpg)
...
- China: Includes City Commercial banks, Privately-owned banks, Rural Commercial banks, Rural Cooperative banks, Rural Credit Cooperatives, Village and Township banks, Direct banks, and Foreign banks.   
- Philippines: Incudes Universal and Commercial banks, Thrift banks, Rural and Cooperative banks, and Digital Banks.   
- Hong Kong: Includes banks incorporated in Hong Kong and outside of Hong Kong. Licensed banks are primarily allowed to 1) Operate current and savings accounts; 2) Accept deposits of any size and maturity from the public.   
- Japan: Includes City banks, Trust banks, and Regional banks.   
- Singapore: Includes both full banks and wholesale banks (restricted from offering retail banking services).   
- Indonesia: Includes both commercial banks and rural banks. Rural banks accounts for slightly more than 90% of total banks.   
- India: Includes scheduled commercial banks and scheduled co-operative banks. Scheduled banks refer to banks that are eligible for RBI facilities such as liquidity support and clearing access.   
- Australia: Includes all authorised deposit-taking institutions (such as banks, building societies and credit unions).   
- Korea: Includes domestic banks and foreign banks.   
• Taiwan: Includes only domestic banks.   
- Malaysia: Only includes commercial banks (both domestic and foreign). Excludes Islamic banks and investment banks.   
- Thailand: Only includes commercial banks (both domestic and foreign).   
- Vietnam: Includes policy banks, State-owned Commercial Banks, Joint-stock Commercial Banks, Joint-Venture Banks, and 100% Foreign-Owned Banks.

# Branch rationalisation initiatives are also underway

Based on data from the World Bank (latest data as of 2023), most markets in Asia have seen a decline in branch penetration (measured by the number of branches per 100k adults) from 2018-23, apart from India (+1%) and Japan (flat), which likely contributed to savings on total opex. Markets that saw the largest decline in branch penetration from 2018-23 were Australia (-39%), Indonesia (-27%), Thailand (-26%), and Singapore (-25%).

On an absolute basis, branch penetration was the highest in Japan (34 branches per 100k adults) in 2023, followed closely by Hong Kong (18 branches) and Australia (17 branches). On the other end, Vietnam has the lowest branch penetration (3 branches per 100k adults), followed by Singapore (6 branches), and Thailand (8 branches).

Figure 19: Number of branches per 100k adults – HK / KR / JP / AU / SG   
![](images/7c4938eb840514b5cd20e39e73998c2896691aeef4cca390928864bbb64ded61.jpg)
...
| Year | HK   | KR   | JP   | AU   | SG   |
|------|------|------|------|------|------|
| 2004 | 23.5 | 17.0 | 34.5 | 31.0 | 11.5 |
| 2006 | 23.5 | 18.5 | 34.5 | 32.0 | 11.0 |
| 2008 | 24.0 | 19.0 | 34.5 | 32.5 | 10.5 |
| 2010 | 24.0 | 18.5 | 34.5 | 32.0 | 10.0 |
| 2012 | 23.5 | 18.5 | 34.5 | 31.5 | 9.5  |
| 2014 | 23.0 | 18.0 | 34.5 | 30.5 | 9.0  |
| 2016 | 22.0 | 17.0 | 34.5 | 28.0 | 8.5  |
| 2018 | 21.5 | 16.0 | 34.5 | 29.0 | 8.0  |
| 2020 | 20.5 | 15.0 | 34.5 | 24.0 | 7.5  |
| 2022 | 19.0 | 13.5 | 34.5 | 17.0 | 6.5  |
|    |      |      |      |      |      |
</details>

Source: World Bank

Figure 20: Number of branches per 100k adults – CN / IN / MY / PH / ID / TH / VN   
![](images/57c3d15792b42e301ad6918b22fa78efce3d61761d041998d3fd1e0362704b4b.jpg)

<details>
<summary>line</summary>

| Year | CN   | IN   | MY   | PH   | ID   | TH   | VN   |
|------|------|------|------|------|------|------|------|
| 2004 | 8.0  | 8.5  | 13.0 | 8.0  | 4.5  | 8.0  | 3.5  |
| 2006 | 8.5  | 9.0  | 12.0 | 7.5  | 6.0  | 8.5  | 3.5  |
| 2008 | 9.0  | 9.5  | 11.5 | 7.5  | 7.5  | 9.0  | 3.5  |
| 2010 | 9.5  | 10.0 | 11.0 | 7.5  | 16.0 | 9.5  | 3.5  |
| 2012 | 10.0 | 11.0 | 10.5 | 8.0  | 17.0 | 10.0 | 3.5  |
| 2014 | 10.5 | 12.0 | 10.0 | 8.5  | 17.5 | 10.5 | 3.5  |
| 2016 | 11.0 | 13.0 | 9.5  | 9.0  | 17.0 | 11.0 | 3.5  |
| 2018 | 11.5 | 13.5 | 9.0  | 9.5  | 16.5 | 11.5 | 3.5  |
| 2020 | 12.0 | 14.0 | 8.5  | 10.0 | 16.0 | 12.0 | 3.5  |
| 2022 | 12.5 | 14.5 | 8.0  | 10.5 | 12.0 | 12.5 | 3.5  |
</details>

Source: World Bank

# In terms of absolute branch count, all Asian markets, apart from the Philippines and Vietnam, saw a decline in the total number of branches over the past 5y.

Markets that saw the largest decline in the absolute number of branches over this period were Australia (-33%), Thailand (-24%) and Korea (-14%). Total number of branches increased 5% over the past 5y in the Philippines, and 7% in Vietnam.

Figure 21: Number of bank branches – IN / CN   
![](images/143d97e723265c57fa12450ee492e0d4197f6805e559efd65461a09d5c751d58.jpg)
...
Source: Central banks, company data. Note: Data for China is based on total branch count for ICBC, CCB, ABC, BOC, and BOCOM.

Figure 22: Number of bank branches – JP / PH / ID   
![](images/58608049cd839ca72cdbc3eae76c99a41d53e26b04b47687ac8e7916089e0243.jpg)
...
Source: Central banks, Japanese Bankers Association, Indonesia Financial Services Authority.

Figure 23: Number of bank branches – KR / AU / TW / TH   
![](images/763fd9133d187657cb3a0ebd8ac0050aa9e8118e188dc068d6fd781c630e4d62.jpg)
...
Figure 24: Number of bank branches – HK / MY / SG / VN   
![](images/8199ae6e6cf3cfd11038fe43ce368809d504c82df199095cfc9022c4fb30e0ae.jpg)
...
Source: Central banks, company data. Note: Data for Singapore is based on total branch count for OCBC and UOB. Data for Vietnam is based on total branch count for TCB, MBB, VPB, and ACB.

# Even as total employee headcount has generally risen...

While the total number of branches in most Asian markets have declined over the past 5y, the total number of bank employees have increased for most markets.

This could have been driven by a shift in employee mix from customer-facing branch tellers in the past to increasingly more back-end tech support staff over the years. Furthermore, the increase in overall headcount could have been driven by the need for more technological investments and thus higher tech headcount among banks over the past few years, given increasing competition from fintechs and increasing demand from end consumers for better digital offerings.

Markets that saw the largest increase in bank employees over the past 5y were India (+37%), Singapore (+25%), and Taiwan (+18%). On the other hand, markets that saw a decline in bank employees were Thailand (-16%), Hong Kong (-5%), and Korea (-5%).

Figure 25: Number of bank employees – CN   
![](images/5f68a86f5c2b49943e591ae2a090352650fbecd5d3a008882368cddc3105dec9.jpg)

<details>
<summary>line</summary>

| Year | Number of bank employees |
| ---- | ------------------------ |
| 2006 | 1,400,000                |
| 2015 | 1,750,000                |
| 2024 | 1,650,000                |
...
Source: Company data. Note: Data for China is based on total employee count for ICBC, CCB, ABC, BOC, and BOCOM.

Figure 26: Number of bank employees – IN   
![](images/7d10ad4e25ed2128e39e22278bf267e1568b60f6bccad03218578d9576f8cbc1.jpg)
...
Source: Company data. Note: Data for India is based on total employee count for HDFCB, ICICI, SBI, Axis, and Kotak.

Figure 27: Number of bank employees – KR / JP / AU / MY / ID / TH   
![](images/267d43556dfd24dec637de15ddf05faddbdfb0eb2c6193ba479d14522726aeb3.jpg)

<details>
<summary>line</summary>

| Year | KR    | JP    | AU    | MY    | ID    | TH    |
|------|-------|-------|-------|-------|-------|-------|
| 2000 |       |       | 138,000 |       |       |       |
| 2001 |       |       | 135,000 |       |       |       |
| 2002 |       |       | 132,000 |       |       |       |
...
| 2007 |       |       | 138,000 |       |       |       |
| 2008 |       | 98,000| 142,000|       |       |       |
| 2009 |       | 102,000| 155,000|       |       |       |
| 2010 |       | 105,000| 178,000| 115,000| 95,000|       |
| 2011 |       | 103,000| 175,000| 135,000| 125,000|      |
| 2012 |       | 125,000| 172,000| 145,000| 155,000|      |
| 2013 |       | 135,000| 175,000| 148,000| 165,000|      |
| 2014 |       | 145,000| 178,000| 145,000| 175,000|      |
| 2015 |       | 155,000| 175,000| 148,000| 185,000|      |
| 2016 |       | 165,000| 172,000| 135,000| 195,000|      |
| 2017 |       | 175,000| 168,000| 125,000| 198,000|      |
| 2018 |       | 185,000| 165,000| 115,000| 195,000|      |
| 2019 |       | 195,000| 162,000| 118,000| 198,000|      |
| 2020 |       | 215,000| 165,000| 125,000| 195,000|      |
| 2021 |       | 235,000| 175,000| 135,000| 198,000|      |
| 2022 |       | 255,000| 185,000| 145,000| 215,000|      |
| 2023 |       | 275,000| 195,000| 155,000| 235,000|      |
| 2024 |       | 295,000| 215,000| 165,000| 265,000|      |
| 2025 |       |         |     |     |     |     |
</details>

Source: Central banks, company data. Note: Data for Japan (MUFG, SMBC), Australia (CBA, NAB, ANZ, Westpac), Indonesia (BBCA, BBRI, BMRI, BBNI).

Figure 28: Number of bank employees – HK / TW / SG / PH / VN   
![](images/da4a40a94f7dea63e94442b8f2fdd3dd7a1219fe22b67dbd5229be4c4e98d21d.jpg)  
Source: Company data. Note: Data for Hong Kong (BOCHK, BEA), Taiwan (CTBC, Mega, E.Sun), Singapore (DBS, OCBC, UOB), Philippines (BDO, BPI), Vietnam (VCB, TCB, VPB, MBB, ACB).

# ...growth in staff costs per employee has lagged nominal GDP growth

Consistent with the discussion above, even as total bank employee headcount has generally risen across most markets, staff costs per employee have also increased over the past five years but at a pace below nominal GDP growth (Figure 33).

This suggests improving cost efficiencies, as growth in personnel expenses has been relatively contained despite expanding workforces – likely reflecting a shift toward lower cost back-end and technology-focused roles enabled by higher technology investment, which we discuss further in the following section.

Over the same period, markets that saw the largest increases in staff costs per employee (in US\$ terms) were Hong Kong, Malaysia, Singapore, and China (+5%). Conversely, staff costs per employee rose the least in Japan (-5%), Korea, Thailand, and Taiwan (+1%).

Figure 29: Staff costs per employee – HK / KR / JP / AU / SG   
![](images/12d9a37b0107e5972d3b156d2477f0dce756e3131ab83f704c79ca4cfa913ef7.jpg)  
Source: Company data. Note: Data for Hong Kong (BOCHK, BEA), Japan (MUFG, SMBC), Australia (CBA, NAB, ANZ, Westpac), Singapore (DBS, OCBC, UOB).

Figure 30: Staff costs per employee – CN / TW / MY   
![](images/b02019bda8295f2e4cae353b85ef7f2c729f4c87945997aa1ad89eca9593c1d6.jpg)
...
| Year | CN     | TW     | MY     |
|------|--------|--------|--------|
| 2006 | 10,000 | 40,000 | 30,000 |
| 2010 | 25,000 | 45,000 | 35,000 |
| 2014 | 35,000 | 50,000 | 30,000 |
| 2018 | 45,000 | 55,000 | 45,000 |
| 2021 | 55,000 | 65,000 | 55,000 |
| 2024 | 55,000 | 65,000 | 60,000 |
</details>

Source: Company data. Note: Data for China (ICBC, CCB, ABC, BOC, and BOCOM), Taiwan (CTBC, Mega, E.Sun).

Figure 31: Staff costs per employee – ID / TH   
![](images/c74e0db35c9e576223124aa2f233a165f5b11e2396deb7c43a8b7d7f4df28d78.jpg)
...
Source: Company data. Note: Data for Indonesia (BBCA, BBRI, BMRI, BBNI).

Figure 32: Staff costs per employee – IN / PH / VN   
![](images/bf094e38879f117024063ca539bc781daf9fe7a4dc01eff4f7900d11a97d426f.jpg)
...
Source: Company data. Note: Data for India (HDFCB, ICICI, SBI, Axis, and Kotak), Philippines (BDO, BPI), Vietnam (VCB, TCB, VPB, MBB, ACB).

While staff costs per employee growth generally lagged nominal GDP growth across the region, we note Hong Kong and Korea were the only 2 markets where staff costs per employee growth outpaced nominal GDP growth. This may point to more limited staff cost gains from technology investments in Hong Kong and Korea, where opportunities to lower average personnel costs through workforce shuffling appear more constrained.

Figure 33: Growth in staff costs per employee relative to nominal GDP growth   
![](images/7db6995c0da505bc97d357815d2cf7d3fa194368b87c9078d730f84b17f76c58.jpg)

<details>
<summary>bar</summary>

Staff costs per headcount vs nominal GDP growth
| Country | Staff costs/headcount (US$, 5y CAGR) (%) | Nominal GDP growth (US$, 5y CAGR) (%) |
| :--- | :--- | :--- |
| HK | 5 | 4 |
| MY | 5 | 7 |
| SG | 5 | 11 |
...
Source: Central banks, company data

# How much are banks spending on technology?

Based on company disclosures where available, we calculate the big banks in Asia are spending around 4-5% of their revenue on technology expenses on average. This ratio has increased by 1-2ppt on average over the past 10y.

Banks in Singapore, Australia, and Taiwan are spending around 6-10% of their revenues on technology expenses, while in EM markets such as China, Malaysia, Philippines, and Vietnam, technology spend is relatively lower at 1-4% of revenue.

Figure 34: Tech expenses/revenue ratio (ASEAN Banks)   
![](images/18668485627d1a2463f5082a585a728d2891bf1c70a7401988f218a85682afb7.jpg)

<details>
<summary>line</summary>

| Year | DBS (SG) | UOB (SG) | MBBM (MY) | PUBM (MY) | BDO (PH) | MBT (PH) | TCB (VN) |
|------|----------|----------|-----------|-----------|----------|----------|----------|
| 2010 | 8.0%     | 3.0%     | 4.0%      | 0.5%      | 1.0%     | 1.5%     | 0.5%     |
| 2011 | 8.5%     | 2.8%     | 3.5%      | 0.5%      | 0.8%     | 1.4%     | 0.5%     |
| 2012 | 7.8%     | 2.6%     | 3.6%      | 0.5%      | 0.6%     | 1.3%     | 0.5%     |
| 2013 | 7.6%     | 2.5%     | 3.5%      | 0.5%      | 0.5%     | 1.2%     | 0.5%     |
| 2014 | 8.0%     | 2.7%     | 3.2%      | 0.5%      | 0.5%     | 1.1%     | 0.5%     |
| 2015 | 8.2%     | 3.0%     | 3.0%      | 0.5%      | 0.5%     | 1.0%     | 0.5%     |
| 2016 | 7.8%     | 3.5%     | 2.8%      | 0.5%      | 0.5%     | 0.9%     | 0.5%     |
| 2017 | 7.5%     | 4.0%     | 2.7%      | 0.5%      | 0.5%     | 0.8%     | 0.5%     |
| 2018 | 7.3%     | 4.5%     | 2.6%      | 0.5%      | 0.5%     | 0.7%     | 0.5%     |
| 2019 | 7.2%     | 5.0%     | 2.5%      | 0.5%      | 0.5%     | 0.6%     | 0.5%     |
| 2020 | 7.4%     | 6.5%     | 2.4%      | 0.5%      | 0.5%     | 0.5%     | 0.5%     |
| 2021 | 7.6%     | 6.8%     | 2.3%      | 0.5%      | 0.5%     | 0.4%     | 0.5%     |
| 2022 | 7.3%     | 7.0%     | 2.4%      | 1.0%      | 1.0%     | 1.5%     | 1.5%     |
| 2023 | 6.8%     | 7.2%     | 2.8%      | 1.5%      | 1.2%     | 1.8%     | 2.5%     |
| 2024 | 6.5%     | 7.5%     | 3.2%      | 2.0%      | 1.3%     | 2.0%     | 2.8%     |
| 2025 | 6.3%     | 8.2%     | 3.6%      | 2.2%      | 1.4%     | 2.2%     | 3.0%     |
</details>

Source: Company data

Figure 35: Tech expenses/revenue ratio (ex-ASEAN Banks)   
![](images/446fc40e10eaee8858183f00f1dd1e494cd1085673cb72878dc856438cecd164.jpg)

<details>
<summary>line</summary>

| Year | CBA (AU) | ANZ (AU) | Westpac (AU) | ABC (CN) | BOC (CN) | E.Sun (TW) | Woori FG (KR) |
|------|----------|----------|--------------|----------|----------|------------|---------------|
| 2010 | 5.0%     | 5.0%     | 3.5%         | 3.0%     | 3.0%     | 5.0%       | 1.0%          |
| 2011 | 5.5%     | 6.0%     | 3.5%         | 3.0%     | 3.0%     | 5.5%       | 1.0%          |
| 2012 | 5.5%     | 7.5%     | 3.0%         | 3.0%     | 3.0%     | 6.0%       | 1.5%          |
| 2013 | 5.5%     | 6.5%     | 3.0%         | 3.0%     | 3.0%     | 6.5%       | 1.5%          |
| 2014 | 5.5%     | 6.0%     | 3.0%         | 3.0%     | 3.0%     | 7.0%       | 1.5%          |
| 2015 | 5.5%     | 6.5%     | 3.0%         | 3.0%     | 3.0%     | 7.5%       | 1.5%          |
| 2016 | 6.0%     | 9.0%     | 3.0%         | 3.0%     | 3.0%     | 8.0%       | 1.5%          |
| 2017 | 7.0%     | 6.5%     | 3.0%         | 3.0%     | 3.0%     | 8.5%       | 1.5%          |
| 2018 | 7.5%     | 9.5%     | 3.0%         | 3.0%     | 3.0%     | 9.0%       | 1.5%          |
| 2019 | 7.5%     | 8.0%     | 3.0%         | 3.0%     | 3.0%     | 9.5%       | 1.5%          |
| 2020 | 8.0%     | 9.5%     | 3.0%         | 3.0%     | 3.0%     | 10.0%      | 1.5%          |
| 2021 | 8.5%     | 8.5%     | 3.0%         | 3.0%     | 3.0%     | 9.5%       | 1.5%          |
| 2022 | 8.5%     | 8.0%     | 3.0%         | 3.0%     | 3.0%     | 10.0%      | 1.5%          |
| 2023 | 8.0%     | 8.5%     | 3.0%         | 3.5%     | 3.5%     | 8.5%       | 1.5%          |
| 2024 | 8.5%     | 9.5%     | 3.0%         | 3.5%     | 3.5%     | 7.5%       | 1.5%          |
| 2025 | 8.5%     | 9.5%     | 3.0%         | 3.5%     | 3.5%     | 7.0%       | 1.5%          |
</details>

Source: Company data

We calculate technology expenses accounted for around 9-10% of total opex for the big banks in Asia in 2025. Markets that stand out are Singapore, Australia, and Taiwan where technology expenses account for 15-18% of total opex. China and Vietnam banks are not far behind, with technology expenses accounting for c10% of total opex.

Despite rising technology investment, the link to measurable cost efficiency remains weak at the aggregate level, highlighting the limitations of traditional digitalisation efforts, in our view.

Figure 36: Tech expenses/total opex ratio (ASEAN Banks)   
![](images/03decff2fb7760cd115bd8a188def39285a3a0aa9f696d40d660162903c332f5.jpg)
...
| Year | DBS (SG) | UOB (SG) | MBBM (MY) | PUBM (MY) | BDO (PH) | MBT (PH) | TCB (VN) |
|------|----------|----------|-----------|-----------|----------|----------|----------|
| 2010 | 19.5%    | 8.0%     | 8.0%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2011 | 19.0%    | 7.0%     | 7.0%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2012 | 17.5%    | 6.5%     | 7.5%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2013 | 17.0%    | 6.0%     | 7.0%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2014 | 17.5%    | 6.5%     | 7.5%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2015 | 17.5%    | 7.0%     | 7.0%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2016 | 17.5%    | 8.0%     | 6.5%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2017 | 17.0%    | 9.0%     | 6.0%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2018 | 16.0%    | 10.0%    | 6.0%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2019 | 16.5%    | 11.0%    | 6.0%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2020 | 17.5%    | 13.0%    | 6.0%      | 1.5%      | 1.5%     | 2.0%     | 1.5%     |
| 2021 | 17.0%    | 14.5%    | 6.0%      | 1.5%      | 1.5%     | 2.0%     | 3.0%     |
| 2022 | 16.5%    | 14.5%    | 6.0%      | 4.0%      | 1.5%     | 3.0%     | 4.0%     |
| 2023 | 16.0%    | 16.0%    | 6.5%      | 4.5%      | 2.0%     | 3.5%     | 7.0%     |
| 2024 | 15.5%    | 17.0%    | 7.0%      | 6.0%      | 2.0%     | 4.0%     | 8.0%     |
| 2025 | 14.5%    | 18.5%    | 7.5%      | 6.0%      | 2.0%     | 4.5%     | 9.0%     |
</details>

Source: Company data

Figure 37: Tech expenses/total opex ratio (ex-ASEAN Banks)   
![](images/e2035a338064c16b6f6030a56739ab0c11a8276bc34aebe1ef93c8a6d08a8113.jpg)
...
| Year | CBA (AU) | ANZ (AU) | Westpac (AU) | ABC (CN) | BOC (CN) | E.Sun (TW) | Woori FG (KR) |
|------|----------|----------|--------------|----------|----------|------------|---------------|
| 2010 | 10%      | 9%       | 7%           | 8%       | 8%       | 10%        | 3%            |
| 2011 | 11%      | 12%      | 9%           | 8%       | 8%       | 11%        | 3%            |
| 2012 | 11%      | 15%      | 7%           | 8%       | 8%       | 12%        | 3%            |
| 2013 | 11%      | 14%      | 7%           | 8%       | 8%       | 13%        | 3%            |
| 2014 | 13%      | 10%      | 6%           | 8%       | 8%       | 14%        | 3%            |
| 2015 | 13%      | 12%      | 6%           | 8%       | 8%       | 15%        | 3%            |
| 2016 | 14%      | 15%      | 6%           | 8%       | 8%       | 16%        | 3%            |
| 2017 | 18%      | 11%      | 6%           | 8%       | 8%       | 24%        | 2%            |
| 2018 | 17%      | 18%      | 6%           | 8%       | 8%       | 22%        | 2%            |
| 2019 | 16%      | 15%      | 6%           | 6%       | 6%       | 18%        | 2%            |
| 2020 | 20%      | 16%      | 5%           | 8%       | 9%       | 17%        | 2%            |
| 2021 | 18%      | 16%      | 5%           | 8%       | 9%       | 17%        | 2%            |
| 2022 | 17%      | 16%      | 5%           | 9%       | 10%      | 16%        | 2%            |
| 2023 | 17%      | 16%      | 5%           | 9%       | 9%       | 15%        | 2%            |
| 2024 | 17%      | 17%      | 5%           | 9%       | 9%       | 14%        | 2%            |
| 2025 | 17%      | 17%      | 5%           | 9%       | 10%      | 14%        | 2%            |
</details>

Source: Company data

# Are the technology investments leading to costs savings?

Our findings suggest this relationship looks fairly mixed for Asian banks overall. The scatter plot in Figure 38 indicates a very weak negative correlation between technology spend (as a percentage of assets) and total operating expenses (as a percentage of assets). In other words, banks with higher IT costs relative to assets tend to exhibit lower overall cost intensity.

Figure 38: Are higher tech investments leading to costs savings?   
![](images/17a3a0db25d740fa087a2f25b9b94a9f972508ca01e4205abeb15a24bd0303d8.jpg)

<details>
<summary>scatter</summary>

| Company | Change in IT costs/ assets ratio (2021-25) | Change in total costs/ assets ratio (2021-25) |
|---------|---------------------------------------------|------------------------------------------------|
| E.Sun (TW) | -0.04% | 0.00% |
| CBA (AU) | -0.02% | 0.00% |
| DBS (SG) | 0.00% | 0.00% |
| ANZ (AU) | 0.00% | 0.00% |
| Woori FG (KR) | 0.00% | -0.10% |
| MBBM (MY) | 0.04% | 0.00% |
| PUBM (MY) | 0.06% | 0.00% |
| UOB (SG) | 0.06% | 0.20% |
| BDO (PH) | 0.02% | -0.30% |
| MBT (PH) | 0.04% | -0.30% |
| TCB (VN) | 0.08% | -0.70% |
| Westpac (AU) | 0.02% | -0.30% |
| ABC (CN) | 0.02% | -0.40% |
</details>

Source: Company data

This relationship appears to be more driven by changes in staff cost structure (Figure 39). Technology investments reduce reliance on higher-cost front-end roles by automating customer-facing and manual processes, even as overall headcount continues to grow (see the section above). The resulting shift toward more back-end and operational roles, which are typically lower-cost, helps contain personnel expenses and contributes to lower overall cost intensity.

This relationship is more pronounced in emerging markets such as Vietnam and the Philippines. This is intuitive, as these markets generally started with lower operating efficiency, leaving greater scope to capture meaningful cost savings through higher technology investments.

We believe that continued technology investment should further enhance operating efficiency, particularly across emerging markets, over the medium term. To date, most tech spending has been directed toward digitalising legacy systems, enhancing digital capabilities (e.g. retail and consumer banking interfaces), and strengthening cybersecurity. Looking ahead, we see artificial intelligence as the next potential driver of operating efficiency gains.

Over time, we believe AI is likely to emerge as a key differentiator among banks: those that invest early and meaningfully in AI, and, importantly, foster an organisational culture that supports experimentation and rapid implementation, are likely to be best positioned to translate technological capability into sustainable efficiency gains and competitive advantage. We discuss this in more detail in the section below – Will AI drive better costs efficiencies for the Asian banks?

Figure 39: Higher tech investments has generally led to lower staff costs...   
![](images/ce0f8b815e2e0df3a07c39065c788b830b22e2f1f845af351e3596991be152ea.jpg)

<details>
<summary>scatter</summary>

| Company | Change in IT costs/ assets ratio (2021-25) (%) | Change in staff costs/ assets ratio (2021-25) (%) |
| :--- | :--- | :--- |
| E.Sun (TW) | -0.04 | 0.00 |
| Westpac (AU) | -0.02 | 0.00 |
| CBA (AU) | -0.02 | 0.00 |
| DBS (SG) | 0.00 | 0.20 |
| ANZ (AU) | 0.06 | -0.10 |
| Woori FG (KR) | 0.02 | -0.10 |
| BDO (PH) | 0.04 | -0.10 |
| MBBM (MY) | 0.04 | -0.10 |
| PUBM (MY) | 0.04 | -0.10 |
| UOB (SG) | 0.06 | -0.10 |
| MBT (PH) | 0.02 | -0.30 |
| MCB (VN) | 0.08 | -0.65 |
The chart displays a dashed red trend line connecting the data points across multiple labeled categories (e.g., ABC (CN), BOC (CN), Woori FG (KR), MBBM (MY), UOB (SG)) to highlight the direction of the trend line.
</details>

Source: Company data

Figure 40: ...but an increase in other costs (which includes tech costs)   
![](images/aa4f27cb49357e1f01372411011fcf4be4497e0802ae81f893d3eb36d689a202.jpg)

<details>
<summary>scatter</summary>

| Company | Change in other costs/ assets ratio (2021-25) | Change in IT costs/ assets ratio (2021-25) |
|---------|-----------------------------------------------|---------------------------------------------|
| E.Sun (TW) | -0.04% | 0.00% |
| BOC (CN) | 0.05% | -0.02% |
| DBS (SG) | 0.00% | -0.02% |
| Woori FG (KR) | 0.00% | 0.00% |
| ANZ (AU) | -0.05% | 0.02% |
| MBBM (MY) | 0.04% | 0.04% |
| PUBM (MY) | 0.08% | 0.08% |
| UOB (SG) | 0.10% | 0.08% |
...
| TCB (VN) | -0.30% | 0.08% |
| ABC (CN) | -0.20% | -0.02% |
| Westpac (AU) | -0.30% | -0.02% |
</details>

Source: Company data

# Alternate measures of operating efficiency

Another measure of operating efficiency, aside from the more commonly used cost-to-income ratio (CIR), is the level of loans and deposits per branch, which serves as a proxy for branch-level productivity.

# Loans per branch ratio

Loans per branch, measured on a LC basis, have increased across all Asian banking markets over the past five years. The largest increases were observed in Vietnam (+21% CAGR), Australia (+14%), China (+13%), and India (+11%).

While loans per branch have risen across the region, not all markets delivered improvements relative to nominal GDP growth. This distinction is important, as loan growth is fundamentally driven by nominal GDP; therefore, genuine operating efficiency gains should manifest as faster growth in loans per branch relative to nominal GDP.

Our analysis shows that only around 70% of Asian banking markets recorded loans-per-branch growth that outpaced nominal GDP growth over the past five years – namely Vietnam, Australia, China, India, Korea, Thailand, Singapore, Taiwan, and Japan.

This suggests that banks in these markets were more successful in translating operational improvements (including digitalisation and productivity gains) into higher branch level efficiency on this metric.

Figure 41: Growth in loans per branch relative to nominal GDP growth   
![](images/29d21b912171bedef336f1da3031deb1522e4a2b9a4c0650784bba42ef2c35d4.jpg)

<details>
<summary>bar</summary>

Loans per branch ratio vs nominal GDP growth
| Country | Loans/branch (LC, 5y CAGR) (%) | Nominal GDP growth (LC, 5y CAGR) (%) |
| :--- | :--- | :--- |
| VN | 21 | 9 |
| AU | 14 | 6 |
| CN | 13 | 7 |
...
Below charts shows the absolute loans per branch trend for the various Asian markets in US\$ terms. On an absolute basis, it is not surprising to see that the DM banks have higher loans per branch ratio compared to the EM banks given their relatively higher GDP per capita.

Figure 42: Loans per branch (US\$m) – HK / AU   
![](images/30c6cfcdbce81fe2cbabc28ce3f33da856ad242f624e3656734c02efa9deeafb.jpg)
...
Figure 43: Loans per branch (US\$m) – JP / TW / SG   
![](images/acf15a593f6584eb8dc23111fdce1dde337147a50c156ccfaaf07e49233bc825.jpg)
...
Source: Central banks, company data. Note: Data for Singapore is based on total for OCBC and UOB.

Figure 44: Loans per branch (US\$m) – CN / KR / MY / ID / TH / VN   
![](images/af492a8f8fa4319cdf39165b02583e51501340bb1de181d049c16fe03130f559.jpg)

<details>
<summary>line</summary>

| Year | CN   | KR   | MY   | ID   | TH   | VN   |
|------|------|------|------|------|------|------|
| 2000 |      |      |      |      |      |      |
| 2001 |      |      |      |      |      |      |
| 2002 |      |      |      |      |      |      |
...
| 2022-        |       |       |       |       |       |       |
| 2023-        |       |       |       |       |       |       |
| 2024E        (note) - KN - KR - MY - ID - TH - VN - VN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN - YCN
    end
</details>

Source: Central banks, company data. Note: Data for China is based on total for ICBC, CCB, ABC, BOC, and BOCOM. Data for Vietnam is based on total for TCB, MBB, VPB, and ACB.

Figure 45: Loans per branch (US\$m) – IN / PH   
![](images/f42bd3859d87f1db567884c62e04cd261ce268eb080388305d34e4fccd2d9712.jpg)
...
# Deposits per branch ratio

Deposits per branch, measured on a LC basis, have increased across all Asian banking markets over the past five years, with Japan again the key exception due to JPY depreciation. The strongest growth was recorded in Vietnam (+16% CAGR), Australia (+15%), China (+11%), and India (+10%).

As with the loans-per-branch analysis, while deposits per branch have risen across the region, not all markets delivered improvements relative to nominal GDP growth. This distinction matters, as deposit growth is also closely linked to nominal economic growth; therefore, meaningful operating efficiency gains should result in deposits per branch growing faster than nominal GDP.

Our analysis indicates that all Asian banking markets achieved deposits-per-branch growth that outpaced nominal GDP growth over the past five years, except Malaysia. This suggests the Malaysian banks were less successful in improving branch level productivity and extracting operating efficiency gains on this metric.

Figure 46: Growth in deposits per branch relative to nominal GDP growth   
![](images/a32fb9c93c5c362ee5e55adaf3a022688c044e59ceb5d60521178b9f84b271ff.jpg)

<details>
<summary>bar</summary>

Deposits per branch ratio vs nominal GDP growth
| Country | Deposits/branch (LC, 5y CAGR) (%) | Nominal GDP growth (LC, 5y CAGR) (%) |
| :--- | :--- | :--- |
| VN | 16 | 9 |
| AU | 15 | 6 |
| CN | 11 | 7 |
...
Below charts shows the absolute deposits per branch trend for the various Asian markets in US\$ terms.

Figure 47: Deposits per branch (US\$m) – HK   
![](images/c7627bcb519a611b2ba4bb7ccfc4a922f882727eae8be3f826ae4770aa79737f.jpg)

<details>
<summary>line</summary>

| Year | Deposits/branch (US$ mn) |
| ---- | ------------------------ |
| 2000 | 300                      |
| 2001 | 320                      |
| 2002 | 340                      |
...
Figure 48: Deposits per branch (US\$m) – JP / AU / TW / SG   
![](images/7a4c797317250847f1019c57e5e6afb3028e03bf4361754add5d914d492d4595.jpg)  
Source: Central banks, company data. Note: Data for Singapore is based on total for OCBC and UOB.

Figure 49: Deposits per branch (US\$m) – CN / KR / MY / ID / TH / VN   
![](images/69d9c234af8eae0989f34162f091707648d1dc0a9614a3af146d68b39a15d176.jpg)  
Source: Central banks, company data. Note: Data for China is based on total for ICBC, CCB, ABC, BOC, BOCOM, and PSBC. Data for Vietnam is based on total for TCB, MBB, VPB, and ACB.

Figure 50: Deposits per branch (US\$m) – IN / PH   
![](images/f65bc1df7c0b372731f5d1dc70ea96d59e0703c5c981fcfea2865d4c0c82356d.jpg)
...
# Will AI drive better costs efficiencies for the Asian banks?

Having discussed the key cost drivers – and the extent to which they have only partially offset structural revenue pressures for Asian banks – the question then becomes whether AI can emerge as the next structural driver of operating efficiency.

AI is increasingly viewed as a strategic necessity, with banks that fail to evolve toward AI-native operating models at risk of falling behind on both cost efficiency and competitive capability. Against this backdrop, adoption is accelerating across the region, with many Asian banks moving beyond pilot programmes toward scaled, enterprise-wide deployment of GenAI and agentic AI across core operations.

These efforts are primarily focused on three broad areas so far: 1) enhancing customer experience through personalization; 2) driving productivity gains in internal workflows like software engineering and document processing; and 3) fortifying defensive moats through real-time fraud detection and risk analytics. However, the financial impact of these use cases is uneven across categories.

# From a P&L perspective, the financial impact of these initiatives is asymmetric across these three areas:

Investments in customer personalization are best viewed as defensive rather than revenue accretive, as such capabilities have increasingly become table stakes across the industry. While improved engagement and cross-sell are often cited benefits, the more tangible outcome is the prevention of customer attrition and share loss, in our view. As personalization becomes ubiquitous, its absence is more likely to result in revenue leakage than its presence driving incremental topline growth.

Productivity-oriented use cases, particularly in software development, operations, and document processing, offer clearer scope for cost efficiencies in the medium term, although quantification remains challenging at this stage. We believe gains are likely to accrue gradually through headcount cost avoidance, faster turnaround times, and reduced error rates rather than explicit cost out. As such, near-term margin uplift may be limited, with benefits manifesting more as a structural hedge against operating cost inflation over the medium term.

Lastly, AI investments in fraud detection and risk analytics have a more direct bearing on earnings stability rather than earnings expansion. While improved data ingestion and real-time analytics could modestly enhance credit underwriting outcomes, we believe the primary benefit lies in mitigating downside risks – lower fraud losses, earlier identification of asset quality deterioration, and reduced tail-risk events. In this sense, these capabilities help contain potential future costs that could otherwise materialise in the absence of such investments, supporting more resilient returns through the cycle.

As such, we believe the benefits of AI adoption are currently more operational than financial, with limited translation into reported cost ratios.

# Banks are spending more on AI than they are saving, at present

Despite these early operational breakthroughs – and we would expect meaningful costs savings in the medium term given that operations can represent \~60-70% of a bank's costs base (based on the McKinsey report here) – there is currently a noticeable financialization gap where AI has not yet translated into material costs improvements in many instances. This is evident in banks commentaries (particularly HSBC) summarised in the tables below.

The key reason behind this is that while localized efficiency gains are significant – such as reducing lending decision times or automating customer messaging – these are not yet headcount-cut stories in most cases (see our discussion on headcount in the section above). They are primarily capacity-release stories (same headcount, higher throughput)

AI deployment is shifting from isolated use cases to enterprise-wide adoption

Three channels of impact: personalisation (defensive), productivity (efficiency), risk (resilience)

AI helps retain revenues more than it drives incremental growth

Efficiency = gradual, not immediate: Benefits accrue via headcount avoidance and throughput gains

Risk containment: AI improves earnings stability rather than boosting profitability.

Operational gains are real, but financial benefits remain lagged. True cost savings require scaled, end-to-end deployment.

and cost-avoidance (not hiring), so far, which shows up gradually in cost/income overtime rather than immediate opex cuts.

Furthermore, the resulting cost savings today are likely being largely reinvested in additional capital expenditure required for larger data infrastructure, technological upgrades, cybersecurity, and compliance.

Consequently, many banks report that production use cases have not yet delivered significant financial impacts, as they prioritize reinvesting these gains into further technological modernization to remain competitive against peers and digital-native disruptors.

# Medium term: From implementation to costs savings

Looking ahead, we think the potential for AI to drive material cost savings for banks in the medium term remains strong given the large amount of data and human capital. Furthermore, based on the findings from McKinsey (report here), operations can represent \~60–70% of a bank's cost base, making operational AI the biggest cost lever for banks if scaled end-to-end.

For example, ICBC in China has said that it has reached a milestone where the workload handled by AI is equivalent to more than 40,000 full-time employees, illustrating the substantial scale of operational displacement possible.

Furthermore, as banks move past the initial high capex phase of building data infrastructure, these "digital workers" can scale with very low marginal cost, eventually allowing banks to scale their revenues without a linear increase in headcount or physical infrastructure.

# From qualitative statements to hard numbers

As investor expectations mature, banks will need to adapt by doing more than talking about AI. The bar is rising from signalling intent to proving impact, with greater emphasis on measurable P&L outcomes and strong governance. Institutions that fail to translate investment into demonstrable financial or risk-mitigating benefits risk losing credibility, as AI narratives without execution risk being increasingly discounted by the market.

Put differently, AI is transitioning from a narrative enhancer to a delivery obligation, with execution risk becoming as relevant as technological capability. Over time, differences in AI readiness and execution could become a key driver of cost and valuation divergence across Asian banks (please refer to our companion APAC Focus note here).

From narrative to differentiation: AI readiness could drive future valuation dispersion

Figure 51: Tech/AI applications and implications on business performance – ex-ASEAN banks 

<table><tr><td>Bank</td><td>Market</td><td>Tech/AI application and implications</td></tr><tr><td>ICBC</td><td>China</td><td>Built ICBC Zhiyong, a financial LLM system with over 100 billion parameters, helps to empower more than 20 main business fields and over 200 scenarios. AI wealth assistant helps to provide personalized services to its 630 million personal mobile banking users. The large-scale application of tech/AI at ICBC has resulted in a workload reduction equivalent to 40,000 persons annually.</td></tr><tr><td>BOC</td><td>China</td><td>Developed the BOCAI large model platform, deployed a series of large models such as DeepSeek and Qwen3, and built more than 400 intelligent assistants to empower key business functions including credit, marketing, operations, office work, customer service and technology. Leveraged enterprise-level robotic process automation (RPA) to reduce the workload of primary-level institutions, deploying RPA in over 3,600 scenarios and executing an average of nearly 300,000 tasks per month.</td></tr><tr><td>HSBC</td><td>Hong Kong</td><td>Have over 100 GenAI solutions in use and a strong pipeline of use cases in development. Around the globe, around 85% of HSBC staff have access to the large language model-based productivity tool, HSBC Productivity Suite, which helps them to analyse and translate documents, summarise information and generate insights. HSBC is increasing AI partnerships to accelerate adoption of cutting-edge technologies. HSBC notes that production use cases have not yet delivered &quot;significant&quot; financial impact in terms of bottom-line numbers, they are viewed as critical for long-term operational efficiency.</td></tr><tr><td>StanChart</td><td>Hong Kong</td><td>StanChart has launched SC GPT, a GenAI tool, across 41 markets worldwide. Designed to enhance operational efficiency and client engagement, SC GPT marks a significant step in the Bank&#x27;s strategy to integrate AI into its business. Set to empower over 70,000 employees worldwide, SC GPT is expected to improve the Bank&#x27;s operations and productivity; tailor sales and marketing efforts to increase revenue; advance software engineering with more automation; and scale how risks are measured, managed, recorded and reported. In July 2025, Standard Chartered signed a strategic partnership with Alibaba Group to deploy Alibaba Cloud AI technology across its client service, sales intelligence, risk management, and compliance functions.</td></tr><tr><td>Hana FG</td><td>Korea</td><td>Launched an AI-based loan product which uses AI to determine customer loan limits. The new product calculates optimal loan limits for applying customers&#x27; finances, based on its analysis of the Bank&#x27;s big data of loan transaction records and patterns.</td></tr><tr><td>Woori FG</td><td>Korea</td><td>Use of AI to streamline work processes. For example, the AI-based market prediction system supports optimization of asset management, whilst the fraudulent transaction monitoring system also leverages AI technology. Aims to expand the use of AI to customer services, and promoting various projects to establish potential banking services in line with this goal. This includes upgrading their AI-based counseling bot and chatbot services, as well as implementing an AI Banker by developing language models tailored to the financial sector.</td></tr><tr><td>MUFG</td><td>Japan</td><td>Implemented AI in 116 use cases and aim to exceed 250 by FY26. MUFG is advancing the development of AI agents (e.g. co-developing an AI credit expert with Sakana AI). For employees, AI is supporting tasks such as summarizing and translating materials, creating sentences and programs, aggregating and analyzing numbers, and generating ideas. Estimates that cumulative benefits from AI use cases over its current three-year medium-term business plan will reach approximately JPY30 billion.</td></tr><tr><td>SMFG</td><td>Japan</td><td>Beyond improving productivity by replacing human work, SMFG aims to develop a model where AI acts as a partner, analyzing data, anticipating customer needs, and making proposals using avatars in the core of banking business such as lending and asset management.</td></tr><tr><td>HDFCB</td><td>India</td><td>Using cloud-based AI/ML tools, the bank decodes customer behavior to curate &quot;hyper-personalized&quot; content and sharpens campaign precision to improve return on investment. Actively engaging in &quot;agentic AI&quot; projects through its Tech Innovators platform and collaborates with the RBI Innovation Hub on AI-based early warning systems and inclusive credit tools.</td></tr><tr><td>Axis Bank</td><td>India</td><td>The Bank is harnessing emerging technologies such as AI/ML, automation, and data analytics to enhance customer experience, optimize operational efficiency, and improve staff productivity by building AI assists. By process Re-Engineering and digitisation, the Bank has been able to reduce the turnaround time on savings and current account opening by about 90%; and on various other processes by 50%-80%. In addition to improving efficiency, there was significant impact on customer satisfaction and risk containment.</td></tr><tr><td>CBA</td><td>Australia</td><td>Consistently invested in technology, data and analytics to deliver more personalised experiences for our customers and make things easier for CBA employees. CBA has achieved tangible efficiency gains, including a 65.00% improvement in recovery times from critical incidents and a 39.00% decrease in core operations complaints.</td></tr><tr><td>NAB</td><td>Australia</td><td>Advanced technology modernisation agenda by streamlining systems, simplifying processes, and embedding smarter, faster, and safer digital solutions. NAB&#x27;s investment in AI and technology has yielded significant financial protections, preventing or recovering over $385 million in customer scam and fraud losses in 2025.</td></tr></table>

Source: Company data

Figure 52: Tech/AI applications and implications on business performance – ASEAN banks 

<table><tr><td>Bank</td><td>Market</td><td>Tech/AI application and implications</td></tr><tr><td>DBS</td><td>Singapore</td><td>DBS&#x27; data analytics and artificial intelligence (AI)/ machine learning (ML) initiatives delivered over SGD 750 million of economic value in 2024, more than double that in the previous year, and aiming for a total economic impact of SGD 1 billion from AI and data initiatives in 2025. The bank has implemented over 1,500 AI models across 370 distinct use cases. DBS uses AI to automate routine &quot;white-collar&quot; tasks, such as writing credit memos, performing KYC (Know Your Customer) checks, and screening transactions. Approximately two-thirds of staff use Gen AI for tasks like summarization, research, and translation, while data scientists use AI coding assistants to reduce coding time by up to 20%. Agentic AI is being tested to generate credit evaluation memos, and Gen AI tools summarize customer calls for quality assurance. The use of AI is expected to lead to revenue, productivity and cost-income ratio improvements.</td></tr><tr><td>OCBC</td><td>Singapore</td><td>AI serves as a strategic lever to maximise value in three key areas: increasing revenue, reducing risk, and enhancing productivity. About six million decisions in the Bank are made by AI on a daily basis. These tools have boosted productivity by as much as 50 per cent, freeing up employees&#x27; time and enabling them to focus on higher-value tasks. OCBC aims for 75% of all customer service requests to be AI-assisted, reducing response times and enhancing the customer experience. As workflows and processes become increasingly optimised, OCBC anticipates a 20% increase in staff productivity. Achieved close to S$80 million in cost avoidance in 2025 through technology modernization and AI integration.</td></tr><tr><td>UOB</td><td>Singapore</td><td>Using GenAI to automate manual processes and increase the workflow efficiency. The end goal is to apply these AI solutions across the Bank to enhance business processes, productivity, manage risk and better personalise customer experience at scale and at speed. AI is being scaled to improve detection accuracy in areas such as Anti-Money Laundering (AML), fraud detection, and scam prevention.</td></tr><tr><td>Maybank</td><td>Malaysia</td><td>Piloted agentic AI in its internal auditing processes to automate selected workflows and enhance insight generation.</td></tr><tr><td>CIMB</td><td>Malaysia</td><td>Leverages conversational AI and chatbots to handle routine inquiries and improve response times across digital channels. AI is applied to credit decisioning, fraud detection, and general operational processes to improve consistency and service quality.</td></tr><tr><td>BDO</td><td>Philippines</td><td>Transitioning away from manual, low-end compliance and bookkeeping work by implementing AI solutions designed to enhance productivity, mitigate risk, and focus on higher-value advisory services.</td></tr><tr><td>BPI</td><td>Philippines</td><td>BPI utilizes AI and machine learning to analyze customer behavior, allowing for hyper-personalized product recommendations and &quot;digital nudges&quot; within its mobile apps. BPI is exploring AI-enhanced credit scoring models to better assess the creditworthiness of the &quot;unbanked&quot; or &quot;underbanked&quot; segments, using non-traditional data points to expand its lending reach.</td></tr><tr><td>BCA</td><td>Indonesia</td><td>Integrated the use of Augmented Reality (AR), Machine Learning (ML), and Generative Artificial Intelligence (Gen-AI) to automate internal processes and support strategic initiatives like fraud detection and AI assistance. Utilizes Gen-AI coding assistants to accelerate IT development, which significantly reduces risks and costs. Internally, AI agents at the contact center handle repetitive tasks, such as mortgage quality control, where an automatic engine replaced the manual work previously done by five agents. ML models are deployed for new customer segmentation and to predict customer attrition (churn), allowing for more targeted investment offerings.</td></tr><tr><td>BMRI</td><td>Indonesia</td><td>Mandiri uses AI and Gen-AI to provide personalized product recommendations and improve the efficiency of digital marketing across its digital channels. Focuses on both front-end and back-end automation to reduce operational bottlenecks and accelerate internal processes.</td></tr><tr><td>KBANK</td><td>Thailand</td><td>AI is embedded into end-to-end credit processes, including automated approval decisions, fraud prevention, and collection analytics to increase recovery rates. The bank has launched AINU, an AI-driven identity verification solution (facial recognition and OCR), and InsurTech solutions for automated accident assessments to process claims more efficiently.</td></tr><tr><td>SCBX</td><td>Thailand</td><td>Uses AI-powered advisory tools and predictive analytics to provide personalized recommendations and account planning. Its InnovestX platform delivers real-time data and AI-driven insights covering over 1,000 stocks. Digital lenders MONIX and ABACUS leverage proprietary AI engines for behavioral scoring to capture underserved segments with superior asset quality. CardX utilizes AI-driven collections to control credit costs and manage debt recovery efficiently. AI-driven security solutions identify anomalies and potential fraud by analyzing large volumes of network and user interaction data that traditional rule-based controls might miss.</td></tr><tr><td>TCB</td><td>Vietnam</td><td>Integrated AI across its entire value chain, processing over 8 billion data points daily to build detailed customer profiles with approximately 12,500 attributes each. Advanced analytics and machine learning initiatives delivered VND 1.3 trillion in incremental revenue in 2025. AI is being embedded into hyper-personalized credit decisioning models to enable faster, risk-aligned lending.</td></tr></table>

Source: Company data

Figure 53: Summary of AI applications by markets 

<table><tr><td>Market</td><td>Top AI Priority 1</td><td>Top AI Priority 2</td><td>What this indicates about the market&#x27;s AI strategy</td></tr><tr><td>China</td><td>Technology/engineering enablement – foundation LLM (100B parameters)</td><td>Productivity &amp; cost efficiency – RPA across 3,600+ processes</td><td>Chinese banks emphasise technological self-sufficiency and massive scale, building proprietary large language models and deploying AI across thousands of processes to achieve huge efficiency gains.</td></tr><tr><td>Hong Kong</td><td>Productivity &amp; cost efficiency – 85% of staff using GenAI tools</td><td>Revenue growth &amp; advisory – AI-driven sales &amp; revenue initiatives</td><td>Global banks in Hong Kong focus on enterprise-wide GenAI adoption for internal efficiency while also pursuing AI-enabled revenue growth (e.g. tailored marketing to boost sales ), indicating an emphasis on long-term innovation over immediate returns .</td></tr><tr><td>Korea</td><td>Credit &amp; underwriting – AI-based lending limits product</td><td>Risk, fraud &amp; compliance – AI fraud monitoring systems</td><td>Korean banks are selectively introducing AI in core lending (e.g. automated loan limit decisions ) and improving risk controls (AI-based fraud monitoring ), reflecting a targeted, cautious integration of AI into traditional banking.</td></tr><tr><td>Japan</td><td>Productivity &amp; cost efficiency – AI for workforce productivity (¥30 bn benefit target)</td><td>Credit &amp; underwriting – AI credit expert in lending</td><td>Japanese banks are pursuing broad AI deployment for efficiency gains (aiming ~¥30 bn cost benefits ) and innovating with AI in lending (co-developing an AI credit expert ) to embed AI as a trusted partner in core banking services .</td></tr><tr><td>India</td><td>Customer personalisation &amp; experience – hyper-personalised marketing &amp; content</td><td>Productivity &amp; cost efficiency – process automation for scale efficiency</td><td>Indian banks leverage AI to hyper-personalise products and campaigns for their huge customer bases (boosting marketing ROI ) alongside aggressive automation of high-volume processes (90% faster account opening, etc. ) to support growth at scale.</td></tr><tr><td>Australia</td><td>Customer personalisation &amp; experience – personalised digital services</td><td>Risk, fraud &amp; compliance – AI fraud &amp; scam prevention</td><td>Australian banks are improving digital customer experiences (more personalised services ) while strengthening AI-powered fraud and scam prevention (intercepting ~$385 m in scams in 2025 ), reflecting a balance between innovation and security.</td></tr><tr><td>Singapore</td><td>Productivity &amp; cost efficiency – enterprise-wide AI efficiency gains</td><td>Risk, fraud &amp; compliance – AI in compliance &amp; risk (KYC/AML)</td><td>Singapore’s banks lead in broad AI usage, achieving significant measurable value (SGD 750 m+ in 2024 ) by automating tasks at scale and tightening risk/compliance controls (e.g. KYC checks, AML, fraud detection ).</td></tr><tr><td>Malaysia</td><td>Customer personalisation &amp; experience – AI chatbots for customer service</td><td>Risk, fraud &amp; compliance – fraud detection &amp; audit automation</td><td>Malaysian banks prioritise practical improvements: deploying AI chatbots to handle routine customer queries faster and starting to automate internal control processes (e.g. AI in fraud monitoring &amp; auditing ) for greater efficiency.</td></tr><tr><td>Philippines</td><td>Customer personalisation &amp; experience – hyper-personalised offers &amp; nudges</td><td>Regulatory &amp; financial inclusion – AI credit scoring for unbanked segments</td><td>Philippine banks are catching up by automating manual tasks to improve productivity and using AI for highly tailored product suggestions &amp; credit scoring to reach the unbanked , highlighting both modernisation and financial inclusion.</td></tr><tr><td>Indonesia</td><td>Productivity &amp; cost efficiency – AR/GenAI-driven process automation</td><td>Customer personalisation &amp; experience – personalised product targeting</td><td>Indonesian banks are mixing frontier tech (AR, GenAI) to automate internal operations (e.g. AI agents in back-office roles ) with AI-driven personalisation in offerings and marketing , aligning with the country’s fast-evolving digital landscape.</td></tr><tr><td>Thailand</td><td>Credit &amp; underwriting – AI-embedded lending &amp; credit processes</td><td>Revenue growth &amp; advisory – AI-enabled advisory &amp; fintech growth</td><td>Thai banks are applying AI in core credit operations (from loan approval to fraud checks ) while developing AI-powered advisory and digital lending platforms to drive new growth and serve underserved segments .</td></tr><tr><td>Vietnam</td><td>Customer personalisation &amp; experience – data-driven hyper-personalisation</td><td>Credit &amp; underwriting – AI-augmented credit underwriting</td><td>Vietnam’s banks utilise huge data sets (8 billion+ daily data points ) to enable ultra-personalised customer insights and swift, AI-assisted lending decisions, supporting strong revenue growth in loans .</td></tr></table>

Source: Company data, UBS

# How do banking markets compare on opex-related metrics?

In this section, we summarise the key metrics across the Asian banking markets discussed above. The table below provides an overview of how the various revenue drivers (as a percentage of assets) have trended over the past 10 years across markets.

Figure 54: Opex drivers (as % of assets) 

<table><tr><td>As % of assets (10y chg)</td><td>Staff costs</td><td>Other opex</td><td>Total opex</td></tr><tr><td>China</td><td>↘</td><td>↘</td><td>↘</td></tr><tr><td>Hong Kong</td><td>→</td><td>↘</td><td>↘</td></tr><tr><td>Korea</td><td>↘</td><td>↘</td><td>↘</td></tr><tr><td>India</td><td>↗</td><td>↗</td><td>↗</td></tr><tr><td>Japan</td><td>↘</td><td>↘</td><td>↘</td></tr><tr><td>Australia</td><td>→</td><td>↘</td><td>↘</td></tr><tr><td>Taiwan</td><td>↘</td><td>↗</td><td>↗</td></tr><tr><td>Singapore</td><td>→</td><td>↘</td><td>→</td></tr><tr><td>Malaysia</td><td>↘</td><td>↗</td><td>↗</td></tr><tr><td>Philippines</td><td>↘</td><td>→</td><td>→</td></tr><tr><td>Indonesia</td><td>↘</td><td>↘</td><td>↘</td></tr><tr><td>Thailand</td><td>↘</td><td>→</td><td>↘</td></tr><tr><td>Vietnam</td><td>↘</td><td>↘</td><td>↘</td></tr><tr><td>Avg (Asia)</td><td>↘</td><td>↘</td><td>↘</td></tr></table>

Source: Central banks, company data, UBS estimates

# Net interest income/assets ratio

The table on the right shows the absolute change in net interest income/assets ratio for the various markets over the past 5y/10y/15y. Over the past 10 years, c50% of Asia banking markets have seen a decline in net interest income/assets ratio.

Markets where the net interest income/assets ratios have declined most were China, followed by Indonesia, and Malaysia. On the other hand, markets that have seen an increase in the net interest income/assets ratio were Philippines, India, and Singapore.

Below charts shows the net interest income/assets trend for the banking markets over the past 20 years. As of 2025, banking markets with the lowest net interest income/ assets ratio were Japan (0.65%), Taiwan (0.91%), and China (1.24%). Markets with the highest net interest income/assets ratio were Indonesia (4.84%), the Philippines (3.91%), and Vietnam (3.11%).

Figure 55: Net interest income/assets (chg) 

<table><tr><td>NII/ assets</td><td>5y</td><td>10y</td><td>15y</td></tr><tr><td>Japan</td><td>0.1%</td><td>-0.1%</td><td>-0.4%</td></tr><tr><td>Australia</td><td>0.0%</td><td>-0.1%</td><td>-0.3%</td></tr><tr><td>China</td><td>-0.7%</td><td>-1.1%</td><td>-1.0%</td></tr><tr><td>Korea</td><td>0.1%</td><td>-0.1%</td><td>-0.8%</td></tr><tr><td>Taiwan</td><td>0.1%</td><td>-0.1%</td><td>0.0%</td></tr><tr><td>Singapore</td><td>0.2%</td><td>0.1%</td><td>0.1%</td></tr><tr><td>Philippines</td><td>0.4%</td><td>1.0%</td><td>0.7%</td></tr><tr><td>India</td><td>0.3%</td><td>0.5%</td><td>0.7%</td></tr><tr><td>Thailand</td><td>0.1%</td><td>0.0%</td><td>-0.2%</td></tr><tr><td>Malaysia</td><td>0.0%</td><td>-0.2%</td><td>-0.6%</td></tr><tr><td>Hong Kong</td><td>0.0%</td><td>0.0%</td><td>0.0%</td></tr><tr><td>Indonesia</td><td>0.0%</td><td>-0.9%</td><td>-0.6%</td></tr><tr><td>Vietnam</td><td>-0.8%</td><td>0.0%</td><td>3.1%</td></tr><tr><td>Avg (Asia)</td><td>0.0%</td><td>-0.1%</td><td>-0.1%</td></tr></table>

Source: Central banks, company data, UBS estimates

Figure 56: Net interest income/assets ratio (DM)   
![](images/49376bd956e10f8cfd703d2e69e2caa47454f223f8934a9956087750e62a714c.jpg)  
Source: Central banks, company data, UBS estimates

Figure 57: Net interest income/assets ratio (EM)   
![](images/1fc429a63e2812f97999f903b6ae1fb1bcf3b6daf456f193b6ed865a4afb3e3b.jpg)

<details>
<summary>line</summary>

| Year | CN    | PH    | IN    | TH    | MY    | ID    | VN    | Avg (Asia) |
|------|-------|-------|-------|-------|-------|-------|-------|------------|
| 2004 | 2.0%  | 3.0%  | 2.8%  | 2.5%  | 2.3%  | 5.0%  | 2.5%  | 2.5%       |
| 2005 | 2.1%  | 3.2%  | 2.9%  | 2.6%  | 2.4%  | 5.1%  | 2.6%  | 2.6%       |
| 2006 | 2.2%  | 3.3%  | 3.0%  | 2.7%  | 2.5%  | 5.2%  | 2.7%  | 2.7%       |
| 2007 | 2.3%  | 3.4%  | 3.1%  | 2.8%  | 2.6%  | 5.3%  | 2.8%  | 2.8%       |
| 2008 | 2.4%  | 3.5%  | 3.2%  | 2.9%  | 2.7%  | 5.4%  | 2.9%  | 2.9%       |
| 2009 | 2.5%  | 3.6%  | 3.3%  | 3.0%  | 2.8%  | 5.5%  | 3.0%  | 3.0%       |
| 2010 | 2.6%  | 3.7%  | 3.4%  | 3.1%  | 2.9%  | 5.6%  | 3.1%  | 3.1%       |
| 2011 | 2.7%  | 3.8%  | 3.5%  | 3.2%  | 3.0%  | 5.7%  | 3.2%  | 3.2%       |
| 2012 | 2.8%  | 3.9%  | 3.6%  | 3.3%  | 3.1%  | 5.8%  | 3.3%  | 3.3%       |
| 2013 | 2.9%  | 4.0%  | 3.7%  | 3.4%  | 3.2%  | 5.9%  | 3.4%  | 3.4%       |
| 2014 | 3.0%  | 4.1%  | 3.8%  | 3.5%  | 3.3%  | 6.0%  | 3.5%  | 3.5%       |
| 2015 | 3.1%  | 4.2%  | 3.9%  | 3.6%  | 3.4%  | 6.1%  | 3.6%  | 3.6%       |
| 2016 | 3.2%  | 4.3%  | 4.0%  | 3.7%  | 3.5%  | 6.2%  | 3.7%  | 3.7%       |
| 2017 | 3.3%  | 4.4%  | 4.1%  | 3.8%  | 3.6%  | 6.3%  | 3.8%  | 3.8%       |
| 2018 | 3.4%  | 4.5%  | 4.2%  | 3.9%  | 3.7%  | 6.4%  | 3.9%  | 3.9%       |
| 2019 | 3.5%  | 4.6%  | 4.3%  | 4.0%  | 3.8%  | 6.5%  | 4.0%  | 4.0%       |
| 2020 | 3.6%  | 4.7%  | 4.4%  | 4.1%  | 3.9%  | 6.6%  | 4.1%  | 4.1%       |
| 2021 | -     | -     | -     | -     | -     | -     | -     | -          |
| 2022 | -     | -     | -     | -     | -     | -     | -     | -          |
| Avg (Asia) - CN - CN + MY + CN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN +VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + VN + BN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - CN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN - TN<nl>
</details>

Source: Central banks, company data, UBS estimates

# Fee income/assets ratio

The table on the right shows the absolute change in fee income/assets ratio for the various markets over the past 5y/10y/15y. Over the past 10 years, c50% of Asia banking markets have seen a decline in fee income/assets ratio.

Markets where the fee income/assets ratios have declined most were China, followed by Thailand, and Hong Kong. On the other hand, markets that have seen an increase in the fee income/assets ratio were Vietnam and India.

Below charts shows the fee income/assets trend for the banking markets over the past 20 years. As of 2025, banking markets with the lowest fee income/assets ratio were Korea (0.14%), Japan (0.19%), and China (0.24%). Markets with the highest fee income/assets ratio were Indonesia (1.05%), the Philippines (0.61%), and India (0.60%).

Figure 58: Fee income/assets (chg) 

<table><tr><td>Fees/assets</td><td>5y</td><td>10y</td><td>15y</td></tr><tr><td>Japan</td><td>0.0%</td><td>0.0%</td><td>0.0%</td></tr><tr><td>Australia</td><td>-0.1%</td><td>-0.2%</td><td>-0.4%</td></tr><tr><td>China</td><td>-0.1%</td><td>-0.3%</td><td>-0.3%</td></tr><tr><td>Korea</td><td>0.0%</td><td>-0.1%</td><td>-0.1%</td></tr><tr><td>Taiwan</td><td>0.1%</td><td>0.0%</td><td>0.0%</td></tr><tr><td>Singapore</td><td>0.0%</td><td>0.0%</td><td>0.0%</td></tr><tr><td>Philippines</td><td>0.1%</td><td>0.0%</td><td>-0.1%</td></tr><tr><td>India</td><td>0.0%</td><td>0.1%</td><td>-0.1%</td></tr><tr><td>Thailand</td><td>-0.1%</td><td>-0.3%</td><td>-0.1%</td></tr><tr><td>Malaysia</td><td>0.0%</td><td>-0.1%</td><td>-0.2%</td></tr><tr><td>Hong Kong</td><td>-0.1%</td><td>-0.2%</td><td>-0.2%</td></tr><tr><td>Indonesia</td><td>0.0%</td><td>-0.1%</td><td>0.0%</td></tr><tr><td>Vietnam</td><td>0.1%</td><td>0.3%</td><td>0.4%</td></tr><tr><td>Avg (Asia)</td><td>0.0%</td><td>-0.1%</td><td>-0.1%</td></tr></table>

Source: Central banks, company data, UBS estimates

Figure 59: Fee income/assets ratio (DM)   
![](images/fcfce1cfe8297389aa149f82a41fcb5dc4eae44f3069f55010d96b2ee894422f.jpg)  
Source: Central banks, company data, UBS estimates

Figure 60: Fee income/assets ratio (EM)   
![](images/26041b7ebca4490e3706cdf27d30c65c3fac128ce2f53cedf67da97c1d507c40.jpg)  
Source: Central banks, company data, UBS estimates

# Total operating expenses/assets ratio

The table on the right shows the absolute change in total opex/ assets ratio for the various markets over the past 5y/10y/15y. Over the past 10 years, c50% of Asia banking markets have seen a decline in total opex/ assets ratio.

Markets where the total opex/ assets ratios have declined most were China, followed by Indonesia, and Vietnam. On the other hand, markets that have seen an increase in the total opex/ assets ratio were India, Malaysia, and Taiwan.

Below charts shows the total opex/assets trend for the banking markets over the past 20-25 years. As of 2025, banking markets with the lowest total opex/assets ratio were Hong Kong (0.53%), and China (0.58%), and Korea (0.72%). Markets with the highest total opex/assets ratio were the Philippines (2.48%), Indonesia (2.42%), and India (2.07%).

Figure 61: Total opex/assets (chg) 

<table><tr><td>Total opex/assets</td><td>Latest (2025)</td><td>5y</td><td>10y</td><td>15y</td></tr><tr><td>Philippines</td><td>2.48%</td><td>0.0%</td><td>0.0%</td><td>-0.8%</td></tr><tr><td>Indonesia</td><td>2.42%</td><td>-0.2%</td><td>-0.6%</td><td>-0.8%</td></tr><tr><td>India</td><td>2.07%</td><td>0.1%</td><td>0.3%</td><td>0.3%</td></tr><tr><td>Malaysia</td><td>1.96%</td><td>0.2%</td><td>0.2%</td><td>0.0%</td></tr><tr><td>Taiwan</td><td>1.70%</td><td>0.3%</td><td>0.1%</td><td>0.0%</td></tr><tr><td>Thailand</td><td>1.60%</td><td>-0.1%</td><td>-0.2%</td><td>-0.2%</td></tr><tr><td>Avg (Asia)</td><td>1.40%</td><td>0.0%</td><td>-0.2%</td><td>-0.3%</td></tr><tr><td>Vietnam</td><td>1.34%</td><td>-0.5%</td><td>-0.5%</td><td></td></tr><tr><td>Australia</td><td>1.06%</td><td>-0.1%</td><td>-0.1%</td><td>-0.5%</td></tr><tr><td>Singapore</td><td>1.03%</td><td>0.1%</td><td>0.0%</td><td>-0.1%</td></tr><tr><td>Japan</td><td>0.75%</td><td>0.0%</td><td>-0.1%</td><td>-0.3%</td></tr><tr><td>Korea</td><td>0.72%</td><td>-0.1%</td><td>-0.3%</td><td>-0.4%</td></tr><tr><td>China</td><td>0.58%</td><td>-0.2%</td><td>-0.6%</td><td>-0.6%</td></tr><tr><td>Hong Kong</td><td>0.53%</td><td>-0.1%</td><td>-0.2%</td><td>-0.3%</td></tr></table>

Source: Central banks, company data, UBS estimates

Figure 62: Total operating expenses/assets ratio (DM)   
![](images/4c10962d6d38605e50344162cc446f9da97d463e80210203479d3d3e037cb8eb.jpg)  
Source: Central banks, company data, UBS estimates

Figure 63: Total operating expenses/assets ratio (EM)   
![](images/b89e5aa4d624b21bb58e58c5b0126a0f2fa7d0234f4a0ca6f43d33bf72e2597d.jpg)  
Source: Central banks, company data, UBS estimates

# Staff costs/ assets ratio

The table on the right shows the absolute change in staff costs/ assets ratio for the various markets over the past 5y/10y/15y. Over the past 10 years, most banking markets have seen a decline in staff costs/ assets ratio.

Markets where the staff costs/ assets ratios have declined most were China, followed by Indonesia, and Vietnam. On the other hand, India was the only markets that saw an increase in the staff costs/ assets ratio.

Below charts shows the staff costs/ assets trend for the banking markets over the past 20-25 years. As of 2025, banking markets with the lowest staff costs/ assets ratio were China (0.29%), Japan (0.33%), and Hong Kong (0.34%). Markets with the highest staff costs/ assets ratio were Indonesia (1.36%), India (1.03%) and the Philippines (0.90%).

Figure 64: Staff costs/assets (chg) 

<table><tr><td>Staff costs/assets</td><td>Latest (2025)</td><td>5y</td><td>10y</td><td>15y</td></tr><tr><td>Indonesia</td><td>1.36%</td><td>-0.2%</td><td>-0.3%</td><td>-0.3%</td></tr><tr><td>India</td><td>1.03%</td><td>0.0%</td><td>0.1%</td><td>0.0%</td></tr><tr><td>Philippines</td><td>0.90%</td><td>0.0%</td><td>-0.1%</td><td>-0.3%</td></tr><tr><td>Malaysia</td><td>0.74%</td><td>0.0%</td><td>-0.1%</td><td>-0.2%</td></tr><tr><td>Vietnam</td><td>0.73%</td><td>-0.3%</td><td>-0.2%</td><td></td></tr><tr><td>Thailand</td><td>0.70%</td><td>-0.1%</td><td>-0.1%</td><td>-0.1%</td></tr><tr><td>Avg (Asia)</td><td>0.66%</td><td>0.0%</td><td>-0.1%</td><td>-0.1%</td></tr><tr><td>Singapore</td><td>0.64%</td><td>0.1%</td><td>0.0%</td><td>0.1%</td></tr><tr><td>Australia</td><td>0.61%</td><td>0.1%</td><td>0.0%</td><td>-0.1%</td></tr><tr><td>Taiwan</td><td>0.58%</td><td>0.0%</td><td>0.0%</td><td>0.0%</td></tr><tr><td>Korea</td><td>0.35%</td><td>-0.1%</td><td>-0.1%</td><td>-0.1%</td></tr><tr><td>Hong Kong</td><td>0.34%</td><td>0.0%</td><td>0.0%</td><td>-0.1%</td></tr><tr><td>Japan</td><td>0.33%</td><td>0.0%</td><td>0.0%</td><td>0.0%</td></tr><tr><td>China</td><td>0.29%</td><td>-0.1%</td><td>-0.2%</td><td>-0.3%</td></tr></table>

Source: Central banks, Company data, UBS estimates

Figure 65: Staff costs/assets ratio (DM)   
![](images/5187f4a0c9f7faaef4590daeeccd0c004a30f3105b6539cfd1f8f624f13f2ccd.jpg)

<details>
<summary>line</summary>

| Year | HK    | KR    | JP    | AU    | TW    | SG    | Average (Asia) |
|------|-------|-------|-------|-------|-------|-------|----------------|
| 2002 | 0.55  | 0.52  | 0.38  | 1.00  | 0.68  | 0.55  | 0.85           |
| 2003 | 0.53  | 0.54  | 0.20  | 0.98  | 0.67  | 0.54  | 0.84           |
| 2004 | 0.51  | 0.56  | 0.21  | 0.96  | 0.65  | 0.53  | 0.83           |
| 2005 | 0.52  | 0.58  | 0.22  | 0.94  | 0.63  | 0.52  | 0.82           |
| 2006 | 0.54  | 0.60  | 0.23  | 0.92  | 0.61  | 0.51  | 0.81           |
| 2007 | 0.56  | 0.62  | 0.24  | 0.90  | 0.59  | 0.50  | 0.80           |
| 2008 | 0.58  | 0.64  | 0.25  | 0.88  | 0.57  | 0.49  | 0.79           |
| 2009 | 0.60  | 0.66  | 0.26  | 0.86  | 0.55  | 0.48  | 0.78           |
| 2010 | 0.62  | 0.68  | 0.27  | 0.84  | 0.53  | 0.47  | 0.77           |
| 2011 | 0.64  | 0.70  | 0.28  | 0.82  | 0.51  | 0.46  | 0.76           |
| 2012 | 0.66  | 0.72  | 0.29  | 0.80  | 0.49  | 0.45  | 0.75           |
| 2013 | 0.68  | 0.74  | 0.30  | 0.78  | 0.47  | 0.44  | 0.74           |
| 2014 | 0.70  | 0.76  | 0.31  | 0.76  | 0.45  | 0.43  | 0.73           |
| 2015 | 0.72  | 0.78  | 0.32  | 0.74  | 0.43  | 0.42  | 0.72           |
| 2016 | 0.74  | 0.80  | 0.33  | 0.72  | 0.41  | 0.41  | 0.71           |
| 2017 | 0.76  | 0.82  | 0.34  | 0.70  | 0.39  | 0.40  | 0.70           |
| 2018 | 0.78  | 0.84  | 0.35  | 0.68  | 0.37  | 0.39  | 0.69           |
| 2019 | 0.80  | 0.86   | -     | -     | -     | -     | -              |
| 2020 | -     | -     | -     | -     | -     | -     | -              |
| 2021 | -     | -     | -     | -     | -     | -     | -              |
| 2022 | -     | -     | -     | -     | -     | -     | -              |
| 2023 | -     | -     | -     | -     | -     | -     | -              |
| 2024e| -     | -     | -     | -     | -     | -     | -              |
| Total (Year) from ~25 to ~35; Average (Asia) from ~15% to ~1% for all regions; labeled as Asia; SG; AU; TW; KR; JP; HK; JP; Average (Asia) from ~1% to ~-%; all values are estimated based on the provided code.
</details>

Source: Central banks, company data, UBS estimates

Figure 66: Staff costs/assets ratio (EM)   
![](images/648ac5527e18af372829dbcfbf7506cb09e6f0df336fc22720decf028c8716ac.jpg)  
Source: Central banks, company data, UBS estimates

# Other opex/assets ratio

The table on the right shows the absolute change in other opex/assets ratio for the various markets over the past 5y/10y/15y. Over the past 10 years, c50% of banking markets have seen a decline in other opex/assets ratio negatively impacted by lower policy rates.

Markets where the other opex/ assets ratios have declined most were China, Indonesia, and Vietnam. On the other hand, markets that have seen an increase in the other opex/ assets ratio were Malaysia, India, and Taiwan.

Figure 67: Other opex/assets (chg) 

<table><tr><td>Other opex/assets</td><td>Latest (2025)</td><td>5y</td><td>10y</td><td>15y</td></tr><tr><td>Philippines</td><td>1.58%</td><td>0.0%</td><td>0.0%</td><td>-0.5%</td></tr><tr><td>Malaysia</td><td>1.23%</td><td>0.2%</td><td>0.3%</td><td>0.2%</td></tr><tr><td>Taiwan</td><td>1.12%</td><td>0.3%</td><td>0.1%</td><td>0.0%</td></tr><tr><td>Indonesia</td><td>1.06%</td><td>0.0%</td><td>-0.3%</td><td>-0.5%</td></tr><tr><td>India</td><td>1.04%</td><td>0.0%</td><td>0.2%</td><td>0.2%</td></tr><tr><td>Thailand</td><td>0.90%</td><td>0.0%</td><td>0.0%</td><td>-0.1%</td></tr><tr><td>Avg (Asia)</td><td>0.74%</td><td>0.0%</td><td>-0.1%</td><td>-0.2%</td></tr><tr><td>Vietnam</td><td>0.61%</td><td>-0.2%</td><td>-0.3%</td><td></td></tr><tr><td>Australia</td><td>0.45%</td><td>-0.1%</td><td>-0.1%</td><td>-0.4%</td></tr><tr><td>Japan</td><td>0.42%</td><td>0.0%</td><td>-0.1%</td><td>-0.3%</td></tr><tr><td>Singapore</td><td>0.39%</td><td>0.0%</td><td>-0.1%</td><td>-0.1%</td></tr><tr><td>Korea</td><td>0.37%</td><td>0.0%</td><td>-0.2%</td><td>-0.3%</td></tr><tr><td>China</td><td>0.29%</td><td>-0.1%</td><td>-0.4%</td><td>-0.3%</td></tr><tr><td>Hong Kong</td><td>0.20%</td><td>-0.1%</td><td>-0.1%</td><td>-0.2%</td></tr></table>

Below charts shows the other opex/assets trend for the banking markets over the past 20-25 years. As of 2025, banking markets with the lowest other opex/assets were Hong Kong (0.20%), China (0.29%), and Korea (0.37%). Markets with the highest other opex/assets were the Philippines (1.58%), Malaysia (1.23%), and Taiwan (1.12%).

Source: Central banks, company data, UBS estimates

Figure 68: Other opex/assets ratio (DM)   
![](images/ce6a77a9fb5c92bf8594a0330f3a62bfc9ed7ff239174a54a4f0685a95e45dac.jpg)

<details>
<summary>line</summary>

| Year | HK    | KR    | JP    | AU    | TW    | SG    | Asia  |
|------|-------|-------|-------|-------|-------|-------|-------|
| 2002 | 0.4%  | 0.7%  | 1.4%  | 0.7%  | 1.6%  | 0.6%  | 1.0%  |
| 2003 | 0.4%  | 0.7%  | 0.5%  | 0.7%  | 1.7%  | 0.6%  | 1.0%  |
| 2004 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.7%  | 0.6%  | 1.0%  |
| 2005 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.6%  | 0.6%  | 1.0%  |
| 2006 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.5%  | 0.6%  | 1.0%  |
| 2007 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.4%  | 0.6%  | 1.0%  |
| 2008 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.3%  | 0.6%  | 1.0%  |
| 2009 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.2%  | 0.6%  | 1.0%  |
| 2010 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.2%  | 0.6%  | 1.0%  |
| 2011 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.2%  | 0.6%  | 1.0%  |
| 2012 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.2%  | 0.6%  | 1.0%  |
| 2013 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.2%  | 0.6%  | 1.0%  |
| 2014 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.2%  | 0.6%  | 1.0%  |
| 2015 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.2%  | 0.6%  | 1.0%  |
| 2016 | 0.4%  | 0.7%  | 0.5%  | 1.1%  | 1.2%  | 0.6%  | 1.0%   |
| 2017 | 0.4%   | 0.7%   | 0.5%   | 1.1%   | 1.2%   | 0.6%   | 1.0%   |
| 2018 | 0.4%   | 0.7%   | 0.5%   | 1.1%   | 1.2%   | 0.6%   | 1.0%   |
| 2019 | 0.4%   | 0.7%   | 0.5%   | 1.1%   | 1.2%   | 0.6%   | -     |
| 2020 | -     | -     | -     | -     | -     | -     | -     |
| 2021 | -     | -     | -     | -     | -     | -     | -     |
| 2022 | -     | -     | -     | -     | -     | -     | -     |
| 2023 | -     | -     | -     | -     | -     | -     | -     |
...
Figure 69: Other opex/assets ratio (EM)   
![](images/2e112429ac11bc4b459c59614bf4db784c271c2d5a424e9235f17795eacba347.jpg)  
Source: Central banks, company data, UBS estimates

# Staff costs/total opex ratio

The table on the right shows the absolute change in staff costs/total opex ratio for the various markets over the past 5y/10y/15y. Over the past 10 years, most banking markets have seen an increase in staff costs/total opex ratio.

Markets where the staff costs/total opex ratios have declined the most were India, Thailand, and Philippines. On the other hand, markets that have seen the largest increase in the staff costs/total opex ratio were Hong Kong, Australia, and China.

Below charts shows the staff costs/total opex trend for the banking markets over the past 20-25 years. As of 2025, banking markets with the lowest staff costs/total opex ratio were Taiwan (34%), Philippines (36%), and Thailand (44%). Markets with the highest staff costs/total opex ratio were Hong Kong (63%), Singapore (62%), and Australia (57%).

Figure 70: Staff costs/total opex (chg) 

<table><tr><td>Staff opex/total opex</td><td>Latest (2025)</td><td>5y</td><td>10y</td><td>15y</td></tr><tr><td>Hong Kong</td><td>63%</td><td>6%</td><td>8%</td><td>9%</td></tr><tr><td>Singapore</td><td>62%</td><td>2%</td><td>4%</td><td>9%</td></tr><tr><td>Australia</td><td>57%</td><td>10%</td><td>7%</td><td>11%</td></tr><tr><td>Vietnam</td><td>54%</td><td>-2%</td><td>3%</td><td></td></tr><tr><td>Malaysia</td><td>52%</td><td>1%</td><td>2%</td><td>3%</td></tr><tr><td>India</td><td>50%</td><td>-1%</td><td>-5%</td><td>-6%</td></tr><tr><td>China</td><td>50%</td><td>-1%</td><td>5%</td><td>0%</td></tr><tr><td>Avg (Asia)</td><td>49%</td><td>1%</td><td>2%</td><td>4%</td></tr><tr><td>Korea</td><td>48%</td><td>-2%</td><td>1%</td><td>7%</td></tr><tr><td>Indonesia</td><td>45%</td><td>0%</td><td>-1%</td><td>-1%</td></tr><tr><td>Japan</td><td>44%</td><td>2%</td><td>3%</td><td>18%</td></tr><tr><td>Thailand</td><td>44%</td><td>-2%</td><td>-3%</td><td>-3%</td></tr><tr><td>Philippines</td><td>36%</td><td>-1%</td><td>-2%</td><td>0%</td></tr><tr><td>Taiwan</td><td>34%</td><td>-5%</td><td>-2%</td><td>-4%</td></tr></table>

Source: Central banks, company data, UBS estimates

Figure 71: Staff costs/total opex ratio (DM)   
![](images/dec8366c0c794c45b241af660563f4bdb5c3f0224878d438cde0845e894c8ba3.jpg)

<details>
<summary>line</summary>

| Year | HK   | SG   | AU   | KR   | Asia | JP   | TW   |
|------|------|------|------|------|------|------|------|
| 2002 | 56%  | 56%  | 56%  | 34%  | 35%  | 28%  | 45%  |
| 2003 | 57%  | 57%  | 57%  | 34%  | 34%  | 26%  | 45%  |
| 2004 | 57%  | 57%  | 57%  | 34%  | 34%  | 24%  | 45%  |
| 2005 | 57%  | 57%  | 57%  | 34%  | 34%  | 22%  | 45%  |
| 2006 | 57%  | 57%  | 57%  | 34%  | 34%  | 20%  | 45%  |
| 2007 | 57%  | 57%  | 57%  | 34%  | 34%  | 18%  | 45%  |
| 2008 | 57%  | 57%  | 57%  | 34%  | 34%  | 16%  | 45%  |
| 2009 | 57%  | 57%  | 57%  | 34%  | 34%  | 18%  | 45%  |
| 2010 | 57%  | 57%  | 57%  | 34%  | 34%  | 20%  | 45%  |
| 2011 | 57%  | 57%  | 57%  | 34%  | 34%  | 22%  | 45%  |
| 2012 | 57%  | 57%  | 57%  | 34%  | 34%  | 24%  | 45%  |
| 2013 | 57%  | 57%  | 57%  | 34%  | 34%  | 26%  | 45%  |
| 2014 | 57%  | 57%  | 57%  | 34%  | 34%  | 28%  | 45%  |
| 2015 | 57%  | 57%  | 57%  | 34%  | 34%  | 30%   | 45%   |
| 2016 | 57%  | 57%  | 57%  | 34%  | 34%   | 32%   | 45%   |
| 2017 | 57%  | 57%  | 57%  | 34%   | 34%   | 34%   | -    |
| 2018 | -    | -    | -    | -    | -    | -    | -    |
| 2019 | -    | -    | -    | -    | -    | -    | -    |
| 2020 | -    | -    | -    | -    | -    | -    | -    |
| 2021 | -    | -    | -    | -    | -    | -    | -    |
...
| AU   | -    | -    | -    | -    | -    | -    | -    |
| KR   | -    | -    | -    | -    | -    | -    | -    |
| Asia (Average) between HK and SG are shown as lines on the right. The values for all other series are explicitly labeled with 'A', 'B', 'C', etc., but they are estimated based on the legend. The data is presented in a table format.
</details>

Source: Central banks, company data, UBS estimates

Figure 72: Staff costs/total opex ratio (EM)   
![](images/a4d474d50cf1080f19d04df8b5eca4f71e0a48732e3f9d80098777f3bed0e637.jpg)  
Source: Central banks, company data, UBS estimates

# Total opex/revenue ratio

The table on the right shows the absolute change in total opex/revenue ratio for the various markets over the past 5y/10y/15y. Over the past 10 years, most banking markets have seen a decline in total opex/revenue ratio.

Markets where the total opex/revenue ratios have declined most were Vietnam, Korea, and Philippines. On the other hand, markets that have seen the largest increase in the total opex/revenue ratio were Japan, Australia, and India.

Below charts shows the total opex/revenue trend for the banking markets over the past 20-25 years. As of 2025, banking markets with the lowest total opex/revenue ratio were Hong Kong (29%), Vietnam (30%), and China (38%). Markets with the highest total opex/revenue ratio were Japan (63%), Taiwan (59%), and Australia (53%).

Figure 73: Total opex/revenue (chg) 

<table><tr><td>Total opex/revenue</td><td>Latest (2025)</td><td>5y</td><td>10y</td><td>15y</td></tr><tr><td>Japan</td><td>63%</td><td>-4%</td><td>4%</td><td>4%</td></tr><tr><td>Taiwan</td><td>59%</td><td>1%</td><td>-3%</td><td>6%</td></tr><tr><td>Australia</td><td>53%</td><td>-4%</td><td>4%</td><td>-2%</td></tr><tr><td>Philippines</td><td>53%</td><td>0%</td><td>-10%</td><td>-8%</td></tr><tr><td>Indonesia</td><td>50%</td><td>-14%</td><td>-8%</td><td>-6%</td></tr><tr><td>Korea</td><td>49%</td><td>-4%</td><td>-11%</td><td>3%</td></tr><tr><td>India</td><td>48%</td><td>0%</td><td>1%</td><td>3%</td></tr><tr><td>Malaysia</td><td>47%</td><td>3%</td><td>0%</td><td>2%</td></tr><tr><td>Avg (Asia)</td><td>46%</td><td>-3%</td><td>-4%</td><td>-3%</td></tr><tr><td>Thailand</td><td>43%</td><td>-4%</td><td>-6%</td><td>-11%</td></tr><tr><td>Singapore</td><td>41%</td><td>-2%</td><td>-3%</td><td>1%</td></tr><tr><td>China</td><td>38%</td><td>6%</td><td>0%</td><td>-2%</td></tr><tr><td>Vietnam</td><td>30%</td><td>-4%</td><td>-14%</td><td></td></tr><tr><td>Hong Kong</td><td>29%</td><td>-7%</td><td>-9%</td><td>-14%</td></tr></table>

Source: Central banks, company data, UBS estimates

Figure 74: Total opex/revenue ratio (DM)   
![](images/caf379a7153e404a3e6671d44fcff34ed712682d0915da3d53a0bbc3a81c1fe2.jpg)
...
| Year | HK   | KR   | JP   | AU   | TW   | SG   | Average (Asia) |
|------|------|------|------|------|------|------|----------------|
| 2002 | 36%  | 45%  | 50%  | 50%  | 50%  | 40%  | 50%            |
| 2003 | 37%  | 44%  | 51%  | 51%  | 51%  | 40%  | 51%            |
| 2004 | 38%  | 43%  | 52%  | 52%  | 52%  | 40%  | 52%            |
| 2005 | 39%  | 42%  | 70%  | 53%  | 53%  | 40%  | 53%            |
| 2006 | 40%  | 41%  | 45%  | 54%  | 54%  | 40%  | 54%            |
| 2007 | 41%  | 40%  | 46%  | 55%  | 55%  | 40%  | 55%            |
| 2008 | 42%  | 39%  | 57%  | 56%  | 56%  | 40%  | 56%            |
| 2009 | 43%  | 38%  | 58%  | 57%  | 57%  | 40%  | 57%            |
| 2010 | 44%  | 37%  | 59%  | 58%  | 58%  | 40%  | 58%            |
| 2011 | 45%  | 36%  | 60%  | 59%  | 59%  | 40%  | 59%            |
| 2012 | 46%  | 35%  | 61%  | 60%  | 60%  | 40%  | 60%            |
| 2013 | 47%  | 34%  | 62%  | 61%  | 61%  | 40%  | 61%            |
| 2014 | 48%  | 33%  | 63%  | 62%  | 62%  | 40%  | 62%            |
| 2015 | 49%  | 32%  | 64%  | 63%  | 63%  | 40%  | 63%            |
| 2016 | 50%  | 31%  | 65%  | 64%  | 64%  | 40%  | 64%            |
| 2017 | 51%  | 30%  | 66%  | 65%  | 65%  | 40%  | 65%            |
| 2018 | 52%  | 29%  | 67%  | 66%  | 66%  | 40%  | 66%            |
| 2019 | 53%  | 28%  | -    | -    | -    | -    | -              |
| 2020 | -    | -    | -    | -    | -    | -    | -              |
| 2021 | -    | -    | -    | -    | -    | -    | -              |
| 2022 | -    | -    | -    | -    | -    | -    | -              |
...
| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **HK*          |
| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **HK*          |
| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **H*           |
| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **H*           |
| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **H*           |
| **HK**| **HK**| **HK**| **HK**| **HK**| **HK**| **H*   | **H*           |
| **HK**| **HK**| **HK**| **HK**| **HK**| **H*   | **H*   | **H*           |
| **HK**| **HK**| **HK**| **HK**| **H*   | **H*   | **H*   | **H*           |
| **HK**| **HK**| **HK**| **H*   | **H*   | **H*   | **H*   | **H*           |
| **HK**| **HK**| **HK**| **H*   | **H*   | **H*   | **H*   | **H*           |
| **HK**| **HK**| **HK**| **H*   | **H*   | **H*   | **H*   | **H*           |
| *** (Average)****; Y-axis values are estimated based on the chart's actual values from the code. The data is presented in the table format as follows: *K = K, *L = L, *N = N, *O = O, *P = P, *Q = Q, *R = R, *S = S, *T = T, *U = U, *V = V, *W = W, *X = X, *Y = Z. The chart type is a single series of bars. Values for each series are estimated based on the original code.
</details>

Source: Central banks, company data, UBS estimates

Figure 75: Total opex/revenue ratio (EM)   
![](images/c0b4d819ec8a2909c67bd62d7943e61883a93f74a04ed420bf402bf2f651fb77.jpg)  
Source: Central banks, company data, UBS estimates

# Staff costs/revenue ratio

The table on the right shows the absolute change in staff costs/revenue ratio for the various markets over the past 5y/10y/15y. Over the past 10 years, most banking markets have seen a decline in staff costs/revenue ratio.

Markets where the staff costs/revenue ratios have declined most were Philippines, Vietnam, and Korea. On the other hand, markets that have seen the largest increase in the staff costs/revenue ratio were Australia, China, and Japan.

Below charts shows the staff costs/revenue trend for the banking markets over the past 20-25 years. As of 2025, banking markets with the lowest staff costs/revenue ratio were Vietnam (16%), Hong Kong (18%), and Thailand (19%). Markets with the highest staff costs/revenue ratio were Australia (31%), Japan (28%), and Singapore (26%).

Figure 76: Staff costs/revenue (chg) 

<table><tr><td>Staff opex/revenue</td><td>Latest (2025)</td><td>5y</td><td>10y</td><td>15y</td></tr><tr><td>Australia</td><td>31%</td><td>3%</td><td>6%</td><td>5%</td></tr><tr><td>Japan</td><td>28%</td><td>0%</td><td>3%</td><td>13%</td></tr><tr><td>Singapore</td><td>26%</td><td>0%</td><td>0%</td><td>4%</td></tr><tr><td>India</td><td>24%</td><td>-1%</td><td>-2%</td><td>-1%</td></tr><tr><td>Korea</td><td>23%</td><td>-3%</td><td>-5%</td><td>5%</td></tr><tr><td>Malaysia</td><td>22%</td><td>0%</td><td>-1%</td><td>0%</td></tr><tr><td>Avg (Asia)</td><td>22%</td><td>-1%</td><td>-1%</td><td>0%</td></tr><tr><td>Taiwan</td><td>20%</td><td>-3%</td><td>-2%</td><td>-3%</td></tr><tr><td>Philippines</td><td>19%</td><td>-1%</td><td>-5%</td><td>-3%</td></tr><tr><td>China</td><td>19%</td><td>3%</td><td>2%</td><td>-1%</td></tr><tr><td>Indonesia</td><td>19%</td><td>-3%</td><td>-2%</td><td>-3%</td></tr><tr><td>Thailand</td><td>19%</td><td>-3%</td><td>-4%</td><td>-6%</td></tr><tr><td>Hong Kong</td><td>18%</td><td>-2%</td><td>-2%</td><td>-5%</td></tr><tr><td>Vietnam</td><td>16%</td><td>-3%</td><td>-6%</td><td></td></tr></table>

Source: Central banks, company data, UBS estimates

Figure 77: Staff costs/revenue ratio (DM)   
![](images/96c13212f64f164010e02989d8e185dce3a81eea42a632851cc9d9ea1df892fc.jpg)

<details>
<summary>line</summary>

| Year | HK   | KR   | JP   | AU   | SG   | Asia | TW   | Average (Asia) |
|------|------|------|------|------|------|------|------|----------------|
| 2002 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2003 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2004 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2005 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2006 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2007 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2008 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2009 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2010 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2011 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2012 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2013 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2014 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2015 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2016 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2017 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2018 | 20%  | 18%  | 14%  | 30%  | 20%  | 14%  | 14%  | 22%            |
| 2019 | 20%  | 18%  | -    | -    | -    | -    | -    | -              |
| 2020 | -    | -    | -    | -    | -    | -    | -    | -              |
| 2021 | -    | -    | -    | -    | -    | -    | -    | -              |
| ... (repeated values shown as 'Average (Asia)') are estimated based on the provided code. The actual values for 'AU' and 'JP' are not explicitly labeled in the chart but are inferred from the original data points. The 'HK' series is also included in the chart but is not part of the original data series. The 'Average (Asia)' series is calculated as: - for all years. The chart is created using a multi-axes plot with color-coded lines representing different financial metrics. The y-axis is labeled with percentages and units.
</details>

Source: Central banks, company data, UBS estimates

Figure 78: Staff costs/revenue ratio (EM)   
![](images/4152276e283dcefc913015d9ad10edde410637fe12646f58adeff5d5e764f011.jpg)  
Source: Central banks, company data, UBS estimates

Figure 79: Opex changes in the past 10 years across Asian banks (bubble size indicates the current level)   
![](images/47b2de9c85f81dde780e057dad33b891470cf506a5550bfc6dee163118e2da52.jpg)

<details>
<summary>bubble</summary>

| Country     | Total opex/ assets (10y change) | Total opex/revenue (10y change) |
| ----------- | ------------------------------- | ------------------------------- |
| Australia   | -0.1                            | 4%                              |
| Japan       | -0.1                            | 4%                              |
| China       | -0.6                            | -2%                             |
...
Source: UBS estimates. Note: Bubble sizes are scaled to banks' respective total opex/ assets ratios as of 2025.

Figure 80: How has opex/revenue and opex/assets ratio changed over the past 10y (DM)?   
![](images/e09caf7d3ad2506ff9b0518b0a04332493a734f4fcf80f558e0372f251c1028f.jpg)

<details>
<summary>line</summary>

| Category | Total opex/assets (2015-25) | Total opex/revenue (2015-25) |
| -------- | ---------------------------- | ----------------------------- |
| HK       | 0.60%                        | 40%                           |
| HK       | 0.70%                        | 35%                           |
| HK       | 0.80%                        | 35%                           |
...
| TW       | 7.00%                        | 60%                           |
| TW       | -                            | -                             |
The chart displays a line graph with markers for each category (HK, KR, JP, AU, TG, TW) plotted against the x-axis labeled 'Total opex/assets (2015-25)' and y-axis labeled 'Total opex/revenue (2015-25)'. The data series are represented by colored lines with distinct markers for each category.
</details>

Source: Central banks, company data, UBS estimates

Figure 81: How has opex/revenue and opex/assets ratio changed over the past 10y (EM)?   
![](images/9291376bd14d249730dd1e4db544413b920cbcf085bd0aff1f646e7d0854a93f.jpg)
...
The main risk for Asian banks is inflation in countries with current account deficits and low FX reserves as higher interest rates would hurt margins for banks with high LDRs and hurt credit quality. Also, asymmetric increases in deposit rates and fewer rises in lending rates could hurt current high loan margins. Banks with equity/asset ratios below 5% and ROAs below 1% are vulnerable to economic and regulatory risk, especially if still growing loans by more than 15% per annum, as they will encounter capital shortages.
...
UBS AG, Singapore Branch: Aakash Rawat, CFA, Benjamin Tan.
