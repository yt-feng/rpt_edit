...
| Category | HSBC (%) | UOB (%) | OCBC (%) | RHB (%) | AMMB (%) | CIMB (%) | Public Bank (%) | Mayb

[中间内容因长度限制已省略]

essional Client. A distribution of the different MS Research ratings or recommendations, in percentage terms for Investments in each sector covered, is available upon request from your sales representative.
