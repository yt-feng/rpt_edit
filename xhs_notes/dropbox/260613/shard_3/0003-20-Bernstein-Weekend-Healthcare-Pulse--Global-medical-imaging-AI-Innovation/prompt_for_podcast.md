...
![](images/d79f0fe28ae8e5e73d53cad77788b07a5c7f9553056bd1b01f8aa16525038a76.jpg)
...
```mermaid
graph TD
  A["Prioritisation\nKnow which cases to prioritise to enable timely clinical decision-making"] --> B["Contextual Information\nUnderstand and see suspected findings from available data sources"]
  B --> C["Follow-Up\nTrack progress to improve outcomes throughout the patient life cycle*"]
  C --> D["Care Coordination\nThe single-platform solution enables collective action across service lines immediately"]
...
![](images/31cc37bcf3bef6ceeb21b79afcd2fb4fe89b0c597cca488ab39131b14b9ad6e8.jpg)
