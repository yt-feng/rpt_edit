...
Model projection: 6.7853 versus 6.8047 previous (194 pips lower; 49 pips higher from the previous official spot close).

Model projection with counter-cyclical factor: 6.7934 (113 pips lower from previous fix).
