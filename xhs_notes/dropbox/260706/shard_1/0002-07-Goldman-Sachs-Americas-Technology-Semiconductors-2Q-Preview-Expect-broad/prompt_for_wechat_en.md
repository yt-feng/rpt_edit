...
We are Sell rated on ARM. Our 12-month price target of \$150 is based on 50X our normalized EPS estimate of \$3.00. Key upside risks: (1) stronger-than-expected Datacenter ramp; (2) better-than-expected operating leverage; (3) better-than-expected execution on chip manufacturing.

## Cadence (CDNS, Buy): Expect increased 2026 guidance as agentic tools drive monetization

Key stock takeaways: We expect investors to focus on management's commentary on EDA and IP momentum, as well as the path to agentic AI monetization. We think positioning has turned more positive in recent months given rising momentum across the sector, with the debate around Cadence increasingly shifting toward AI monetization. We continue to believe that Cadence (and Synopsys) are uniquely insulated against AI disruption and poised for growth across multiple vectors in the semi industry, and we see tailwinds from the diffusion of custom chip design across a broader range of customers. We expect investors to focus on: (1) end market momentum across Core EDA, IP, and System Design & Analysis; (2) agentic tool adoption, pricing and size of upcoming 3Q revenue contribution; (3) the current pace of ASIC design starts across the industry; (4) Hexagon D&E acquisition integration.

Setup heading into the print: We believe investor expectations have risen in recent months, driven by growing optimism across the sector.

Our view on key metrics and our estimates: We expect Cadence to deliver \~1% revenue upside to Street in the quarter and raise guidance to \~17%-19% YoY revenue growth for 2026 (vs. \~15.5%-17.5% YoY previously) given upside across the core EDA and hardware business, along with \~10%-12% EPS growth. We expect this growth to be driven by accelerating high-teens growth in IP, low-double digit growth in core EDA, and \~32% SD&A growth (\~13% ex-Hexagon). For 2026/27, our EPS estimates are \~1% above in 2026 and \~3% above Street consensus in 2027 as we expect near-term EPS dilution from Hexagon to be offset by an acceleration in the IP and Core EDA business and incremental AI revenues over time.

Items on the call that could move the stock: (1) EDA and IP momentum: We expect Cadence to provide incremental detail on its Core EDA and IP business; (2) AI adoption rates: We expect management to note whether it has seen an increase in adoption of its AI offerings and the associated customer feedback; (3) ASIC design starts: We expect a qualitative update on the pace of ASIC design starts across the industry.

Coming out of the print: We expect the stock debate to continue around the sustainability of non-traditional customer demand, the convergence of physical and digital simulation, and customer exposure/share dynamics.

Exhibit 3: CDNS - Summary of GS vs. Street estimates

<table><tr><td rowspan="2">Financials ($mn, except EPS)</td><td colspan="3">2Q26E</td><td colspan="3">3Q26E<
