...
The PBOC held its Q2 MPC meeting on July 4th and the statement was released on July 8th. Compared with the Q1 MPC meeting minutes, the central bank appears to have acknowledged softer economic momentum, especially weak domestic demand and more bifurcated growth. That said, the statement points to limited appetite for near-term broad-based monetary easing, and we maintain our baseline of no policy rate or RRR cuts in 2026. In our view, near-term policy support is more likely to come through faster fiscal policy implementation, ample interbank liquidity and targeted credit easing. Separately, Governor Pan Gongsheng announced a package of measures to support Hong Kong's CNH market. In our view, the package aims to improve CNH liquidity and strengthen the market infrastructure, which should help provide more stable and lower-cost CNH funding over time, while improving the market depth of CNH fixed income and FX products.
