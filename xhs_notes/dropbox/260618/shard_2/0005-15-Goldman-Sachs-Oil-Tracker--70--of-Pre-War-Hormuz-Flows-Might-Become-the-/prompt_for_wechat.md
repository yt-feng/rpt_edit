...
Latest observation is today, and data is unsmoothed. "Crude" categories (landed and on water) include both crude and condensate. Month-over-month changes are calculated by taking the end-of-month level (or latest re
