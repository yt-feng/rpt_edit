...
## Key takeaways from the management call; lifting PT on strong outlook for DC and overseas power orders

Qingdao TGOOD Electric has outperformed the index by $>20\%$ YTD (TGOOD +28% vs. SZCOMP +5%) as investors increasingly recognize its rising overseas exposure in prefabricated substations and the growth potential of its data-center offering. The recent management call reinforces our positive view: China data-center orders YTD have already exceeded the FY25 level and management has guided to a doubling of China DC orders this year; Middle East prefabricated substation orders could more than double this year with management guiding to $\sim50\%$ market share, alongside rising orders from Europe and Australia; and the collaboration with Eaton (ETN US, NR) could help TGOOD expand further overseas, while its newly developed high-voltage AC-to-low-voltage DC solutions have attracted inquiries from data-center customers across regions, including the US. At <20x 1-year forward P/E, we think the valuation remains attractive, and we reiterate our OW rating.

\- YTD data center orders already above FY25: The company has secured Rmb 400–500mn of new data center orders in China YTD, exceeding FY25's level. It supplied prefabricated substations to two 100MW Tencent data centers. Management guides to >Rmb 800mn of data center orders this year, with \~50% market share in HV prefabricated substations for data centers, supported by demand as large sites ( $\geq$ 50MW) increasingly require 110kV (or above) substations. TGOOD also announced a strategic cooperation with Eaton (ETN US) to jointly develop prefabricated data-center power solutions; management sees synergies given TGOOD's strength in 110kV+ products and Eaton's international footprint, which could help TGOOD expand overseas.

\- Middle East orders may double this year: Management expects Saudi Energy to tender new prefabricated substation orders in 3Q, with a total tender value of Rmb 4–6bn. Assuming \~50% share, we estimate TGOOD's contract value would be >2x FY25 (vs. \~Rmb 1bn). Management expects more meaningful revenue recognition in FY27. Beyond the Middle East, the company targets to double new orders from other markets YoY, citing progress in Europe, Australia, the Middle East, and Central Asia.
...
\- Earnings and PT changes: We lift 27-28E earnings by $3 - 4\%$ to reflect stronger-than-expected order wins. We roll forward our PT from Dec 26 to Jun 27 and raise it from Rmb 35 to Rmb 40.

## Overweight

300001.SZ, 300001 CH  
Price (08 Jul 26):Rmb32.93

▲Price Target (Jun-27):Rmb40.00  
Prior (Dec-26):Rmb35.00
...
Price Performance  
![](images/9dcd0efe315c87f6d0a677fa79e0a1e290c6286fc149d7600f43c78db1aed01d.jpg)
...
TGOOD is a leading global manufacturer of prefabricated substations and operator of China's largest EV charging network ( $\sim 20\%+$ market share). We have an OW rating on the name as we see multiple under-appreciated growth drivers: (1) expanding overseas exposure and domestic tailwinds from grid investment for electrical equipment; (2) the EV charging business has pivoted to an asset-light model with sustained attributable profit growth; and (3) data center contracts and the development of HVPAC/SST technology offer growth optionality yet to be priced in. Trading at a discount to peers with a $>20\%$ earnings CAGR from 2025-28E, the valuation is attractive, in our view.

## Valuation

Our Jul-27 PT of Rmb 40/sh is based on a sum-of-the-parts methodology. We apply a 20x FY27-28E P/E to the electrical equipment segment by referencing TGOOD's peers and a 20x P/E to the EV charging segment given an improving earnings outlook.

Performance Drivers  
![](images/a7e3cc5de517ade3b2ba865fdd2fe10185fe97a753660edf40792cc064540ce5.jpg)
...
Qingdao TGOOD Electric (Overweight; Price Target: Rmb40.00)

## Investment Thesis

TGOOD is a leading global manufacturer of prefabricated substations and operator of China's largest EV charging network ( $\sim 20\%+$ market share). We have an OW rating on the name as we see multiple under-appreciated growth drivers: (1) expanding overseas exposure and domestic tailwinds from grid investment for electrical equipment; (2) the EV charging business has pivoted to an asset-light model with sustained attributable profit growth; and (3) data center contracts and the development of HVPAC/SST technology offer growth optionality yet to be priced in. Trading at a discount to peers with a $>20\%$ earnings CAGR from 25-28E, the valuation is attractive, in our view.

## Valuation

Our Jun-27 PT of Rmb 40/sh is based on a sum-of-the-parts methodology. We apply a 20x FY27-28E P/E to the electrical equipment segment by referencing TGOOD's peers and a 20x P/E to the EV charging segment given an improving earnings outlook.
