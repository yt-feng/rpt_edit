...
On monetization, Dexterity operates a subscription model that it views as more lucrative than token consumption, while Dyna Robotics expects the industry to converge on a token-to-output model over the long term. The panel agreed that physical AI models still need to reach the sophis
