...
# 2026 ASCO: Highlights from covered companies

What we suggest to look at for Akeso, BeOne, CSPC, Hengrui, apart from Kelun Bio and Innovent

The 2026 American Society of Clinical Oncology (ASCO) annual meeting will take place in Chicago during 29 May to 2 Jun (local time).

This year in total 94 research studies conducted in China will be presented orally, among which 12 will be included in late-breaking abstracts (LBA), both a historical high, reflecting the increasing weight of China innovation in oncology drug development.

Besides Kelun Bio (6990 HK, Buy) and Innovent (1801 HK, Buy), on which we have published reports earlier (see our reports: Kelun Biotech (6990 HK) (Buy) - Another big win for sac-TMT in upcoming ASCO\_Quick Note - Innovent (1801 HK) (Buy) - IBI363 PoC data released), we also highlight the below key assets from companies under our coverage in this report.

# Akeso (9926 HK, Neutral): HARMONi-6 is in the spotlight – an HR of 0.72 is being expected

The company will read out more than 40 clinical results and in our view the HARMONi-6 study will be one of the most closely monitored events at this meeting (see our report: Akeso (9926 HK) (Neutral) - HARMONI-6 OS data to be reported in ASCO meeting). The data will be reported on 31 May pm (local time) and we learn that investors, in general, are expecting a hazard ratio (HR) of around 0.70-0.72 for overall survival (OS), though some optimistic investors expect an even stronger HR of 0.68-0.70 for this drug.

# BeOne (6160 HK/ONC US, Buy): BGB-43395 (CDK4) shows lower hematological toxicity, while higher GI toxicity needs to be monitored

The company will report over 60 abstracts during this ASCO. Besides the hematology-oncology area that the company has already well covered, the company released early-stage data for several its solid tumor pipelines, a market key focus: (1) for BGB-43395 (CDK4), in HR+/HER2− breast cancer (BC) patients, 98% of the 58 patients who received this drug candidate (combo letrozole) reported treatment-emergent adverse events (TEAEs), mainly grade 1 or grade 2 and in the gastrointestinal area (diarrhea [79% / 95% / 90%); grade 3 [5%/11%/30%] for 240mg/400mg/600mg cohorts). Compared to current standard-of-care regimens or other CDK4 candidate, BGB-43395 shows lower hematological toxicity, but higher GI toxicity. (2) for BGB-B2033 (GPC3 x 4-1BB bsAb), manageable hepatotoxicity was found: 8% of patients reported grade 3 TR-TEAEs, and a 20.3% objective response rate (ORR) was reported for the 59 HCC patients.

# CSPC (1093 HK, Buy): SYS6010 (EGFR ADC) and SYS6043(B7-H3 ADC) updates, promising on late-stage ESCC and BC

The company will report four clinical updates on SYS6010. In a phase II trail for advanced ESCC patients, among 40 evaluable patients (out of 48 patients enrolled), the confirmed ORR was 35%, disease control rate (DCR) was 67.5% and median progression-free survival (mPFS) was 4.6 months. On the safety front, 97.9% (47/48) of patients experienced TRAEs, with 64.6% being grade ≥3 TRAEs. For SYS6043 that enrolled 502 patients on various late stage solid tumors, management targets it more dedicatedly for BC patients that showed an ORR of 83.8% and DCR of 100%.

# Hengrui (600276 CH / 1276 HK, Buy): more than 80 studies to present

This company will report more than 80 clinical results in this upcoming ASCO, reflecting its broadest innovative oncology pipeline among peers. We highlight its SHR-A1811 (HER2 ADC) in 1L HER2+ mCRC, SHR-1826 (c-Met ADC) in advanced solid tumors (most lung cancers), SHR-A1904 (CLDN18.2 ADC) in advanced solid tumors (most GC/GEJC), SHR-A2102 (Nectin-4 ADC) in 1L late-stage NSCLC – though most are in early-stage clinical trials, they reported manageable safety profiles and encouraging efficacy activity.
