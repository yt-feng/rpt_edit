...
Model projection: 6.8007 versus 6.8054 previous (47 pips lower; 51 pips higher from the previous official spot close).

Model projection with counter-cyclical factor: 6.8012 (42 pips lower from previous fix).
