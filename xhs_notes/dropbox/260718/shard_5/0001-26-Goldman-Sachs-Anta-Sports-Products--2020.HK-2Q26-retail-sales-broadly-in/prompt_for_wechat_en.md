...
2026 Outlook: mgmt highlighted Anta brands 1H26 +MSD% yoy growth above its full year guidance of full-year guidance of >+LSD%, and mgmt reiterated the FY26 guidance. Looking into 2H26, management expects the relatively low comparison base in 3Q25 and the calendar shift of the Mid-Autumn Festival to provide some support, yet the competitive and promotional environment and unfavorable weather, could remain near-term headwinds. On products, Anta introduced its self-developed structural cushioning platform and launched the new Anta FOLD running shoes (ASP Rmb599) and management expects the product to support momentum in the running category during 2H26.
...
Kolon achieved +40+% yoy growth and healthy discount (<10% off of all channels) and inventory level (less th
