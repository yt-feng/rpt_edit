...
![](images/4b906bdcbcc7897d931f4f90c53a08493634661f919ff625ca3e51f257305e8d.jpg)
...
![](images/7a668057bc839a952c33454d8bb969534c316e2c95016f0dbba386c9ac3dcb8e.jpg)
...
![](images/0281dedd0c740a31cd7908678c137293fabd7f8e506f673d6efc6cec121ebc01.jpg)
...
![](images/7a17bfa0fbad62178753d7eafa83540065c276e0413a9e996619a6bac9d60556.jpg)
...
![](images/b4dd0ac48eb1ef8c1317bbe192735366de6b940153a3c1319d294ac11dad2bd7.jpg)
...
![](images/97077ba82454c43ab4a98db98ef50e49ec641986e6f659f995dd6bdbad31e6c2.jpg)
...
![](images/46b0fed5e555dc7cbfd189b337c47a471333b33bb94846ed4ca578e3e62cf448.jpg)
...
![](images/4695bfce9f8f970c16f35907037cf3c2051576f721ae094d72e0c5e3ab03aff2.jpg)
...
```mermaid
graph TD
    A["Long-term RMB liquidity supply"] --> B["Retail RMB flows"]
    A --> C["Current account (Trade settlement)"]
    A --> D["Financial account"]
    D --> E["Direct Investment"]
    D --> F["Stock Connect"]
    D --> G["Bond Connect"]
    D --> H["Cross-border Loans"]
    D --> I["..."]
    
    J["Short-term RMB liquidity supply"] --> K["PBOC-HKMA standing swap line (RMB 800bn)"]
    K --> L["RMB liquidity facility (intraday, o/n, 1d, 1w, 2w, 1m repos)"]
    K --> M["Primary liquidity providers (intraday, o/n repos)"]
    K --> N["RMB business facility (1m, 3m, 6m, 12m)"]
    
    O["Onshore RMB assets"] --> P["Bond & equities"]
    O --> Q["Direct investment"]
    O --> R["Loans & retail flows"]
    
    S["Offshore RMB assets"] --> T["Dim Sum bonds"]
    S --> U["RMB equities & funds"]
    S --> V["RMB loans"]
    S --> W["RMB trade finance"]
    
    X["Hong Kong RMB liquidity pool RMB deposits + CDs (RMB 1.1 trillion)"] --> Y["FX swap market"]
    Y --> Z["Interbank lending"]
    Z --> AA["CNH HIBORs"]
    AA --> AB["CNH FX implied yields"]
    AB --> AC["Offshore RMB funding market"]
    AC --> AD["Pricing Reference"]
    AD --> AE["Short-term RMB liquidity supply"]
    AE --> AF["RMB liquidity facility (intraday, o/n, 1d, 1w, 2w, 1m repos)"]
    AE --> AG["Primary liquidity providers (intraday, o/n repos)"]
    AE --> AH["RMB business facility (1m, 3m, 6m, 12m)"]
...
The framework highlights a key point: offshore RMB market development is not only about accumulating RMB deposits or settling China-linked trade. It requires an ecosystem in which RMB can be funded, invested, hedged and redeployed. To move beyond China-linked trade settlement, the RMB therefore needs to become eas
