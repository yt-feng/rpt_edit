...
Private R&D investment tends to follow large commercial markets, systematically bypassing the crops that female smallholders in Southeast Asia grow most, such as cassava, leafy vegetables, legumes, and root crops. Because these crops generate lower commercial returns, private firms have little incentive to develop climate-resilient varieties for them. Public research institutions should fill this gap. National agricultural research agencies should substantially increase the share of R&D budgets allocated to horticulture and climate-substitute crops and involve women farmers directly in participatory variety selection. Publicly funded climate-adapted seeds for underserved crops would reach the farming systems where the yield gap is currently widest.

## Expand Market Price Information Tools to Female Smallholders

Information asymmetries between smallholders and intermediaries reduce the prices farmers receive in fragmented rural markets. Mobile-based applications displaying current farmgate and wholesale prices across nearby markets have been shown to reduce price dispersion. Research also shows that the device holder captures the benefit, meaning that when women own and operate the technology themselves, income gains accrue to them directly. Distribution programs should therefore target individual female farmers rather than farm households, and digital literacy support should accompany device provision.

## Disburse Agricultural Subsidies and Loans Directly into Women's Mobile Accounts

Mobile wallet infrastructure is already operating at scale across Southeast Asia. Agricultural subsidies and loans disbursed at the household level are vulnerable to intra-household reallocation, whereby resources intended for female farmers are redirected before reaching the plot. Disbursing directly into individual accounts registered to women removes this risk without requiring new technical investment. Governments should require individual female account registration as a condition for subsidy receipt and simplify account-opening requirements for rural women in coordination with financial regulators.

## Medium-Term Reforms

## Formalize Women's Land Tenure Rights

Farmers who lack secure tenure cannot make multi-year soil investments, such as cover cropping, fallowing, or perennial planting, even when those investments would raise long-term yields. This constraint falls disproportionately on women, whose rights within customary tenure systems are often contingent rather than formally recognized. Countries across Southeast Asia should accelerate land certification programs with explicit mandates to register plots in women's names and should review national land laws to close the gap between formal property rights and customary practice.
