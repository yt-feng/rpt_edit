...
Investors may appoint one primary and up to two general settlement banks. While all provide pricing and execution, only the primary settlement bank is authorized to settle Northbound transactions within the CMU system. To utilize these services, investors must either have in place or open CNY-denominated cash accounts with their selected FX settlement banks in Hong Kong, China. BCCL supports the necessary registration with CFETS for the service.

## Swap Connect

Swap Connect enables international investors to contract onshore CNY interest rate swaps by directly participating in the PRC derivatives market.

Swap Connect allows international investors (including Northbound Bond Connect investors and CIBM Direct Investors) to follow familiar trading and settlement

practices. The International Swaps and Derivatives Association (ISDA) has provided a Swap Connect Appendix to the ISDA–FIA Client Cleared OTC Derivatives Addendum.

The scheme grants investors direct access to onshore dealers via international platforms, while eliminating the need for onshore account opening in the PRC. Bond Connect investors can execute an ISDA agreement or the standard agreement of the National Association of Financial Market Institutional Investors, or they can trade without an agreement with PRC counterparties.

As the world's first derivatives access scheme linking two central counterparties—OTC Clearing Hong Kong Limited (OTC Clear) and SHCH—Swap Connect enables international investors to face a Qualified Central Counterparty in Hong Kong, China (OTC Clear) instead of adopting SHCH counterparty procedures onshore.

Bond Connect investors can utilize Chinese Government Bonds (CGBs) and policy bank financial bonds held through Bond Connect as eligible collateral for initial margining under Northbound Swap Connect, allowing for flexible margin management by investors. $^{10}$

## Repurchase Agreement (Repo)

The repo business under Bond Connect was launched in 2025 and consists of two complementary arrangements: $^{11}$ (i) the Offshore RMB Bond Repo Business, and (ii) the Cross-Boundary Bond Repo Business. $^{12}$ In contrast to the traditional onshore repo business in the CIBM, which is conducted in the form of pledge repo, both repo schemes under Bond Connect are conducted on a title transfer basis; therefore, an overseas investor can effect title-transfer repo transactions under either arrangement Investors may participate in both schemes by submitting only one application form through BCCL and can utilize internationally accepted standard documentation such as the Global Master Repo Agreement or the domestic agreement issued by the National Association of Financial Market Institutional Investors. $^{13}$

Both the Global Master Repo Agreement and the relevant provisions of the National Association of Financial Market Institutional Investors agreement clarify the rights and obligations of the contracting parties under these two title-transfer repo schemes, particularly in the event of a default regarding the transfer of legal title to collateral and the operation of close-out netting. Investors are advised to seek independent legal advice if they are in any doubt about the contents of these documents. $^{14}$

Offshore RMB Bond Repo. The Offshore RMB Bond Repo was launched in February 2025, allowing Northbound Bond Connect participants to use eligible onshore bonds held under Northbound Bond Connect as collateral for repo transactions in the Hong Kong bond market. This scheme involves the Hong Kong Monetary Authority, the CMU, and Hong Kong market makers. Subsequent enhancements were introduced in August 2025, including the rehypothecation of collateral and cross-currency repo in other currencies (e.g., the Hong Kong dollar, United States dollar, and euro), aligning the framework with international market practices and broadening the use of onshore CNY-denominated bonds in offshore markets.

Cross-Boundary Bond Repo. Cross-Boundary Bond Repo was launched in September 2025, enabling Northbound Bond Connect participants as well as CIBM Direct investors to conduct onshore repo transactions and remit the RMB liquidity obtained for offshore use. This scheme involves CMU, CCDC, SHCH, and China bond market makers.

The establishment of these repo schemes not only allows international investors to tap into onshore market makers' liquidity but may also serve as a valuable reference for other monetary authorities regarding the macroprudential management of cross-border financing.

In addition to allowing international investors to participate in the PRC repo market and utilize their own CIBM bonds for collateral or funding purposes, the two repo arrangements provide more stable liquidity support for Hong Kong, China's offshore RMB market. Table 3 offers a comparison of the characteristics of the two repo arrangements accessible to Bond Connect investors.

Detailed information on the policy and rules for both Offshore RMB Bond Repo and Cross-Boundary Bond Repo can be found on the BCCL website. $^{15}$

## Primary Market Subscription

ePrime Northbound, integrated with CFETS' iDeal, enables international investors to connect with onshore underwriters, participate in bidding, and receive allocation confirmation via a seamless interface designed for both investors and underwriters.

More information about ePrime Northbound is available from the BCCL website. $^{16}$

Table 3: Comparison of Repo Business Schemes in the China Inter-Bank Bond Market

<table><tr><td>Scheme</td><td>Cross-Boundary Bond Repo</td><td>Offshore RMB Bond Repo</td></tr><tr><td>Eligibility</td><td>Northbound Bond Connect and CIBM Direct Investors</td><td>Only Northbound Bond Connect Investors</td></tr><tr><td>Master Agreement</td><td>GMRA or NAFMII</td><td>GMRA, NAFMII, others</td></tr><tr><td>Trading Mode</td><td>Northbound linkage (similar to Bond Connect trading pattern)</td><td>OTC, Northbound linkage, others</td></tr><tr><td>Collateral Utilization</td><td>Investors can withdraw CNY and convert in Hong Kong, China if needed:·Sovereign institutions, RMB clearing banks, participating banks: up to 100% of bond value·Other types of international institutional investors: up to 80% of bond valueFor PRC market makers, the net outstanding balance is capped at 6% of the institution&#x27;s net Tier-1 capital or core net capital</td><td>Rehypothecation of bond collateral is supported during the repo period under four use cases:(i) for re-use in offshore repo transactions,(ii) as collateral for the HKMA&#x27;s RMB Liquidity Facility,(iii) as margin collateral at OTC Clearing Hong Kong Limited, and(iv) for cash bond trading through Northbound Bond Connect.</td></tr><tr><td>Settlement Currency</td><td>CNY (RMB) only (convertible offshore after withdrawal)</td><td>CNY (RMB), EUR, HKD, USD</td></tr><tr><td>Liquidity Pool</td><td>Onshore</td><td>Offshore</td></tr><tr><td>Number of Market Makers</td><td>13 PRC onshore market makers</td><td>11 Hong Kong market makers</td></tr></table>

CCDC = China Central Depository & Clearing Co., Ltd.; CIBM = China Inter-Bank Bond Market; CMUOC = CMU OmniClear Limited; CNY = Chinese yuan (ISO code); EUR = euro; GMRA = Global Master Repurchase Agreement; HKD = Hong Kong dollar; HKMA = Hong Kong Monetary Authority; NAFMII = National Association of Financial Market Institutional Investors; OTC = over-the-counter; PRC = People's Republic of China; repo = repurchase agreement, RMB = Chinese renminbi (domestic designation); SHCH = Shanghai Clearing House; USD = United States dollar.
Source: Bond Connect Company Limited.

## Use of CIBM Bonds as Collateral

International investors can use onshore bonds issued by the PRC's Ministry of Finance and policy banks, and held under Northbound Bond Connect, as eligible margin collateral at OTC Clear for derivative transactions in the market in Hong Kong, China. This initiative provides even greater flexibility for the use of collateral by Bond Connect investors.

## Treasury Bond Futures

The move is part of the efforts to broaden the investment scope for QFIIs and Renminbi Qualified Foreign Institutional Investors, enrich interest rate risk management tools, enhance the appeal of CNY-denominated bond assets, improve the stability of foreign institutional investment behaviors, and push forward the high-quality development of both spot and futures markets for bonds.

Qualified Foreign Institutional Investors (QFII) and Renminbi Qualified Foreign Institutional Investors have been allowed to participate in Treasury bond futures trading on the China Financial Futures Exchange since April 2026, with trading activities limited to hedging purposes.

Figure 3: Breakdown of Northbound Bond Connect Investors by Jurisdiction  
![](images/2db48ec94b073366d0948199052d0fc1b14b714fcbdc99fba056f9065b21b2e9.jpg)  
Notes: Percentages are based on investors that have received the People's Bank of China's filing notice. Data as of 1 June 2026. Source: Bond Connect Company Limited.

Figure 4: Breakdown of Northbound Bond Connect Investors by Investor Type  
![](images/27b25942727aefc8183c8f27ca0033f204c8fc2b1d289e391dffa82a40d2dc8e.jpg)  
Notes: Percentages are based on investors that have received the People's Bank of China's filing notice. Data as of 1 June 2026. Source: Bond Connect Company Limited.

Figure 5: Assets Under Custody by International Institutional Investors in the CIBM Custody Balance (RMB billion)  
![](images/efe3d7e2dd8cf34923a8dec9d864762364551299393cbcb2dc0adf37c88feb1f.jpg)  
CIBM = China Inter-Bank Bond Market, RMB = Chinese renminbi.  
Note: Data as of December 2025.  
Sources: Bond Connect Company Limited; China Central Depository & Clearing Co., Ltd.; and Shanghai Clearing House.

## Conclusion

Guided by the declared policy objective of opening up of the Chinese bond market and adhering to market-oriented principles, regulatory authorities in the PRC and Hong Kong, China have established a comprehensive Bond Connect ecosystem that facilitates the integration of financial resources—including cash bonds, FX, derivatives, and repo—with BCCL acting as a conduit to this ecosystem.

The introduction of Bond Connect has seen sustained growth in investor access, holding balances, and trading volume since inception. As of December 2025, BCCL had registered 839 investors from 40 jurisdictions. $^{17}$ A breakdown of these investors is provided: by jurisdiction in Figure 3 and by type in Figure 4.

Since the launch of Bond Connect, the holding balances of international investors have increased nearly fourfold, with total foreign holdings in the CIBM standing at approximately RMB3.45 trillion in December 2025 (Figure 5).

Bond Connect enables the trading of all CIBM cash bonds through familiar global interfaces (via an integrated link to the CFETS) and supports a flexible settlement cycle (from T+0 to T+N). The ability to use existing custody arrangements, allowing for operational compatibility, is complemented by safekeeping of the CIBM bonds through an account with CMU, which reduces settlement and counterparty risk.
