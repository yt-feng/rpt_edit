...
![](images/4d052caa737a1a85e7908027a2bf47fa36d05c11698e51426b7d05a0b0fc33bf.jpg)

Total ADB operations in 2025 amounted to \$29.3 billion, with cofinancing of \$14.7 billion.

BRUNEI DARUSSALAM: SHAREHOLDING AND VOTING POWER

Number of shares held: 37,386 (0.351% of total shares)

Votes:
75,933 (0.571% of total membership,
0.872% of total regional membership)

\*Overall capital subscription: \$512.45 million

\*Paid-in capital subscription: \$25.67 million

\*United States dollar figures are valued at the rate as of 31 December 2025.

## BRUNEI DARUSSALAM

The Asian Development Bank (ADB) works alongside governments, development partners, and other stakeholders to confront the complex challenges presented by persistent poverty, geopolitical instability, and other pressing development issues facing the Asia and Pacific region.

In 2025, ADB made institutional changes that allow the bank to scale up for development impact well into the future. These include an amendment to the bank's founding charter to remove a lending limitation and enable ADB to expand support for developing member countries (DMCs) in addressing critical priorities without requiring a general capital increase from shareholders.

ADB also introduced new guidance for integrating private sector solutions at every stage of the project cycle. The approach focuses on improving enabling environments through policy reforms, developing bankable projects, and mobilizing private capital to complement public investments.

The bank updated its energy policy in 2025, strengthening its commitment to increasing energy access and improving energy security for DMCs. While continuing with strong support for renewable energy generation, the changes enable ADB to support nuclear power—subject to rigorous assessments; strong safety, security, and environmental and social safeguards; and whole-of-life cost assessments.

ADB's updated Results-Based Lending Policy introduces greater flexibility to help DMCs deliver sustainable outcomes. Results-based lending can now be combined with other types of ADB financing—such as investment loans—to strengthen government institutions and support complementary projects.

Brunei Darussalam joined ADB in 2006. It had provided \$512.45 million in capital subscription to ADB as of 31 December 2025. It has also contributed and committed \$22.31 million to ADB's special funds since becoming a member.

## CONTRIBUTIONS TO SPECIAL FUNDS RESOURCES

Brunei Darussalam contributes to the Asian Development Fund (ADF) and the Technical Assistance Special Fund (TASF). The ADF provides grants to ADB's low-income developing member countries. The TASF provides technical assistance grants to developing member countries to help prepare projects and undertake technical or policy studies.

Contributions:
\*\*ADF (committed): \$21.21 million
\*\*TASF (committed): \$1.1 million

\*\* Valued at exchange rates per relevant Board of Governors' Resolutions.

## FINANCING PARTNERSHIPS

Financing partnerships enable ADB's partner governments or their agencies, multilateral financing institutions, and private organizations to participate in financing ADB projects. The additional funds provided may be in the form of loans and grants, technical assistance, and private sector cofinancing. More information on cofinanced investment projects can be found on www.adb.org/what-we-do/financing-partnerships.

Trust funds. ADB manages trust funds established through financing agreements initially from single donors targeting specific sectors. It has been increasingly switching to thematic trust funds and financing partnership facilities that link various forms of assistance to support priority areas such as water, clean energy, regional cooperation and integration, urban sector financing, and health.
...
## ADB Governor: Amin Liew Abdullah

ADB Alternate Governor: Pengiran Datin Zety Sufina Pengiran Dato Sani
ADB Director: Amiruddin Muhamed (Malaysia)

ADB Alternate Director: Shreekrishna Nepal (Nepal)

ADB Director's Advisors: Pimpatchara Kusolvititkul (Thailand), Hafiz Daud (Brunei Darussalam), and Yonca Saka Sezgin (Türkiye)
...
Partnership Reports
www.adb.org/documents/series/partnership-reports
