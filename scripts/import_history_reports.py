#!/usr/bin/env python3
"""Import the ib_rpt_history text-only report archive into Portal Suite data files.
...
- `portal_suite/data/history_catalog.json`: catalog-shaped metadata for every
...
- `portal_suite/data/history_text/shard_<YYMM>.json.gz`: normalized, per-report
...
def main() -> int:
    ...
    parser.add_argument("--catalog-out", default="portal_suite/data/history_catalog.json")
    parser.add_argument("--text-dir-out", default="portal_suite/data/history_text")
