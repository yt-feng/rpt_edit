...
def draw_portal_watermark(draw: ImageDraw.ImageDraw) -> None:
...
def wechat_title_from_filename(
    ...
    try:
        ...
        print(f"Filename title repair failed for {source_filename[:80]}: {exc}", flush=True)
        return selected, decision
