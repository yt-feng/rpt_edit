#!/usr/bin/env python3
"""Notify IndexNow about canonical KC Desk pages changed by a deployment."""
...
DEFAULT_BASE_URL = "https://kcdesk.com"
DEFAULT_ENDPOINT = "https://api.indexnow.org/indexnow"
DEFAULT_KEY = "201eca2fc32f348cb7280e22b4999524"
...
def verify_key_file(key_location: str, key: str, attempts: int = 6) -> None:
    ...
    for attempt in range(attempts):
        try:
            request = Request(key_location, headers={"User-Agent": "KCDesk-IndexNow/1.0"})
    ...
    for attempt in range(4):
        try:
            request = Request(
                endpoint,
                data=body,
                headers={"Content-Type": "application/json; charset=utf-8", "User-Agent": "KCDesk-IndexNow/1.0"},
                method="POST",
            )
...
def main() -> int:
    ...
    parser.add_argument("--catalog", default="kc_desk_notes/data/catalog.json")
