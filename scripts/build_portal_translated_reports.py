...
6. 插入 1-2 条 `> 编辑评论：...`。编辑评论要用大白话解释“这对市场/企业/政策观察意味着什么”，不要空泛，也不要夹带 CTA。
7. 如有可用图表占位符，只能从这些 token 里选 1-3 个并原样插入，单独成行：{token_text}
8. 不要输出任何 CTA、广告、扫码、社群、知识星球、每日汇编、喂给 AI、网站、域名、关注或星标表达；系统会在最结尾统一插入固定信息。
9. 标题、正文和 编辑评论不要直接输出“经济、投资、财经、金融、股票、股价、股市、理财、证券、券商、收益率、资产定价”等直白词；改成“宏观环境、研究、观察、资金、公司、报价、市场、回报表现、市场定价”等中性表达。
