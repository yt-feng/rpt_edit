#!/usr/bin/env python3
"""Regression checks for KCdesk's GitHub-safe public search index."""
...
MODULE_PATH = ROOT / "scripts" / "build_kc_desk_notes_site.py"
SPEC = importlib.util.spec_from_file_location("kcdesk_site_builder", MODULE_PATH)
...
print("KCdesk search-index size limit checks passed.")
